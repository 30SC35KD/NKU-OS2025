...
ffffffffc0200060:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc0200062:	77a050ef          	jal	ra,ffffffffc02057dc <memset>
    dtb_init();
...
ffffffffc0200072:	79a58593          	addi	a1,a1,1946 # ffffffffc0205808 <etext+0x2>
ffffffffc0200076:	00005517          	auipc	a0,0x5
ffffffffc020007a:	7b250513          	addi	a0,a0,1970 # ffffffffc0205828 <etext+0x22>
...
ffffffffc0200092:	2f1030ef          	jal	ra,ffffffffc0203b82 <vmm_init>
    proc_init(); // init process table
ffffffffc0200096:	699040ef          	jal	ra,ffffffffc0204f2e <proc_init>
...
ffffffffc02000a2:	024050ef          	jal	ra,ffffffffc02050c6 <cpu_idle>
...
ffffffffc02000c0:	77450513          	addi	a0,a0,1908 # ffffffffc0205830 <etext+0x2a>
...
ffffffffc0200186:	c602                	sw	zero,12(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc0200188:	230050ef          	jal	ra,ffffffffc02053b8 <vprintfmt>
    return cnt;
}
...
ffffffffc02001bc:	c202                	sw	zero,4(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc02001be:	1fa050ef          	jal	ra,ffffffffc02053b8 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200222:	61a50513          	addi	a0,a0,1562 # ffffffffc0205838 <etext+0x32>
{
...
ffffffffc0200238:	62450513          	addi	a0,a0,1572 # ffffffffc0205858 <etext+0x52>
ffffffffc020023c:	f59ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200240:	00005597          	auipc	a1,0x5
ffffffffc0200244:	5c658593          	addi	a1,a1,1478 # ffffffffc0205806 <etext>
ffffffffc0200248:	00005517          	auipc	a0,0x5
ffffffffc020024c:	63050513          	addi	a0,a0,1584 # ffffffffc0205878 <etext+0x72>
...
ffffffffc0200260:	63c50513          	addi	a0,a0,1596 # ffffffffc0205898 <etext+0x92>
...
ffffffffc0200274:	64850513          	addi	a0,a0,1608 # ffffffffc02058b8 <etext+0xb2>
...
ffffffffc02002a2:	63a50513          	addi	a0,a0,1594 # ffffffffc02058d8 <etext+0xd2>
}
...
ffffffffc02002b0:	65c60613          	addi	a2,a2,1628 # ffffffffc0205908 <etext+0x102>
ffffffffc02002b4:	04f00593          	li	a1,79
ffffffffc02002b8:	00005517          	auipc	a0,0x5
ffffffffc02002bc:	66850513          	addi	a0,a0,1640 # ffffffffc0205920 <etext+0x11a>
{
...
ffffffffc02002cc:	67060613          	addi	a2,a2,1648 # ffffffffc0205938 <etext+0x132>
ffffffffc02002d0:	00005597          	auipc	a1,0x5
ffffffffc02002d4:	68858593          	addi	a1,a1,1672 # ffffffffc0205958 <etext+0x152>
ffffffffc02002d8:	00005517          	auipc	a0,0x5
ffffffffc02002dc:	68850513          	addi	a0,a0,1672 # ffffffffc0205960 <etext+0x15a>
{
ffffffffc02002e0:	e406                	sd	ra,8(sp)
        cprintf("%s - %s\n", commands[i].name, commands[i].desc);
ffffffffc02002e2:	eb3ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc02002e6:	00005617          	auipc	a2,0x5
ffffffffc02002ea:	68a60613          	addi	a2,a2,1674 # ffffffffc0205970 <etext+0x16a>
ffffffffc02002ee:	00005597          	auipc	a1,0x5
ffffffffc02002f2:	6aa58593          	addi	a1,a1,1706 # ffffffffc0205998 <etext+0x192>
ffffffffc02002f6:	00005517          	auipc	a0,0x5
ffffffffc02002fa:	66a50513          	addi	a0,a0,1642 # ffffffffc0205960 <etext+0x15a>
ffffffffc02002fe:	e97ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc0200302:	00005617          	auipc	a2,0x5
ffffffffc0200306:	6a660613          	addi	a2,a2,1702 # ffffffffc02059a8 <etext+0x1a2>
ffffffffc020030a:	00005597          	auipc	a1,0x5
ffffffffc020030e:	6be58593          	addi	a1,a1,1726 # ffffffffc02059c8 <etext+0x1c2>
ffffffffc0200312:	00005517          	auipc	a0,0x5
ffffffffc0200316:	64e50513          	addi	a0,a0,1614 # ffffffffc0205960 <etext+0x15a>
...
ffffffffc0200350:	68c50513          	addi	a0,a0,1676 # ffffffffc02059d8 <etext+0x1d2>
{
...
ffffffffc0200372:	69250513          	addi	a0,a0,1682 # ffffffffc0205a00 <etext+0x1fa>
...
ffffffffc0200388:	6ecc0c13          	addi	s8,s8,1772 # ffffffffc0205a70 <commands>
        if ((buf = readline("K> ")) != NULL)
ffffffffc020038c:	00005917          	auipc	s2,0x5
ffffffffc0200390:	69c90913          	addi	s2,s2,1692 # ffffffffc0205a28 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL)
ffffffffc0200394:	00005497          	auipc	s1,0x5
ffffffffc0200398:	69c48493          	addi	s1,s1,1692 # ffffffffc0205a30 <etext+0x22a>
        if (argc == MAXARGS - 1)
ffffffffc020039c:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020039e:	00005b17          	auipc	s6,0x5
ffffffffc02003a2:	69ab0b13          	addi	s6,s6,1690 # ffffffffc0205a38 <etext+0x232>
        argv[argc++] = buf;
ffffffffc02003a6:	00005a17          	auipc	s4,0x5
ffffffffc02003aa:	5b2a0a13          	addi	s4,s4,1458 # ffffffffc0205958 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i++)
...
ffffffffc02003cc:	6a8d0d13          	addi	s10,s10,1704 # ffffffffc0205a70 <commands>
        argv[argc++] = buf;
...
ffffffffc02003d4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0)
ffffffffc02003d6:	3ac050ef          	jal	ra,ffffffffc0205782 <strcmp>
...
ffffffffc02003e8:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0)
ffffffffc02003ea:	398050ef          	jal	ra,ffffffffc0205782 <strcmp>
...
ffffffffc0200428:	39e050ef          	jal	ra,ffffffffc02057c6 <strchr>
...
ffffffffc0200466:	360050ef          	jal	ra,ffffffffc02057c6 <strchr>
...
ffffffffc0200484:	5d850513          	addi	a0,a0,1496 # ffffffffc0205a58 <etext+0x252>
...
ffffffffc02004c0:	5fc50513          	addi	a0,a0,1532 # ffffffffc0205ab8 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02004d6:	6e650513          	addi	a0,a0,1766 # ffffffffc0206bb8 <default_pmm_manager+0x540>
...
ffffffffc020050a:	5d250513          	addi	a0,a0,1490 # ffffffffc0205ad8 <commands+0x68>
{
...
ffffffffc020052a:	69250513          	addi	a0,a0,1682 # ffffffffc0206bb8 <default_pmm_manager+0x540>
...
ffffffffc0200564:	59850513          	addi	a0,a0,1432 # ffffffffc0205af8 <commands+0x88>
    ticks = 0;
...
ffffffffc0200604:	51850513          	addi	a0,a0,1304 # ffffffffc0205b18 <commands+0xa8>
void dtb_init(void) {
...
ffffffffc0200632:	4fa50513          	addi	a0,a0,1274 # ffffffffc0205b28 <commands+0xb8>
...
ffffffffc0200648:	4f450513          	addi	a0,a0,1268 # ffffffffc0205b38 <commands+0xc8>
...
ffffffffc0200658:	4fc50513          	addi	a0,a0,1276 # ffffffffc0205b50 <commands+0xe0>
    if (boot_dtb == 0) {
...
ffffffffc0200712:	49290913          	addi	s2,s2,1170 # ffffffffc0205ba0 <commands+0x130>
...
ffffffffc0200720:	47c48493          	addi	s1,s1,1148 # ffffffffc0205b98 <commands+0x128>
...
ffffffffc0200774:	4a850513          	addi	a0,a0,1192 # ffffffffc0205c18 <commands+0x1a8>
ffffffffc0200778:	a1dff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    }
    cprintf("DTB init completed\n");
ffffffffc020077c:	00005517          	auipc	a0,0x5
ffffffffc0200780:	4d450513          	addi	a0,a0,1236 # ffffffffc0205c50 <commands+0x1e0>
}
...
ffffffffc02007c0:	3b450513          	addi	a0,a0,948 # ffffffffc0205b70 <commands+0x100>
}
...
ffffffffc02007ca:	771040ef          	jal	ra,ffffffffc020573a <strlen>
...
ffffffffc02007d6:	2a01                	sext.w	s4,s4
                if (strncmp(name, "memory", 6) == 0) {
ffffffffc02007d8:	7c9040ef          	jal	ra,ffffffffc02057a0 <strncmp>
...
ffffffffc020086e:	715040ef          	jal	ra,ffffffffc0205782 <strcmp>
...
ffffffffc0200886:	32650513          	addi	a0,a0,806 # ffffffffc0205ba8 <commands+0x138>
           fdt32_to_cpu(x >> 32);
...
ffffffffc0200954:	27850513          	addi	a0,a0,632 # ffffffffc0205bc8 <commands+0x158>
...
ffffffffc0200966:	27e50513          	addi	a0,a0,638 # ffffffffc0205be0 <commands+0x170>
...
ffffffffc0200978:	28c50513          	addi	a0,a0,652 # ffffffffc0205c00 <commands+0x190>
ffffffffc020097c:	819ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("DTB init completed\n");
ffffffffc0200980:	00005517          	auipc	a0,0x5
ffffffffc0200984:	2d050513          	addi	a0,a0,720 # ffffffffc0205c50 <commands+0x1e0>
        memory_base = mem_base;
...
ffffffffc02009e2:	28a50513          	addi	a0,a0,650 # ffffffffc0205c68 <commands+0x1f8>
{
...
ffffffffc02009f2:	29250513          	addi	a0,a0,658 # ffffffffc0205c80 <commands+0x210>
...
ffffffffc0200a00:	29c50513          	addi	a0,a0,668 # ffffffffc0205c98 <commands+0x228>
...
ffffffffc0200a0e:	2a650513          	addi	a0,a0,678 # ffffffffc0205cb0 <commands+0x240>
ffffffffc0200a12:	f82ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  tp       0x%08x\n", gpr->tp);
ffffffffc0200a16:	700c                	ld	a1,32(s0)
ffffffffc0200a18:	00005517          	auipc	a0,0x5
ffffffffc0200a1c:	2b050513          	addi	a0,a0,688 # ffffffffc0205cc8 <commands+0x258>
...
ffffffffc0200a2a:	2ba50513          	addi	a0,a0,698 # ffffffffc0205ce0 <commands+0x270>
ffffffffc0200a2e:	f66ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  t1       0x%08x\n", gpr->t1);
ffffffffc0200a32:	780c                	ld	a1,48(s0)
ffffffffc0200a34:	00005517          	auipc	a0,0x5
ffffffffc0200a38:	2c450513          	addi	a0,a0,708 # ffffffffc0205cf8 <commands+0x288>
ffffffffc0200a3c:	f58ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  t2       0x%08x\n", gpr->t2);
ffffffffc0200a40:	7c0c                	ld	a1,56(s0)
ffffffffc0200a42:	00005517          	auipc	a0,0x5
ffffffffc0200a46:	2ce50513          	addi	a0,a0,718 # ffffffffc0205d10 <commands+0x2a0>
...
ffffffffc0200a54:	2d850513          	addi	a0,a0,728 # ffffffffc0205d28 <commands+0x2b8>
ffffffffc0200a58:	f3cff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  s1       0x%08x\n", gpr->s1);
ffffffffc0200a5c:	642c                	ld	a1,72(s0)
ffffffffc0200a5e:	00005517          	auipc	a0,0x5
ffffffffc0200a62:	2e250513          	addi	a0,a0,738 # ffffffffc0205d40 <commands+0x2d0>
...
ffffffffc0200a70:	2ec50513          	addi	a0,a0,748 # ffffffffc0205d58 <commands+0x2e8>
...
ffffffffc0200a7e:	2f650513          	addi	a0,a0,758 # ffffffffc0205d70 <commands+0x300>
...
ffffffffc0200a8c:	30050513          	addi	a0,a0,768 # ffffffffc0205d88 <commands+0x318>
ffffffffc0200a90:	f04ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  a3       0x%08x\n", gpr->a3);
ffffffffc0200a94:	742c                	ld	a1,104(s0)
ffffffffc0200a96:	00005517          	auipc	a0,0x5
ffffffffc0200a9a:	30a50513          	addi	a0,a0,778 # ffffffffc0205da0 <commands+0x330>
...
ffffffffc0200aa8:	31450513          	addi	a0,a0,788 # ffffffffc0205db8 <commands+0x348>
...
ffffffffc0200ab6:	31e50513          	addi	a0,a0,798 # ffffffffc0205dd0 <commands+0x360>
...
ffffffffc0200ac4:	32850513          	addi	a0,a0,808 # ffffffffc0205de8 <commands+0x378>
...
ffffffffc0200ad2:	33250513          	addi	a0,a0,818 # ffffffffc0205e00 <commands+0x390>
...
ffffffffc0200ae0:	33c50513          	addi	a0,a0,828 # ffffffffc0205e18 <commands+0x3a8>
...
ffffffffc0200aee:	34650513          	addi	a0,a0,838 # ffffffffc0205e30 <commands+0x3c0>
...
ffffffffc0200afc:	35050513          	addi	a0,a0,848 # ffffffffc0205e48 <commands+0x3d8>
...
ffffffffc0200b0a:	35a50513          	addi	a0,a0,858 # ffffffffc0205e60 <commands+0x3f0>
ffffffffc0200b0e:	e86ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  s6       0x%08x\n", gpr->s6);
ffffffffc0200b12:	784c                	ld	a1,176(s0)
ffffffffc0200b14:	00005517          	auipc	a0,0x5
ffffffffc0200b18:	36450513          	addi	a0,a0,868 # ffffffffc0205e78 <commands+0x408>
...
ffffffffc0200b26:	36e50513          	addi	a0,a0,878 # ffffffffc0205e90 <commands+0x420>
...
ffffffffc0200b34:	37850513          	addi	a0,a0,888 # ffffffffc0205ea8 <commands+0x438>
...
ffffffffc0200b42:	38250513          	addi	a0,a0,898 # ffffffffc0205ec0 <commands+0x450>
...
ffffffffc0200b50:	38c50513          	addi	a0,a0,908 # ffffffffc0205ed8 <commands+0x468>
...
ffffffffc0200b5e:	39650513          	addi	a0,a0,918 # ffffffffc0205ef0 <commands+0x480>
...
ffffffffc0200b6c:	3a050513          	addi	a0,a0,928 # ffffffffc0205f08 <commands+0x498>
ffffffffc0200b70:	e24ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  t4       0x%08x\n", gpr->t4);
ffffffffc0200b74:	746c                	ld	a1,232(s0)
ffffffffc0200b76:	00005517          	auipc	a0,0x5
ffffffffc0200b7a:	3aa50513          	addi	a0,a0,938 # ffffffffc0205f20 <commands+0x4b0>
...
ffffffffc0200b88:	3b450513          	addi	a0,a0,948 # ffffffffc0205f38 <commands+0x4c8>
...
ffffffffc0200b9a:	3ba50513          	addi	a0,a0,954 # ffffffffc0205f50 <commands+0x4e0>
}
...
ffffffffc0200bb0:	3bc50513          	addi	a0,a0,956 # ffffffffc0205f68 <commands+0x4f8>
{
...
ffffffffc0200bc8:	3bc50513          	addi	a0,a0,956 # ffffffffc0205f80 <commands+0x510>
...
ffffffffc0200bd8:	3c450513          	addi	a0,a0,964 # ffffffffc0205f98 <commands+0x528>
...
ffffffffc0200be8:	3cc50513          	addi	a0,a0,972 # ffffffffc0205fb0 <commands+0x540>
...
ffffffffc0200bfc:	3c850513          	addi	a0,a0,968 # ffffffffc0205fc0 <commands+0x550>
}
...
ffffffffc0200c18:	46470713          	addi	a4,a4,1124 # ffffffffc0206078 <commands+0x608>
...
ffffffffc0200c2a:	41250513          	addi	a0,a0,1042 # ffffffffc0206038 <commands+0x5c8>
ffffffffc0200c2e:	d66ff06f          	j	ffffffffc0200194 <cprintf>
        cprintf("Hypervisor software interrupt\n");
ffffffffc0200c32:	00005517          	auipc	a0,0x5
ffffffffc0200c36:	3e650513          	addi	a0,a0,998 # ffffffffc0206018 <commands+0x5a8>
ffffffffc0200c3a:	d5aff06f          	j	ffffffffc0200194 <cprintf>
        cprintf("User software interrupt\n");
ffffffffc0200c3e:	00005517          	auipc	a0,0x5
ffffffffc0200c42:	39a50513          	addi	a0,a0,922 # ffffffffc0205fd8 <commands+0x568>
ffffffffc0200c46:	d4eff06f          	j	ffffffffc0200194 <cprintf>
        cprintf("Supervisor software interrupt\n");
ffffffffc0200c4a:	00005517          	auipc	a0,0x5
ffffffffc0200c4e:	3ae50513          	addi	a0,a0,942 # ffffffffc0205ff8 <commands+0x588>
...
ffffffffc0200c90:	3cc50513          	addi	a0,a0,972 # ffffffffc0206058 <commands+0x5e8>
...
ffffffffc0200cb0:	12f76763          	bltu	a4,a5,ffffffffc0200dde <exception_handler+0x144>
ffffffffc0200cb4:	00005717          	auipc	a4,0x5
ffffffffc0200cb8:	5c070713          	addi	a4,a4,1472 # ffffffffc0206274 <commands+0x804>
...
ffffffffc0200cca:	4ca50513          	addi	a0,a0,1226 # ffffffffc0206190 <commands+0x720>
...
ffffffffc0200ce8:	6121                	addi	sp,sp,64
        syscall();
ffffffffc0200cea:	5cc0406f          	j	ffffffffc02052b6 <syscall>
        cprintf("Environment call from H-mode\n");
ffffffffc0200cee:	00005517          	auipc	a0,0x5
ffffffffc0200cf2:	4c250513          	addi	a0,a0,1218 # ffffffffc02061b0 <commands+0x740>
}
...
ffffffffc0200d0c:	4c850513          	addi	a0,a0,1224 # ffffffffc02061d0 <commands+0x760>
ffffffffc0200d10:	b7dd                	j	ffffffffc0200cf6 <exception_handler+0x5c>
        cprintf("Instruction page fault\n");
ffffffffc0200d12:	00005517          	auipc	a0,0x5
ffffffffc0200d16:	4de50513          	addi	a0,a0,1246 # ffffffffc02061f0 <commands+0x780>
ffffffffc0200d1a:	bff1                	j	ffffffffc0200cf6 <exception_handler+0x5c>
        cprintf("Load page fault\n");
ffffffffc0200d1c:	00005517          	auipc	a0,0x5
ffffffffc0200d20:	4ec50513          	addi	a0,a0,1260 # ffffffffc0206208 <commands+0x798>
...
ffffffffc0200d3e:	0030                	addi	a2,sp,8
ffffffffc0200d40:	85a6                	mv	a1,s1
            pte_t *ptep = NULL;
ffffffffc0200d42:	e402                	sd	zero,8(sp)
            struct Page *page = get_page(current->mm->pgdir, addr, &ptep);
ffffffffc0200d44:	55c010ef          	jal	ra,ffffffffc02022a0 <get_page>
ffffffffc0200d48:	89aa                	mv	s3,a0
            if (page != NULL && ptep != NULL && (*ptep & PTE_V) && page_ref(page) > 1) {
ffffffffc0200d4a:	c911                	beqz	a0,ffffffffc0200d5e <exception_handler+0xc4>
ffffffffc0200d4c:	67a2                	ld	a5,8(sp)
ffffffffc0200d4e:	cb81                	beqz	a5,ffffffffc0200d5e <exception_handler+0xc4>
ffffffffc0200d50:	639c                	ld	a5,0(a5)
ffffffffc0200d52:	8b85                	andi	a5,a5,1
ffffffffc0200d54:	c789                	beqz	a5,ffffffffc0200d5e <exception_handler+0xc4>
ffffffffc0200d56:	4118                	lw	a4,0(a0)
ffffffffc0200d58:	4785                	li	a5,1
ffffffffc0200d5a:	0ae7c763          	blt	a5,a4,ffffffffc0200e08 <exception_handler+0x16e>
        cprintf("Store/AMO page fault at %p\n", tf->tval);
ffffffffc0200d5e:	11043483          	ld	s1,272(s0)
}
ffffffffc0200d62:	7442                	ld	s0,48(sp)
ffffffffc0200d64:	70e2                	ld	ra,56(sp)
ffffffffc0200d66:	7902                	ld	s2,32(sp)
ffffffffc0200d68:	69e2                	ld	s3,24(sp)
ffffffffc0200d6a:	6a42                	ld	s4,16(sp)
        cprintf("Store/AMO page fault at %p\n", tf->tval);
ffffffffc0200d6c:	85a6                	mv	a1,s1
}
ffffffffc0200d6e:	74a2                	ld	s1,40(sp)
        cprintf("Store/AMO page fault at %p\n", tf->tval);
ffffffffc0200d70:	00005517          	auipc	a0,0x5
ffffffffc0200d74:	4e850513          	addi	a0,a0,1256 # ffffffffc0206258 <commands+0x7e8>
}
ffffffffc0200d78:	6121                	addi	sp,sp,64
        cprintf("Store/AMO page fault at %p\n", tf->tval);
ffffffffc0200d7a:	c1aff06f          	j	ffffffffc0200194 <cprintf>
        cprintf("Instruction address misaligned\n");
ffffffffc0200d7e:	00005517          	auipc	a0,0x5
ffffffffc0200d82:	32a50513          	addi	a0,a0,810 # ffffffffc02060a8 <commands+0x638>
ffffffffc0200d86:	bf85                	j	ffffffffc0200cf6 <exception_handler+0x5c>
        cprintf("Instruction access fault\n");
ffffffffc0200d88:	00005517          	auipc	a0,0x5
ffffffffc0200d8c:	34050513          	addi	a0,a0,832 # ffffffffc02060c8 <commands+0x658>
ffffffffc0200d90:	b79d                	j	ffffffffc0200cf6 <exception_handler+0x5c>
        cprintf("Illegal instruction\n");
ffffffffc0200d92:	00005517          	auipc	a0,0x5
ffffffffc0200d96:	35650513          	addi	a0,a0,854 # ffffffffc02060e8 <commands+0x678>
ffffffffc0200d9a:	bfb1                	j	ffffffffc0200cf6 <exception_handler+0x5c>
        cprintf("Breakpoint\n");
ffffffffc0200d9c:	00005517          	auipc	a0,0x5
ffffffffc0200da0:	36450513          	addi	a0,a0,868 # ffffffffc0206100 <commands+0x690>
ffffffffc0200da4:	bf0ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
        if (tf->gpr.a7 == 10)
ffffffffc0200da8:	6458                	ld	a4,136(s0)
ffffffffc0200daa:	47a9                	li	a5,10
ffffffffc0200dac:	10f70863          	beq	a4,a5,ffffffffc0200ebc <exception_handler+0x222>
}
ffffffffc0200db0:	70e2                	ld	ra,56(sp)
ffffffffc0200db2:	7442                	ld	s0,48(sp)
ffffffffc0200db4:	74a2                	ld	s1,40(sp)
ffffffffc0200db6:	7902                	ld	s2,32(sp)
ffffffffc0200db8:	69e2                	ld	s3,24(sp)
ffffffffc0200dba:	6a42                	ld	s4,16(sp)
ffffffffc0200dbc:	6121                	addi	sp,sp,64
ffffffffc0200dbe:	8082                	ret
        cprintf("Load address misaligned\n");
ffffffffc0200dc0:	00005517          	auipc	a0,0x5
ffffffffc0200dc4:	35050513          	addi	a0,a0,848 # ffffffffc0206110 <commands+0x6a0>
ffffffffc0200dc8:	b73d                	j	ffffffffc0200cf6 <exception_handler+0x5c>
        cprintf("Load access fault\n");
ffffffffc0200dca:	00005517          	auipc	a0,0x5
ffffffffc0200dce:	36650513          	addi	a0,a0,870 # ffffffffc0206130 <commands+0x6c0>
ffffffffc0200dd2:	b715                	j	ffffffffc0200cf6 <exception_handler+0x5c>
        cprintf("Store/AMO access fault\n");
ffffffffc0200dd4:	00005517          	auipc	a0,0x5
ffffffffc0200dd8:	3a450513          	addi	a0,a0,932 # ffffffffc0206178 <commands+0x708>
ffffffffc0200ddc:	bf29                	j	ffffffffc0200cf6 <exception_handler+0x5c>
        print_trapframe(tf);
ffffffffc0200dde:	8522                	mv	a0,s0
}
ffffffffc0200de0:	7442                	ld	s0,48(sp)
ffffffffc0200de2:	70e2                	ld	ra,56(sp)
...
ffffffffc0200dec:	6121                	addi	sp,sp,64
        print_trapframe(tf);
ffffffffc0200dee:	bb5d                	j	ffffffffc0200ba4 <print_trapframe>
        panic("AMO address misaligned\n");
ffffffffc0200df0:	00005617          	auipc	a2,0x5
ffffffffc0200df4:	35860613          	addi	a2,a2,856 # ffffffffc0206148 <commands+0x6d8>
ffffffffc0200df8:	0c300593          	li	a1,195
ffffffffc0200dfc:	00005517          	auipc	a0,0x5
ffffffffc0200e00:	36450513          	addi	a0,a0,868 # ffffffffc0206160 <commands+0x6f0>
ffffffffc0200e04:	e8aff0ef          	jal	ra,ffffffffc020048e <__panic>
                struct Page *new_page = alloc_page();
ffffffffc0200e08:	4505                	li	a0,1
ffffffffc0200e0a:	1b6010ef          	jal	ra,ffffffffc0201fc0 <alloc_pages>
ffffffffc0200e0e:	8a2a                	mv	s4,a0
                if (new_page != NULL) {
ffffffffc0200e10:	d539                	beqz	a0,ffffffffc0200d5e <exception_handler+0xc4>
...
ffffffffc0200e16:	8c67b783          	ld	a5,-1850(a5) # ffffffffc02aa6d8 <pages>
ffffffffc0200e1a:	40f986b3          	sub	a3,s3,a5
ffffffffc0200e1e:	00007597          	auipc	a1,0x7
ffffffffc0200e22:	b0a5b583          	ld	a1,-1270(a1) # ffffffffc0207928 <nbase>
ffffffffc0200e26:	8699                	srai	a3,a3,0x6
}
...
ffffffffc0200e28:	577d                	li	a4,-1
    return page - pages + nbase;
ffffffffc0200e2a:	96ae                	add	a3,a3,a1
    return KADDR(page2pa(page));
ffffffffc0200e2c:	8331                	srli	a4,a4,0xc
ffffffffc0200e2e:	00e6f533          	and	a0,a3,a4
ffffffffc0200e32:	000aa617          	auipc	a2,0xaa
ffffffffc0200e36:	89e63603          	ld	a2,-1890(a2) # ffffffffc02aa6d0 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc0200e3a:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0200e3c:	0ac57763          	bgeu	a0,a2,ffffffffc0200eea <exception_handler+0x250>
    return page - pages + nbase;
ffffffffc0200e40:	40fa07b3          	sub	a5,s4,a5
ffffffffc0200e44:	8799                	srai	a5,a5,0x6
ffffffffc0200e46:	97ae                	add	a5,a5,a1
    return KADDR(page2pa(page));
ffffffffc0200e48:	000aa517          	auipc	a0,0xaa
ffffffffc0200e4c:	8a053503          	ld	a0,-1888(a0) # ffffffffc02aa6e8 <va_pa_offset>
ffffffffc0200e50:	8f7d                	and	a4,a4,a5
ffffffffc0200e52:	00a685b3          	add	a1,a3,a0
    return page2ppn(page) << PGSHIFT;
ffffffffc0200e56:	00c79693          	slli	a3,a5,0xc
    return KADDR(page2pa(page));
ffffffffc0200e5a:	08c77863          	bgeu	a4,a2,ffffffffc0200eea <exception_handler+0x250>
                    memcpy(new_kva, old_kva, PGSIZE);
ffffffffc0200e5e:	6605                	lui	a2,0x1
ffffffffc0200e60:	9536                	add	a0,a0,a3
ffffffffc0200e62:	18d040ef          	jal	ra,ffffffffc02057ee <memcpy>
                    page_remove(current->mm->pgdir, aligned_addr);
ffffffffc0200e66:	00093783          	ld	a5,0(s2)
ffffffffc0200e6a:	7798                	ld	a4,40(a5)
                    uint32_t perm = (*ptep & PTE_USER) | PTE_W; // 添加写权限
ffffffffc0200e6c:	67a2                	ld	a5,8(sp)
                    page_remove(current->mm->pgdir, aligned_addr);
ffffffffc0200e6e:	6f08                	ld	a0,24(a4)
                    uint32_t perm = (*ptep & PTE_USER) | PTE_W; // 添加写权限
ffffffffc0200e70:	6380                	ld	s0,0(a5)
                    uintptr_t aligned_addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0200e72:	77fd                	lui	a5,0xfffff
ffffffffc0200e74:	8cfd                	and	s1,s1,a5
                    page_remove(current->mm->pgdir, aligned_addr);
ffffffffc0200e76:	85a6                	mv	a1,s1
ffffffffc0200e78:	055010ef          	jal	ra,ffffffffc02026cc <page_remove>
                    tlb_invalidate(current->mm->pgdir, aligned_addr); // 移除旧映射后刷新TLB
ffffffffc0200e7c:	00093783          	ld	a5,0(s2)
ffffffffc0200e80:	85a6                	mv	a1,s1
                    uint32_t perm = (*ptep & PTE_USER) | PTE_W; // 添加写权限
ffffffffc0200e82:	886d                	andi	s0,s0,27
                    tlb_invalidate(current->mm->pgdir, aligned_addr); // 移除旧映射后刷新TLB
ffffffffc0200e84:	779c                	ld	a5,40(a5)
                    uint32_t perm = (*ptep & PTE_USER) | PTE_W; // 添加写权限
ffffffffc0200e86:	00446413          	ori	s0,s0,4
                    tlb_invalidate(current->mm->pgdir, aligned_addr); // 移除旧映射后刷新TLB
ffffffffc0200e8a:	6f88                	ld	a0,24(a5)
ffffffffc0200e8c:	0b9020ef          	jal	ra,ffffffffc0203744 <tlb_invalidate>
                    page_insert(current->mm->pgdir, new_page, aligned_addr, perm);
ffffffffc0200e90:	00093783          	ld	a5,0(s2)
ffffffffc0200e94:	86a2                	mv	a3,s0
ffffffffc0200e96:	8626                	mv	a2,s1
ffffffffc0200e98:	779c                	ld	a5,40(a5)
ffffffffc0200e9a:	85d2                	mv	a1,s4
ffffffffc0200e9c:	6f88                	ld	a0,24(a5)
ffffffffc0200e9e:	0cb010ef          	jal	ra,ffffffffc0202768 <page_insert>
                    tlb_invalidate(current->mm->pgdir, aligned_addr); // 插入新映射后刷新TLB
ffffffffc0200ea2:	00093783          	ld	a5,0(s2)
ffffffffc0200ea6:	85a6                	mv	a1,s1
ffffffffc0200ea8:	779c                	ld	a5,40(a5)
ffffffffc0200eaa:	6f88                	ld	a0,24(a5)
ffffffffc0200eac:	099020ef          	jal	ra,ffffffffc0203744 <tlb_invalidate>
}
...
{
    page->ref -= 1;
ffffffffc0200eb0:	0009a783          	lw	a5,0(s3)
ffffffffc0200eb4:	37fd                	addiw	a5,a5,-1
ffffffffc0200eb6:	00f9a023          	sw	a5,0(s3)
                    return;
ffffffffc0200eba:	bddd                	j	ffffffffc0200db0 <exception_handler+0x116>
            tf->epc += 4;
ffffffffc0200ebc:	10843783          	ld	a5,264(s0)
ffffffffc0200ec0:	0791                	addi	a5,a5,4
ffffffffc0200ec2:	10f43423          	sd	a5,264(s0)
            syscall();
ffffffffc0200ec6:	3f0040ef          	jal	ra,ffffffffc02052b6 <syscall>
            kernel_execve_ret(tf, current->kstack + KSTACKSIZE);
ffffffffc0200eca:	000aa797          	auipc	a5,0xaa
ffffffffc0200ece:	8267b783          	ld	a5,-2010(a5) # ffffffffc02aa6f0 <current>
ffffffffc0200ed2:	6b9c                	ld	a5,16(a5)
ffffffffc0200ed4:	8522                	mv	a0,s0
}
ffffffffc0200ed6:	7442                	ld	s0,48(sp)
ffffffffc0200ed8:	70e2                	ld	ra,56(sp)
ffffffffc0200eda:	74a2                	ld	s1,40(sp)
ffffffffc0200edc:	7902                	ld	s2,32(sp)
ffffffffc0200ede:	69e2                	ld	s3,24(sp)
ffffffffc0200ee0:	6a42                	ld	s4,16(sp)
            kernel_execve_ret(tf, current->kstack + KSTACKSIZE);
ffffffffc0200ee2:	6589                	lui	a1,0x2
ffffffffc0200ee4:	95be                	add	a1,a1,a5
}
ffffffffc0200ee6:	6121                	addi	sp,sp,64
            kernel_execve_ret(tf, current->kstack + KSTACKSIZE);
ffffffffc0200ee8:	aa8d                	j	ffffffffc020105a <kernel_execve_ret>
    return KADDR(page2pa(page));
ffffffffc0200eea:	00005617          	auipc	a2,0x5
ffffffffc0200eee:	33660613          	addi	a2,a2,822 # ffffffffc0206220 <commands+0x7b0>
ffffffffc0200ef2:	07100593          	li	a1,113
ffffffffc0200ef6:	00005517          	auipc	a0,0x5
ffffffffc0200efa:	35250513          	addi	a0,a0,850 # ffffffffc0206248 <commands+0x7d8>
...
ffffffffc0200f7c:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200f7e:	24c0406f          	j	ffffffffc02051ca <schedule>
                do_exit(-E_KILLED);
ffffffffc0200f82:	555d                	li	a0,-9
ffffffffc0200f84:	58c030ef          	jal	ra,ffffffffc0204510 <do_exit>
            if (current->need_resched)
...
ffffffffc02011be:	76e63603          	ld	a2,1902(a2) # ffffffffc0207928 <nbase>
...
ffffffffc0201404:	eb868693          	addi	a3,a3,-328 # ffffffffc02062b8 <commands+0x848>
ffffffffc0201408:	00005617          	auipc	a2,0x5
ffffffffc020140c:	ec060613          	addi	a2,a2,-320 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201410:	11000593          	li	a1,272
ffffffffc0201414:	00005517          	auipc	a0,0x5
ffffffffc0201418:	ecc50513          	addi	a0,a0,-308 # ffffffffc02062e0 <commands+0x870>
ffffffffc020141c:	872ff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0201420:	00005697          	auipc	a3,0x5
ffffffffc0201424:	f5868693          	addi	a3,a3,-168 # ffffffffc0206378 <commands+0x908>
ffffffffc0201428:	00005617          	auipc	a2,0x5
ffffffffc020142c:	ea060613          	addi	a2,a2,-352 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201430:	0db00593          	li	a1,219
ffffffffc0201434:	00005517          	auipc	a0,0x5
ffffffffc0201438:	eac50513          	addi	a0,a0,-340 # ffffffffc02062e0 <commands+0x870>
ffffffffc020143c:	852ff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0201440:	00005697          	auipc	a3,0x5
ffffffffc0201444:	f6068693          	addi	a3,a3,-160 # ffffffffc02063a0 <commands+0x930>
ffffffffc0201448:	00005617          	auipc	a2,0x5
ffffffffc020144c:	e8060613          	addi	a2,a2,-384 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201450:	0dc00593          	li	a1,220
ffffffffc0201454:	00005517          	auipc	a0,0x5
ffffffffc0201458:	e8c50513          	addi	a0,a0,-372 # ffffffffc02062e0 <commands+0x870>
ffffffffc020145c:	832ff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0201460:	00005697          	auipc	a3,0x5
ffffffffc0201464:	f8068693          	addi	a3,a3,-128 # ffffffffc02063e0 <commands+0x970>
ffffffffc0201468:	00005617          	auipc	a2,0x5
ffffffffc020146c:	e6060613          	addi	a2,a2,-416 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201470:	0de00593          	li	a1,222
ffffffffc0201474:	00005517          	auipc	a0,0x5
ffffffffc0201478:	e6c50513          	addi	a0,a0,-404 # ffffffffc02062e0 <commands+0x870>
ffffffffc020147c:	812ff0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(!list_empty(&free_list));
ffffffffc0201480:	00005697          	auipc	a3,0x5
ffffffffc0201484:	fe868693          	addi	a3,a3,-24 # ffffffffc0206468 <commands+0x9f8>
ffffffffc0201488:	00005617          	auipc	a2,0x5
ffffffffc020148c:	e4060613          	addi	a2,a2,-448 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201490:	0f700593          	li	a1,247
ffffffffc0201494:	00005517          	auipc	a0,0x5
ffffffffc0201498:	e4c50513          	addi	a0,a0,-436 # ffffffffc02062e0 <commands+0x870>
ffffffffc020149c:	ff3fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc02014a0:	00005697          	auipc	a3,0x5
ffffffffc02014a4:	e7868693          	addi	a3,a3,-392 # ffffffffc0206318 <commands+0x8a8>
ffffffffc02014a8:	00005617          	auipc	a2,0x5
ffffffffc02014ac:	e2060613          	addi	a2,a2,-480 # ffffffffc02062c8 <commands+0x858>
ffffffffc02014b0:	0f000593          	li	a1,240
ffffffffc02014b4:	00005517          	auipc	a0,0x5
ffffffffc02014b8:	e2c50513          	addi	a0,a0,-468 # ffffffffc02062e0 <commands+0x870>
ffffffffc02014bc:	fd3fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(nr_free == 3);
ffffffffc02014c0:	00005697          	auipc	a3,0x5
ffffffffc02014c4:	f9868693          	addi	a3,a3,-104 # ffffffffc0206458 <commands+0x9e8>
ffffffffc02014c8:	00005617          	auipc	a2,0x5
ffffffffc02014cc:	e0060613          	addi	a2,a2,-512 # ffffffffc02062c8 <commands+0x858>
ffffffffc02014d0:	0ee00593          	li	a1,238
ffffffffc02014d4:	00005517          	auipc	a0,0x5
ffffffffc02014d8:	e0c50513          	addi	a0,a0,-500 # ffffffffc02062e0 <commands+0x870>
ffffffffc02014dc:	fb3fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_page() == NULL);
ffffffffc02014e0:	00005697          	auipc	a3,0x5
ffffffffc02014e4:	f6068693          	addi	a3,a3,-160 # ffffffffc0206440 <commands+0x9d0>
ffffffffc02014e8:	00005617          	auipc	a2,0x5
ffffffffc02014ec:	de060613          	addi	a2,a2,-544 # ffffffffc02062c8 <commands+0x858>
ffffffffc02014f0:	0e900593          	li	a1,233
ffffffffc02014f4:	00005517          	auipc	a0,0x5
ffffffffc02014f8:	dec50513          	addi	a0,a0,-532 # ffffffffc02062e0 <commands+0x870>
ffffffffc02014fc:	f93fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0201500:	00005697          	auipc	a3,0x5
ffffffffc0201504:	f2068693          	addi	a3,a3,-224 # ffffffffc0206420 <commands+0x9b0>
ffffffffc0201508:	00005617          	auipc	a2,0x5
ffffffffc020150c:	dc060613          	addi	a2,a2,-576 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201510:	0e000593          	li	a1,224
ffffffffc0201514:	00005517          	auipc	a0,0x5
ffffffffc0201518:	dcc50513          	addi	a0,a0,-564 # ffffffffc02062e0 <commands+0x870>
ffffffffc020151c:	f73fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(p0 != NULL);
ffffffffc0201520:	00005697          	auipc	a3,0x5
ffffffffc0201524:	f9068693          	addi	a3,a3,-112 # ffffffffc02064b0 <commands+0xa40>
ffffffffc0201528:	00005617          	auipc	a2,0x5
ffffffffc020152c:	da060613          	addi	a2,a2,-608 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201530:	11800593          	li	a1,280
ffffffffc0201534:	00005517          	auipc	a0,0x5
ffffffffc0201538:	dac50513          	addi	a0,a0,-596 # ffffffffc02062e0 <commands+0x870>
ffffffffc020153c:	f53fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(nr_free == 0);
ffffffffc0201540:	00005697          	auipc	a3,0x5
ffffffffc0201544:	f6068693          	addi	a3,a3,-160 # ffffffffc02064a0 <commands+0xa30>
ffffffffc0201548:	00005617          	auipc	a2,0x5
ffffffffc020154c:	d8060613          	addi	a2,a2,-640 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201550:	0fd00593          	li	a1,253
ffffffffc0201554:	00005517          	auipc	a0,0x5
ffffffffc0201558:	d8c50513          	addi	a0,a0,-628 # ffffffffc02062e0 <commands+0x870>
ffffffffc020155c:	f33fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201560:	00005697          	auipc	a3,0x5
ffffffffc0201564:	ee068693          	addi	a3,a3,-288 # ffffffffc0206440 <commands+0x9d0>
ffffffffc0201568:	00005617          	auipc	a2,0x5
ffffffffc020156c:	d6060613          	addi	a2,a2,-672 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201570:	0fb00593          	li	a1,251
ffffffffc0201574:	00005517          	auipc	a0,0x5
ffffffffc0201578:	d6c50513          	addi	a0,a0,-660 # ffffffffc02062e0 <commands+0x870>
ffffffffc020157c:	f13fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0201580:	00005697          	auipc	a3,0x5
ffffffffc0201584:	f0068693          	addi	a3,a3,-256 # ffffffffc0206480 <commands+0xa10>
ffffffffc0201588:	00005617          	auipc	a2,0x5
ffffffffc020158c:	d4060613          	addi	a2,a2,-704 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201590:	0fa00593          	li	a1,250
ffffffffc0201594:	00005517          	auipc	a0,0x5
ffffffffc0201598:	d4c50513          	addi	a0,a0,-692 # ffffffffc02062e0 <commands+0x870>
ffffffffc020159c:	ef3fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc02015a0:	00005697          	auipc	a3,0x5
ffffffffc02015a4:	d7868693          	addi	a3,a3,-648 # ffffffffc0206318 <commands+0x8a8>
ffffffffc02015a8:	00005617          	auipc	a2,0x5
ffffffffc02015ac:	d2060613          	addi	a2,a2,-736 # ffffffffc02062c8 <commands+0x858>
ffffffffc02015b0:	0d700593          	li	a1,215
ffffffffc02015b4:	00005517          	auipc	a0,0x5
ffffffffc02015b8:	d2c50513          	addi	a0,a0,-724 # ffffffffc02062e0 <commands+0x870>
ffffffffc02015bc:	ed3fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_page() == NULL);
ffffffffc02015c0:	00005697          	auipc	a3,0x5
ffffffffc02015c4:	e8068693          	addi	a3,a3,-384 # ffffffffc0206440 <commands+0x9d0>
ffffffffc02015c8:	00005617          	auipc	a2,0x5
ffffffffc02015cc:	d0060613          	addi	a2,a2,-768 # ffffffffc02062c8 <commands+0x858>
ffffffffc02015d0:	0f400593          	li	a1,244
ffffffffc02015d4:	00005517          	auipc	a0,0x5
ffffffffc02015d8:	d0c50513          	addi	a0,a0,-756 # ffffffffc02062e0 <commands+0x870>
ffffffffc02015dc:	eb3fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02015e0:	00005697          	auipc	a3,0x5
ffffffffc02015e4:	d7868693          	addi	a3,a3,-648 # ffffffffc0206358 <commands+0x8e8>
ffffffffc02015e8:	00005617          	auipc	a2,0x5
ffffffffc02015ec:	ce060613          	addi	a2,a2,-800 # ffffffffc02062c8 <commands+0x858>
ffffffffc02015f0:	0f200593          	li	a1,242
ffffffffc02015f4:	00005517          	auipc	a0,0x5
ffffffffc02015f8:	cec50513          	addi	a0,a0,-788 # ffffffffc02062e0 <commands+0x870>
ffffffffc02015fc:	e93fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201600:	00005697          	auipc	a3,0x5
ffffffffc0201604:	d3868693          	addi	a3,a3,-712 # ffffffffc0206338 <commands+0x8c8>
ffffffffc0201608:	00005617          	auipc	a2,0x5
ffffffffc020160c:	cc060613          	addi	a2,a2,-832 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201610:	0f100593          	li	a1,241
ffffffffc0201614:	00005517          	auipc	a0,0x5
ffffffffc0201618:	ccc50513          	addi	a0,a0,-820 # ffffffffc02062e0 <commands+0x870>
ffffffffc020161c:	e73fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201620:	00005697          	auipc	a3,0x5
ffffffffc0201624:	d3868693          	addi	a3,a3,-712 # ffffffffc0206358 <commands+0x8e8>
ffffffffc0201628:	00005617          	auipc	a2,0x5
ffffffffc020162c:	ca060613          	addi	a2,a2,-864 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201630:	0d900593          	li	a1,217
ffffffffc0201634:	00005517          	auipc	a0,0x5
ffffffffc0201638:	cac50513          	addi	a0,a0,-852 # ffffffffc02062e0 <commands+0x870>
ffffffffc020163c:	e53fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(count == 0);
ffffffffc0201640:	00005697          	auipc	a3,0x5
ffffffffc0201644:	fc068693          	addi	a3,a3,-64 # ffffffffc0206600 <commands+0xb90>
ffffffffc0201648:	00005617          	auipc	a2,0x5
ffffffffc020164c:	c8060613          	addi	a2,a2,-896 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201650:	14600593          	li	a1,326
ffffffffc0201654:	00005517          	auipc	a0,0x5
ffffffffc0201658:	c8c50513          	addi	a0,a0,-884 # ffffffffc02062e0 <commands+0x870>
ffffffffc020165c:	e33fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(nr_free == 0);
ffffffffc0201660:	00005697          	auipc	a3,0x5
ffffffffc0201664:	e4068693          	addi	a3,a3,-448 # ffffffffc02064a0 <commands+0xa30>
ffffffffc0201668:	00005617          	auipc	a2,0x5
ffffffffc020166c:	c6060613          	addi	a2,a2,-928 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201670:	13a00593          	li	a1,314
ffffffffc0201674:	00005517          	auipc	a0,0x5
ffffffffc0201678:	c6c50513          	addi	a0,a0,-916 # ffffffffc02062e0 <commands+0x870>
ffffffffc020167c:	e13fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201680:	00005697          	auipc	a3,0x5
ffffffffc0201684:	dc068693          	addi	a3,a3,-576 # ffffffffc0206440 <commands+0x9d0>
ffffffffc0201688:	00005617          	auipc	a2,0x5
ffffffffc020168c:	c4060613          	addi	a2,a2,-960 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201690:	13800593          	li	a1,312
ffffffffc0201694:	00005517          	auipc	a0,0x5
ffffffffc0201698:	c4c50513          	addi	a0,a0,-948 # ffffffffc02062e0 <commands+0x870>
ffffffffc020169c:	df3fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc02016a0:	00005697          	auipc	a3,0x5
ffffffffc02016a4:	d6068693          	addi	a3,a3,-672 # ffffffffc0206400 <commands+0x990>
ffffffffc02016a8:	00005617          	auipc	a2,0x5
ffffffffc02016ac:	c2060613          	addi	a2,a2,-992 # ffffffffc02062c8 <commands+0x858>
ffffffffc02016b0:	0df00593          	li	a1,223
ffffffffc02016b4:	00005517          	auipc	a0,0x5
ffffffffc02016b8:	c2c50513          	addi	a0,a0,-980 # ffffffffc02062e0 <commands+0x870>
ffffffffc02016bc:	dd3fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc02016c0:	00005697          	auipc	a3,0x5
ffffffffc02016c4:	f0068693          	addi	a3,a3,-256 # ffffffffc02065c0 <commands+0xb50>
ffffffffc02016c8:	00005617          	auipc	a2,0x5
ffffffffc02016cc:	c0060613          	addi	a2,a2,-1024 # ffffffffc02062c8 <commands+0x858>
ffffffffc02016d0:	13200593          	li	a1,306
ffffffffc02016d4:	00005517          	auipc	a0,0x5
ffffffffc02016d8:	c0c50513          	addi	a0,a0,-1012 # ffffffffc02062e0 <commands+0x870>
ffffffffc02016dc:	db3fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02016e0:	00005697          	auipc	a3,0x5
ffffffffc02016e4:	ec068693          	addi	a3,a3,-320 # ffffffffc02065a0 <commands+0xb30>
ffffffffc02016e8:	00005617          	auipc	a2,0x5
ffffffffc02016ec:	be060613          	addi	a2,a2,-1056 # ffffffffc02062c8 <commands+0x858>
ffffffffc02016f0:	13000593          	li	a1,304
ffffffffc02016f4:	00005517          	auipc	a0,0x5
ffffffffc02016f8:	bec50513          	addi	a0,a0,-1044 # ffffffffc02062e0 <commands+0x870>
ffffffffc02016fc:	d93fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201700:	00005697          	auipc	a3,0x5
ffffffffc0201704:	e7868693          	addi	a3,a3,-392 # ffffffffc0206578 <commands+0xb08>
ffffffffc0201708:	00005617          	auipc	a2,0x5
ffffffffc020170c:	bc060613          	addi	a2,a2,-1088 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201710:	12e00593          	li	a1,302
ffffffffc0201714:	00005517          	auipc	a0,0x5
ffffffffc0201718:	bcc50513          	addi	a0,a0,-1076 # ffffffffc02062e0 <commands+0x870>
ffffffffc020171c:	d73fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201720:	00005697          	auipc	a3,0x5
ffffffffc0201724:	e3068693          	addi	a3,a3,-464 # ffffffffc0206550 <commands+0xae0>
ffffffffc0201728:	00005617          	auipc	a2,0x5
ffffffffc020172c:	ba060613          	addi	a2,a2,-1120 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201730:	12d00593          	li	a1,301
ffffffffc0201734:	00005517          	auipc	a0,0x5
ffffffffc0201738:	bac50513          	addi	a0,a0,-1108 # ffffffffc02062e0 <commands+0x870>
ffffffffc020173c:	d53fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201740:	00005697          	auipc	a3,0x5
ffffffffc0201744:	e0068693          	addi	a3,a3,-512 # ffffffffc0206540 <commands+0xad0>
ffffffffc0201748:	00005617          	auipc	a2,0x5
ffffffffc020174c:	b8060613          	addi	a2,a2,-1152 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201750:	12800593          	li	a1,296
ffffffffc0201754:	00005517          	auipc	a0,0x5
ffffffffc0201758:	b8c50513          	addi	a0,a0,-1140 # ffffffffc02062e0 <commands+0x870>
ffffffffc020175c:	d33fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201760:	00005697          	auipc	a3,0x5
ffffffffc0201764:	ce068693          	addi	a3,a3,-800 # ffffffffc0206440 <commands+0x9d0>
ffffffffc0201768:	00005617          	auipc	a2,0x5
ffffffffc020176c:	b6060613          	addi	a2,a2,-1184 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201770:	12700593          	li	a1,295
ffffffffc0201774:	00005517          	auipc	a0,0x5
ffffffffc0201778:	b6c50513          	addi	a0,a0,-1172 # ffffffffc02062e0 <commands+0x870>
ffffffffc020177c:	d13fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201780:	00005697          	auipc	a3,0x5
ffffffffc0201784:	da068693          	addi	a3,a3,-608 # ffffffffc0206520 <commands+0xab0>
ffffffffc0201788:	00005617          	auipc	a2,0x5
ffffffffc020178c:	b4060613          	addi	a2,a2,-1216 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201790:	12600593          	li	a1,294
ffffffffc0201794:	00005517          	auipc	a0,0x5
ffffffffc0201798:	b4c50513          	addi	a0,a0,-1204 # ffffffffc02062e0 <commands+0x870>
ffffffffc020179c:	cf3fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc02017a0:	00005697          	auipc	a3,0x5
ffffffffc02017a4:	d5068693          	addi	a3,a3,-688 # ffffffffc02064f0 <commands+0xa80>
ffffffffc02017a8:	00005617          	auipc	a2,0x5
ffffffffc02017ac:	b2060613          	addi	a2,a2,-1248 # ffffffffc02062c8 <commands+0x858>
ffffffffc02017b0:	12500593          	li	a1,293
ffffffffc02017b4:	00005517          	auipc	a0,0x5
ffffffffc02017b8:	b2c50513          	addi	a0,a0,-1236 # ffffffffc02062e0 <commands+0x870>
ffffffffc02017bc:	cd3fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc02017c0:	00005697          	auipc	a3,0x5
ffffffffc02017c4:	d1868693          	addi	a3,a3,-744 # ffffffffc02064d8 <commands+0xa68>
ffffffffc02017c8:	00005617          	auipc	a2,0x5
ffffffffc02017cc:	b0060613          	addi	a2,a2,-1280 # ffffffffc02062c8 <commands+0x858>
ffffffffc02017d0:	12400593          	li	a1,292
ffffffffc02017d4:	00005517          	auipc	a0,0x5
ffffffffc02017d8:	b0c50513          	addi	a0,a0,-1268 # ffffffffc02062e0 <commands+0x870>
ffffffffc02017dc:	cb3fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(alloc_page() == NULL);
ffffffffc02017e0:	00005697          	auipc	a3,0x5
ffffffffc02017e4:	c6068693          	addi	a3,a3,-928 # ffffffffc0206440 <commands+0x9d0>
ffffffffc02017e8:	00005617          	auipc	a2,0x5
ffffffffc02017ec:	ae060613          	addi	a2,a2,-1312 # ffffffffc02062c8 <commands+0x858>
ffffffffc02017f0:	11e00593          	li	a1,286
ffffffffc02017f4:	00005517          	auipc	a0,0x5
ffffffffc02017f8:	aec50513          	addi	a0,a0,-1300 # ffffffffc02062e0 <commands+0x870>
ffffffffc02017fc:	c93fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(!PageProperty(p0));
ffffffffc0201800:	00005697          	auipc	a3,0x5
ffffffffc0201804:	cc068693          	addi	a3,a3,-832 # ffffffffc02064c0 <commands+0xa50>
ffffffffc0201808:	00005617          	auipc	a2,0x5
ffffffffc020180c:	ac060613          	addi	a2,a2,-1344 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201810:	11900593          	li	a1,281
ffffffffc0201814:	00005517          	auipc	a0,0x5
ffffffffc0201818:	acc50513          	addi	a0,a0,-1332 # ffffffffc02062e0 <commands+0x870>
ffffffffc020181c:	c73fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201820:	00005697          	auipc	a3,0x5
ffffffffc0201824:	dc068693          	addi	a3,a3,-576 # ffffffffc02065e0 <commands+0xb70>
ffffffffc0201828:	00005617          	auipc	a2,0x5
ffffffffc020182c:	aa060613          	addi	a2,a2,-1376 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201830:	13700593          	li	a1,311
ffffffffc0201834:	00005517          	auipc	a0,0x5
ffffffffc0201838:	aac50513          	addi	a0,a0,-1364 # ffffffffc02062e0 <commands+0x870>
ffffffffc020183c:	c53fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(total == 0);
ffffffffc0201840:	00005697          	auipc	a3,0x5
ffffffffc0201844:	dd068693          	addi	a3,a3,-560 # ffffffffc0206610 <commands+0xba0>
ffffffffc0201848:	00005617          	auipc	a2,0x5
ffffffffc020184c:	a8060613          	addi	a2,a2,-1408 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201850:	14700593          	li	a1,327
ffffffffc0201854:	00005517          	auipc	a0,0x5
ffffffffc0201858:	a8c50513          	addi	a0,a0,-1396 # ffffffffc02062e0 <commands+0x870>
ffffffffc020185c:	c33fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(total == nr_free_pages());
ffffffffc0201860:	00005697          	auipc	a3,0x5
ffffffffc0201864:	a9868693          	addi	a3,a3,-1384 # ffffffffc02062f8 <commands+0x888>
ffffffffc0201868:	00005617          	auipc	a2,0x5
ffffffffc020186c:	a6060613          	addi	a2,a2,-1440 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201870:	11300593          	li	a1,275
ffffffffc0201874:	00005517          	auipc	a0,0x5
ffffffffc0201878:	a6c50513          	addi	a0,a0,-1428 # ffffffffc02062e0 <commands+0x870>
ffffffffc020187c:	c13fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201880:	00005697          	auipc	a3,0x5
ffffffffc0201884:	ab868693          	addi	a3,a3,-1352 # ffffffffc0206338 <commands+0x8c8>
ffffffffc0201888:	00005617          	auipc	a2,0x5
ffffffffc020188c:	a4060613          	addi	a2,a2,-1472 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201890:	0d800593          	li	a1,216
ffffffffc0201894:	00005517          	auipc	a0,0x5
ffffffffc0201898:	a4c50513          	addi	a0,a0,-1460 # ffffffffc02062e0 <commands+0x870>
...
ffffffffc02019d0:	c5c68693          	addi	a3,a3,-932 # ffffffffc0206628 <commands+0xbb8>
ffffffffc02019d4:	00005617          	auipc	a2,0x5
ffffffffc02019d8:	8f460613          	addi	a2,a2,-1804 # ffffffffc02062c8 <commands+0x858>
ffffffffc02019dc:	09400593          	li	a1,148
ffffffffc02019e0:	00005517          	auipc	a0,0x5
ffffffffc02019e4:	90050513          	addi	a0,a0,-1792 # ffffffffc02062e0 <commands+0x870>
ffffffffc02019e8:	aa7fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(n > 0);
ffffffffc02019ec:	00005697          	auipc	a3,0x5
ffffffffc02019f0:	c3468693          	addi	a3,a3,-972 # ffffffffc0206620 <commands+0xbb0>
ffffffffc02019f4:	00005617          	auipc	a2,0x5
ffffffffc02019f8:	8d460613          	addi	a2,a2,-1836 # ffffffffc02062c8 <commands+0x858>
ffffffffc02019fc:	09000593          	li	a1,144
ffffffffc0201a00:	00005517          	auipc	a0,0x5
ffffffffc0201a04:	8e050513          	addi	a0,a0,-1824 # ffffffffc02062e0 <commands+0x870>
...
ffffffffc0201aa2:	b8268693          	addi	a3,a3,-1150 # ffffffffc0206620 <commands+0xbb0>
ffffffffc0201aa6:	00005617          	auipc	a2,0x5
ffffffffc0201aaa:	82260613          	addi	a2,a2,-2014 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201aae:	06c00593          	li	a1,108
ffffffffc0201ab2:	00005517          	auipc	a0,0x5
ffffffffc0201ab6:	82e50513          	addi	a0,a0,-2002 # ffffffffc02062e0 <commands+0x870>
{
...
ffffffffc0201b74:	ae068693          	addi	a3,a3,-1312 # ffffffffc0206650 <commands+0xbe0>
ffffffffc0201b78:	00004617          	auipc	a2,0x4
ffffffffc0201b7c:	75060613          	addi	a2,a2,1872 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201b80:	04b00593          	li	a1,75
ffffffffc0201b84:	00004517          	auipc	a0,0x4
ffffffffc0201b88:	75c50513          	addi	a0,a0,1884 # ffffffffc02062e0 <commands+0x870>
ffffffffc0201b8c:	903fe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(n > 0);
ffffffffc0201b90:	00005697          	auipc	a3,0x5
ffffffffc0201b94:	a9068693          	addi	a3,a3,-1392 # ffffffffc0206620 <commands+0xbb0>
ffffffffc0201b98:	00004617          	auipc	a2,0x4
ffffffffc0201b9c:	73060613          	addi	a2,a2,1840 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201ba0:	04700593          	li	a1,71
ffffffffc0201ba4:	00004517          	auipc	a0,0x4
ffffffffc0201ba8:	73c50513          	addi	a0,a0,1852 # ffffffffc02062e0 <commands+0x870>
...
ffffffffc0201c84:	ca86b683          	ld	a3,-856(a3) # ffffffffc0207928 <nbase>
...
ffffffffc0201cb4:	57060613          	addi	a2,a2,1392 # ffffffffc0206220 <commands+0x7b0>
ffffffffc0201cb8:	07100593          	li	a1,113
ffffffffc0201cbc:	00004517          	auipc	a0,0x4
ffffffffc0201cc0:	58c50513          	addi	a0,a0,1420 # ffffffffc0206248 <commands+0x7d8>
...
ffffffffc0201da2:	91268693          	addi	a3,a3,-1774 # ffffffffc02066b0 <default_pmm_manager+0x38>
ffffffffc0201da6:	00004617          	auipc	a2,0x4
ffffffffc0201daa:	52260613          	addi	a2,a2,1314 # ffffffffc02062c8 <commands+0x858>
ffffffffc0201dae:	06300593          	li	a1,99
ffffffffc0201db2:	00005517          	auipc	a0,0x5
ffffffffc0201db6:	91e50513          	addi	a0,a0,-1762 # ffffffffc02066d0 <default_pmm_manager+0x58>
...
ffffffffc0201dc4:	92850513          	addi	a0,a0,-1752 # ffffffffc02066e8 <default_pmm_manager+0x70>
{
...
ffffffffc0201dd4:	93050513          	addi	a0,a0,-1744 # ffffffffc0206700 <default_pmm_manager+0x88>
}
...
ffffffffc0201ec0:	a021                	j	ffffffffc0201ec8 <kfree+0x36>
		for (bb = bigblocks; bb; last = &bb->next, bb = bb->next)
ffffffffc0201ec2:	01048693          	addi	a3,s1,16
...
ffffffffc0201efc:	a3053503          	ld	a0,-1488(a0) # ffffffffc0207928 <nbase>
...
ffffffffc0201f56:	00004617          	auipc	a2,0x4
ffffffffc0201f5a:	7f260613          	addi	a2,a2,2034 # ffffffffc0206748 <default_pmm_manager+0xd0>
ffffffffc0201f5e:	06900593          	li	a1,105
ffffffffc0201f62:	00004517          	auipc	a0,0x4
ffffffffc0201f66:	2e650513          	addi	a0,a0,742 # ffffffffc0206248 <commands+0x7d8>
...
ffffffffc0201f74:	7b060613          	addi	a2,a2,1968 # ffffffffc0206720 <default_pmm_manager+0xa8>
ffffffffc0201f78:	07700593          	li	a1,119
ffffffffc0201f7c:	00004517          	auipc	a0,0x4
ffffffffc0201f80:	2cc50513          	addi	a0,a0,716 # ffffffffc0206248 <commands+0x7d8>
...
ffffffffc0201f8e:	7be60613          	addi	a2,a2,1982 # ffffffffc0206748 <default_pmm_manager+0xd0>
ffffffffc0201f92:	06900593          	li	a1,105
ffffffffc0201f96:	00004517          	auipc	a0,0x4
ffffffffc0201f9a:	2b250513          	addi	a0,a0,690 # ffffffffc0206248 <commands+0x7d8>
pa2page(uintptr_t pa)
...
ffffffffc0201faa:	7c260613          	addi	a2,a2,1986 # ffffffffc0206768 <default_pmm_manager+0xf0>
ffffffffc0201fae:	07f00593          	li	a1,127
ffffffffc0201fb2:	00004517          	auipc	a0,0x4
ffffffffc0201fb6:	29650513          	addi	a0,a0,662 # ffffffffc0206248 <commands+0x7d8>
pte2page(pte_t pte)
...
ffffffffc0202110:	6cc030ef          	jal	ra,ffffffffc02057dc <memset>
    return page - pages + nbase;
...
ffffffffc02021b2:	62a030ef          	jal	ra,ffffffffc02057dc <memset>
    return page - pages + nbase;
...
ffffffffc0202240:	fe460613          	addi	a2,a2,-28 # ffffffffc0206220 <commands+0x7b0>
ffffffffc0202244:	0fa00593          	li	a1,250
ffffffffc0202248:	00004517          	auipc	a0,0x4
ffffffffc020224c:	54850513          	addi	a0,a0,1352 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0202250:	a3efe0ef          	jal	ra,ffffffffc020048e <__panic>
    pde_t *pdep0 = &((pde_t *)KADDR(PDE_ADDR(*pdep1)))[PDX0(la)];
ffffffffc0202254:	00004617          	auipc	a2,0x4
ffffffffc0202258:	fcc60613          	addi	a2,a2,-52 # ffffffffc0206220 <commands+0x7b0>
ffffffffc020225c:	0ed00593          	li	a1,237
ffffffffc0202260:	00004517          	auipc	a0,0x4
ffffffffc0202264:	53050513          	addi	a0,a0,1328 # ffffffffc0206790 <default_pmm_manager+0x118>
...
ffffffffc0202272:	fb260613          	addi	a2,a2,-78 # ffffffffc0206220 <commands+0x7b0>
ffffffffc0202276:	0e900593          	li	a1,233
ffffffffc020227a:	00004517          	auipc	a0,0x4
ffffffffc020227e:	51650513          	addi	a0,a0,1302 # ffffffffc0206790 <default_pmm_manager+0x118>
...
ffffffffc020228c:	f9860613          	addi	a2,a2,-104 # ffffffffc0206220 <commands+0x7b0>
ffffffffc0202290:	0f700593          	li	a1,247
ffffffffc0202294:	00004517          	auipc	a0,0x4
ffffffffc0202298:	4fc50513          	addi	a0,a0,1276 # ffffffffc0206790 <default_pmm_manager+0x118>
...
ffffffffc02023fa:	3aa68693          	addi	a3,a3,938 # ffffffffc02067a0 <default_pmm_manager+0x128>
ffffffffc02023fe:	00004617          	auipc	a2,0x4
ffffffffc0202402:	eca60613          	addi	a2,a2,-310 # ffffffffc02062c8 <commands+0x858>
ffffffffc0202406:	12000593          	li	a1,288
ffffffffc020240a:	00004517          	auipc	a0,0x4
ffffffffc020240e:	38650513          	addi	a0,a0,902 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0202412:	87cfe0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc0202416:	00004697          	auipc	a3,0x4
ffffffffc020241a:	3ba68693          	addi	a3,a3,954 # ffffffffc02067d0 <default_pmm_manager+0x158>
ffffffffc020241e:	00004617          	auipc	a2,0x4
ffffffffc0202422:	eaa60613          	addi	a2,a2,-342 # ffffffffc02062c8 <commands+0x858>
ffffffffc0202426:	12100593          	li	a1,289
ffffffffc020242a:	00004517          	auipc	a0,0x4
ffffffffc020242e:	36650513          	addi	a0,a0,870 # ffffffffc0206790 <default_pmm_manager+0x118>
...
ffffffffc0202674:	13068693          	addi	a3,a3,304 # ffffffffc02067a0 <default_pmm_manager+0x128>
ffffffffc0202678:	00004617          	auipc	a2,0x4
ffffffffc020267c:	c5060613          	addi	a2,a2,-944 # ffffffffc02062c8 <commands+0x858>
ffffffffc0202680:	13500593          	li	a1,309
ffffffffc0202684:	00004517          	auipc	a0,0x4
ffffffffc0202688:	10c50513          	addi	a0,a0,268 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc020268c:	e03fd0ef          	jal	ra,ffffffffc020048e <__panic>
    return KADDR(page2pa(page));
ffffffffc0202690:	00004617          	auipc	a2,0x4
ffffffffc0202694:	b9060613          	addi	a2,a2,-1136 # ffffffffc0206220 <commands+0x7b0>
ffffffffc0202698:	07100593          	li	a1,113
ffffffffc020269c:	00004517          	auipc	a0,0x4
ffffffffc02026a0:	bac50513          	addi	a0,a0,-1108 # ffffffffc0206248 <commands+0x7d8>
...
ffffffffc02026b0:	12468693          	addi	a3,a3,292 # ffffffffc02067d0 <default_pmm_manager+0x158>
ffffffffc02026b4:	00004617          	auipc	a2,0x4
ffffffffc02026b8:	c1460613          	addi	a2,a2,-1004 # ffffffffc02062c8 <commands+0x858>
ffffffffc02026bc:	13600593          	li	a1,310
ffffffffc02026c0:	00004517          	auipc	a0,0x4
ffffffffc02026c4:	0d050513          	addi	a0,a0,208 # ffffffffc0206790 <default_pmm_manager+0x118>
...
ffffffffc0202862:	e1a78793          	addi	a5,a5,-486 # ffffffffc0206678 <default_pmm_manager>
...
ffffffffc0202870:	f7c50513          	addi	a0,a0,-132 # ffffffffc02067e8 <default_pmm_manager+0x170>
    pmm_manager = &default_pmm_manager;
...
ffffffffc02028c4:	f6050513          	addi	a0,a0,-160 # ffffffffc0206820 <default_pmm_manager+0x1a8>
...
ffffffffc02028dc:	f6050513          	addi	a0,a0,-160 # ffffffffc0206838 <default_pmm_manager+0x1c0>
...
ffffffffc0202964:	f0050513          	addi	a0,a0,-256 # ffffffffc0206860 <default_pmm_manager+0x1e8>
...
ffffffffc0202980:	efc50513          	addi	a0,a0,-260 # ffffffffc0206878 <default_pmm_manager+0x200>
...
ffffffffc0202c36:	f6e50513          	addi	a0,a0,-146 # ffffffffc0206ba0 <default_pmm_manager+0x528>
...
ffffffffc0202cfa:	ff258593          	addi	a1,a1,-14 # ffffffffc0206ce8 <default_pmm_manager+0x670>
ffffffffc0202cfe:	10000513          	li	a0,256
ffffffffc0202d02:	26f020ef          	jal	ra,ffffffffc0205770 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202d06:	10040593          	addi	a1,s0,256
ffffffffc0202d0a:	10000513          	li	a0,256
ffffffffc0202d0e:	275020ef          	jal	ra,ffffffffc0205782 <strcmp>
...
ffffffffc0202d40:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202d44:	1f7020ef          	jal	ra,ffffffffc020573a <strlen>
...
ffffffffc0202e08:	f5c50513          	addi	a0,a0,-164 # ffffffffc0206d60 <default_pmm_manager+0x6e8>
...
ffffffffc0202f70:	2b460613          	addi	a2,a2,692 # ffffffffc0206220 <commands+0x7b0>
ffffffffc0202f74:	25400593          	li	a1,596
ffffffffc0202f78:	00004517          	auipc	a0,0x4
ffffffffc0202f7c:	81850513          	addi	a0,a0,-2024 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0202f80:	d0efd0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0202f84:	00004697          	auipc	a3,0x4
ffffffffc0202f88:	c7c68693          	addi	a3,a3,-900 # ffffffffc0206c00 <default_pmm_manager+0x588>
ffffffffc0202f8c:	00003617          	auipc	a2,0x3
ffffffffc0202f90:	33c60613          	addi	a2,a2,828 # ffffffffc02062c8 <commands+0x858>
ffffffffc0202f94:	25500593          	li	a1,597
ffffffffc0202f98:	00003517          	auipc	a0,0x3
ffffffffc0202f9c:	7f850513          	addi	a0,a0,2040 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0202fa0:	ceefd0ef          	jal	ra,ffffffffc020048e <__panic>
        assert((ptep = get_pte(boot_pgdir_va, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc0202fa4:	00004697          	auipc	a3,0x4
ffffffffc0202fa8:	c1c68693          	addi	a3,a3,-996 # ffffffffc0206bc0 <default_pmm_manager+0x548>
ffffffffc0202fac:	00003617          	auipc	a2,0x3
ffffffffc0202fb0:	31c60613          	addi	a2,a2,796 # ffffffffc02062c8 <commands+0x858>
ffffffffc0202fb4:	25400593          	li	a1,596
ffffffffc0202fb8:	00003517          	auipc	a0,0x3
ffffffffc0202fbc:	7d850513          	addi	a0,a0,2008 # ffffffffc0206790 <default_pmm_manager+0x118>
...
ffffffffc0202fd0:	9ec68693          	addi	a3,a3,-1556 # ffffffffc02069b8 <default_pmm_manager+0x340>
ffffffffc0202fd4:	00003617          	auipc	a2,0x3
ffffffffc0202fd8:	2f460613          	addi	a2,a2,756 # ffffffffc02062c8 <commands+0x858>
ffffffffc0202fdc:	22400593          	li	a1,548
ffffffffc0202fe0:	00003517          	auipc	a0,0x3
ffffffffc0202fe4:	7b050513          	addi	a0,a0,1968 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0202fe8:	ca6fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(get_page(boot_pgdir_va, 0x0, NULL) == NULL);
ffffffffc0202fec:	00004697          	auipc	a3,0x4
ffffffffc0202ff0:	90c68693          	addi	a3,a3,-1780 # ffffffffc02068f8 <default_pmm_manager+0x280>
ffffffffc0202ff4:	00003617          	auipc	a2,0x3
ffffffffc0202ff8:	2d460613          	addi	a2,a2,724 # ffffffffc02062c8 <commands+0x858>
ffffffffc0202ffc:	21700593          	li	a1,535
ffffffffc0203000:	00003517          	auipc	a0,0x3
ffffffffc0203004:	79050513          	addi	a0,a0,1936 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203008:	c86fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(boot_pgdir_va != NULL && (uint32_t)PGOFF(boot_pgdir_va) == 0);
ffffffffc020300c:	00004697          	auipc	a3,0x4
ffffffffc0203010:	8ac68693          	addi	a3,a3,-1876 # ffffffffc02068b8 <default_pmm_manager+0x240>
ffffffffc0203014:	00003617          	auipc	a2,0x3
ffffffffc0203018:	2b460613          	addi	a2,a2,692 # ffffffffc02062c8 <commands+0x858>
ffffffffc020301c:	21600593          	li	a1,534
ffffffffc0203020:	00003517          	auipc	a0,0x3
ffffffffc0203024:	77050513          	addi	a0,a0,1904 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203028:	c66fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020302c:	00004697          	auipc	a3,0x4
ffffffffc0203030:	86c68693          	addi	a3,a3,-1940 # ffffffffc0206898 <default_pmm_manager+0x220>
ffffffffc0203034:	00003617          	auipc	a2,0x3
ffffffffc0203038:	29460613          	addi	a2,a2,660 # ffffffffc02062c8 <commands+0x858>
ffffffffc020303c:	21500593          	li	a1,533
ffffffffc0203040:	00003517          	auipc	a0,0x3
ffffffffc0203044:	75050513          	addi	a0,a0,1872 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203048:	c46fd0ef          	jal	ra,ffffffffc020048e <__panic>
    return KADDR(page2pa(page));
ffffffffc020304c:	00003617          	auipc	a2,0x3
ffffffffc0203050:	1d460613          	addi	a2,a2,468 # ffffffffc0206220 <commands+0x7b0>
ffffffffc0203054:	07100593          	li	a1,113
ffffffffc0203058:	00003517          	auipc	a0,0x3
ffffffffc020305c:	1f050513          	addi	a0,a0,496 # ffffffffc0206248 <commands+0x7d8>
ffffffffc0203060:	c2efd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(pde2page(boot_pgdir_va[0])) == 1);
ffffffffc0203064:	00004697          	auipc	a3,0x4
ffffffffc0203068:	ae468693          	addi	a3,a3,-1308 # ffffffffc0206b48 <default_pmm_manager+0x4d0>
ffffffffc020306c:	00003617          	auipc	a2,0x3
ffffffffc0203070:	25c60613          	addi	a2,a2,604 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203074:	23d00593          	li	a1,573
ffffffffc0203078:	00003517          	auipc	a0,0x3
ffffffffc020307c:	71850513          	addi	a0,a0,1816 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203080:	c0efd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0203084:	00004697          	auipc	a3,0x4
ffffffffc0203088:	a7c68693          	addi	a3,a3,-1412 # ffffffffc0206b00 <default_pmm_manager+0x488>
ffffffffc020308c:	00003617          	auipc	a2,0x3
ffffffffc0203090:	23c60613          	addi	a2,a2,572 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203094:	23b00593          	li	a1,571
ffffffffc0203098:	00003517          	auipc	a0,0x3
ffffffffc020309c:	6f850513          	addi	a0,a0,1784 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02030a0:	beefd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02030a4:	00004697          	auipc	a3,0x4
ffffffffc02030a8:	a8c68693          	addi	a3,a3,-1396 # ffffffffc0206b30 <default_pmm_manager+0x4b8>
ffffffffc02030ac:	00003617          	auipc	a2,0x3
ffffffffc02030b0:	21c60613          	addi	a2,a2,540 # ffffffffc02062c8 <commands+0x858>
ffffffffc02030b4:	23a00593          	li	a1,570
ffffffffc02030b8:	00003517          	auipc	a0,0x3
ffffffffc02030bc:	6d850513          	addi	a0,a0,1752 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02030c0:	bcefd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(boot_pgdir_va[0] == 0);
ffffffffc02030c4:	00004697          	auipc	a3,0x4
ffffffffc02030c8:	b5468693          	addi	a3,a3,-1196 # ffffffffc0206c18 <default_pmm_manager+0x5a0>
ffffffffc02030cc:	00003617          	auipc	a2,0x3
ffffffffc02030d0:	1fc60613          	addi	a2,a2,508 # ffffffffc02062c8 <commands+0x858>
ffffffffc02030d4:	25800593          	li	a1,600
ffffffffc02030d8:	00003517          	auipc	a0,0x3
ffffffffc02030dc:	6b850513          	addi	a0,a0,1720 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02030e0:	baefd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc02030e4:	00004697          	auipc	a3,0x4
ffffffffc02030e8:	a9468693          	addi	a3,a3,-1388 # ffffffffc0206b78 <default_pmm_manager+0x500>
ffffffffc02030ec:	00003617          	auipc	a2,0x3
ffffffffc02030f0:	1dc60613          	addi	a2,a2,476 # ffffffffc02062c8 <commands+0x858>
ffffffffc02030f4:	24500593          	li	a1,581
ffffffffc02030f8:	00003517          	auipc	a0,0x3
ffffffffc02030fc:	69850513          	addi	a0,a0,1688 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203100:	b8efd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p) == 1);
ffffffffc0203104:	00004697          	auipc	a3,0x4
ffffffffc0203108:	b6c68693          	addi	a3,a3,-1172 # ffffffffc0206c70 <default_pmm_manager+0x5f8>
ffffffffc020310c:	00003617          	auipc	a2,0x3
ffffffffc0203110:	1bc60613          	addi	a2,a2,444 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203114:	25d00593          	li	a1,605
ffffffffc0203118:	00003517          	auipc	a0,0x3
ffffffffc020311c:	67850513          	addi	a0,a0,1656 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203120:	b6efd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0203124:	00004697          	auipc	a3,0x4
ffffffffc0203128:	b0c68693          	addi	a3,a3,-1268 # ffffffffc0206c30 <default_pmm_manager+0x5b8>
ffffffffc020312c:	00003617          	auipc	a2,0x3
ffffffffc0203130:	19c60613          	addi	a2,a2,412 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203134:	25c00593          	li	a1,604
ffffffffc0203138:	00003517          	auipc	a0,0x3
ffffffffc020313c:	65850513          	addi	a0,a0,1624 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203140:	b4efd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0203144:	00004697          	auipc	a3,0x4
ffffffffc0203148:	9bc68693          	addi	a3,a3,-1604 # ffffffffc0206b00 <default_pmm_manager+0x488>
ffffffffc020314c:	00003617          	auipc	a2,0x3
ffffffffc0203150:	17c60613          	addi	a2,a2,380 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203154:	23700593          	li	a1,567
ffffffffc0203158:	00003517          	auipc	a0,0x3
ffffffffc020315c:	63850513          	addi	a0,a0,1592 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203160:	b2efd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0203164:	00004697          	auipc	a3,0x4
ffffffffc0203168:	83c68693          	addi	a3,a3,-1988 # ffffffffc02069a0 <default_pmm_manager+0x328>
ffffffffc020316c:	00003617          	auipc	a2,0x3
ffffffffc0203170:	15c60613          	addi	a2,a2,348 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203174:	23600593          	li	a1,566
ffffffffc0203178:	00003517          	auipc	a0,0x3
ffffffffc020317c:	61850513          	addi	a0,a0,1560 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203180:	b0efd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0203184:	00004697          	auipc	a3,0x4
ffffffffc0203188:	99468693          	addi	a3,a3,-1644 # ffffffffc0206b18 <default_pmm_manager+0x4a0>
ffffffffc020318c:	00003617          	auipc	a2,0x3
ffffffffc0203190:	13c60613          	addi	a2,a2,316 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203194:	23300593          	li	a1,563
ffffffffc0203198:	00003517          	auipc	a0,0x3
ffffffffc020319c:	5f850513          	addi	a0,a0,1528 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02031a0:	aeefd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02031a4:	00003697          	auipc	a3,0x3
ffffffffc02031a8:	7e468693          	addi	a3,a3,2020 # ffffffffc0206988 <default_pmm_manager+0x310>
ffffffffc02031ac:	00003617          	auipc	a2,0x3
ffffffffc02031b0:	11c60613          	addi	a2,a2,284 # ffffffffc02062c8 <commands+0x858>
ffffffffc02031b4:	23200593          	li	a1,562
ffffffffc02031b8:	00003517          	auipc	a0,0x3
ffffffffc02031bc:	5d850513          	addi	a0,a0,1496 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02031c0:	acefd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc02031c4:	00004697          	auipc	a3,0x4
ffffffffc02031c8:	86468693          	addi	a3,a3,-1948 # ffffffffc0206a28 <default_pmm_manager+0x3b0>
ffffffffc02031cc:	00003617          	auipc	a2,0x3
ffffffffc02031d0:	0fc60613          	addi	a2,a2,252 # ffffffffc02062c8 <commands+0x858>
ffffffffc02031d4:	23100593          	li	a1,561
ffffffffc02031d8:	00003517          	auipc	a0,0x3
ffffffffc02031dc:	5b850513          	addi	a0,a0,1464 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02031e0:	aaefd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02031e4:	00004697          	auipc	a3,0x4
ffffffffc02031e8:	91c68693          	addi	a3,a3,-1764 # ffffffffc0206b00 <default_pmm_manager+0x488>
ffffffffc02031ec:	00003617          	auipc	a2,0x3
ffffffffc02031f0:	0dc60613          	addi	a2,a2,220 # ffffffffc02062c8 <commands+0x858>
ffffffffc02031f4:	23000593          	li	a1,560
ffffffffc02031f8:	00003517          	auipc	a0,0x3
ffffffffc02031fc:	59850513          	addi	a0,a0,1432 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203200:	a8efd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0203204:	00004697          	auipc	a3,0x4
ffffffffc0203208:	8e468693          	addi	a3,a3,-1820 # ffffffffc0206ae8 <default_pmm_manager+0x470>
ffffffffc020320c:	00003617          	auipc	a2,0x3
ffffffffc0203210:	0bc60613          	addi	a2,a2,188 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203214:	22f00593          	li	a1,559
ffffffffc0203218:	00003517          	auipc	a0,0x3
ffffffffc020321c:	57850513          	addi	a0,a0,1400 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203220:	a6efd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_insert(boot_pgdir_va, p1, PGSIZE, 0) == 0);
ffffffffc0203224:	00004697          	auipc	a3,0x4
ffffffffc0203228:	89468693          	addi	a3,a3,-1900 # ffffffffc0206ab8 <default_pmm_manager+0x440>
ffffffffc020322c:	00003617          	auipc	a2,0x3
ffffffffc0203230:	09c60613          	addi	a2,a2,156 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203234:	22e00593          	li	a1,558
ffffffffc0203238:	00003517          	auipc	a0,0x3
ffffffffc020323c:	55850513          	addi	a0,a0,1368 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203240:	a4efd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0203244:	00004697          	auipc	a3,0x4
ffffffffc0203248:	85c68693          	addi	a3,a3,-1956 # ffffffffc0206aa0 <default_pmm_manager+0x428>
ffffffffc020324c:	00003617          	auipc	a2,0x3
ffffffffc0203250:	07c60613          	addi	a2,a2,124 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203254:	22c00593          	li	a1,556
ffffffffc0203258:	00003517          	auipc	a0,0x3
ffffffffc020325c:	53850513          	addi	a0,a0,1336 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203260:	a2efd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(boot_pgdir_va[0] & PTE_U);
ffffffffc0203264:	00004697          	auipc	a3,0x4
ffffffffc0203268:	81c68693          	addi	a3,a3,-2020 # ffffffffc0206a80 <default_pmm_manager+0x408>
ffffffffc020326c:	00003617          	auipc	a2,0x3
ffffffffc0203270:	05c60613          	addi	a2,a2,92 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203274:	22b00593          	li	a1,555
ffffffffc0203278:	00003517          	auipc	a0,0x3
ffffffffc020327c:	51850513          	addi	a0,a0,1304 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203280:	a0efd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(*ptep & PTE_W);
ffffffffc0203284:	00003697          	auipc	a3,0x3
ffffffffc0203288:	7ec68693          	addi	a3,a3,2028 # ffffffffc0206a70 <default_pmm_manager+0x3f8>
ffffffffc020328c:	00003617          	auipc	a2,0x3
ffffffffc0203290:	03c60613          	addi	a2,a2,60 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203294:	22a00593          	li	a1,554
ffffffffc0203298:	00003517          	auipc	a0,0x3
ffffffffc020329c:	4f850513          	addi	a0,a0,1272 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02032a0:	9eefd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(*ptep & PTE_U);
ffffffffc02032a4:	00003697          	auipc	a3,0x3
ffffffffc02032a8:	7bc68693          	addi	a3,a3,1980 # ffffffffc0206a60 <default_pmm_manager+0x3e8>
ffffffffc02032ac:	00003617          	auipc	a2,0x3
ffffffffc02032b0:	01c60613          	addi	a2,a2,28 # ffffffffc02062c8 <commands+0x858>
ffffffffc02032b4:	22900593          	li	a1,553
ffffffffc02032b8:	00003517          	auipc	a0,0x3
ffffffffc02032bc:	4d850513          	addi	a0,a0,1240 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02032c0:	9cefd0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("DTB memory info not available");
ffffffffc02032c4:	00003617          	auipc	a2,0x3
ffffffffc02032c8:	53c60613          	addi	a2,a2,1340 # ffffffffc0206800 <default_pmm_manager+0x188>
ffffffffc02032cc:	06500593          	li	a1,101
ffffffffc02032d0:	00003517          	auipc	a0,0x3
ffffffffc02032d4:	4c050513          	addi	a0,a0,1216 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02032d8:	9b6fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc02032dc:	00004697          	auipc	a3,0x4
ffffffffc02032e0:	89c68693          	addi	a3,a3,-1892 # ffffffffc0206b78 <default_pmm_manager+0x500>
ffffffffc02032e4:	00003617          	auipc	a2,0x3
ffffffffc02032e8:	fe460613          	addi	a2,a2,-28 # ffffffffc02062c8 <commands+0x858>
ffffffffc02032ec:	26f00593          	li	a1,623
ffffffffc02032f0:	00003517          	auipc	a0,0x3
ffffffffc02032f4:	4a050513          	addi	a0,a0,1184 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02032f8:	996fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc02032fc:	00003697          	auipc	a3,0x3
ffffffffc0203300:	72c68693          	addi	a3,a3,1836 # ffffffffc0206a28 <default_pmm_manager+0x3b0>
ffffffffc0203304:	00003617          	auipc	a2,0x3
ffffffffc0203308:	fc460613          	addi	a2,a2,-60 # ffffffffc02062c8 <commands+0x858>
ffffffffc020330c:	22800593          	li	a1,552
ffffffffc0203310:	00003517          	auipc	a0,0x3
ffffffffc0203314:	48050513          	addi	a0,a0,1152 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203318:	976fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_insert(boot_pgdir_va, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc020331c:	00003697          	auipc	a3,0x3
ffffffffc0203320:	6cc68693          	addi	a3,a3,1740 # ffffffffc02069e8 <default_pmm_manager+0x370>
ffffffffc0203324:	00003617          	auipc	a2,0x3
ffffffffc0203328:	fa460613          	addi	a2,a2,-92 # ffffffffc02062c8 <commands+0x858>
ffffffffc020332c:	22700593          	li	a1,551
ffffffffc0203330:	00003517          	auipc	a0,0x3
ffffffffc0203334:	46050513          	addi	a0,a0,1120 # ffffffffc0206790 <default_pmm_manager+0x118>
...
ffffffffc0203342:	ee260613          	addi	a2,a2,-286 # ffffffffc0206220 <commands+0x7b0>
ffffffffc0203346:	22300593          	li	a1,547
ffffffffc020334a:	00003517          	auipc	a0,0x3
ffffffffc020334e:	44650513          	addi	a0,a0,1094 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203352:	93cfd0ef          	jal	ra,ffffffffc020048e <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir_va[0]));
ffffffffc0203356:	00003617          	auipc	a2,0x3
ffffffffc020335a:	eca60613          	addi	a2,a2,-310 # ffffffffc0206220 <commands+0x7b0>
ffffffffc020335e:	22200593          	li	a1,546
ffffffffc0203362:	00003517          	auipc	a0,0x3
ffffffffc0203366:	42e50513          	addi	a0,a0,1070 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc020336a:	924fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020336e:	00003697          	auipc	a3,0x3
ffffffffc0203372:	63268693          	addi	a3,a3,1586 # ffffffffc02069a0 <default_pmm_manager+0x328>
ffffffffc0203376:	00003617          	auipc	a2,0x3
ffffffffc020337a:	f5260613          	addi	a2,a2,-174 # ffffffffc02062c8 <commands+0x858>
ffffffffc020337e:	22000593          	li	a1,544
ffffffffc0203382:	00003517          	auipc	a0,0x3
ffffffffc0203386:	40e50513          	addi	a0,a0,1038 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc020338a:	904fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020338e:	00003697          	auipc	a3,0x3
ffffffffc0203392:	5fa68693          	addi	a3,a3,1530 # ffffffffc0206988 <default_pmm_manager+0x310>
ffffffffc0203396:	00003617          	auipc	a2,0x3
ffffffffc020339a:	f3260613          	addi	a2,a2,-206 # ffffffffc02062c8 <commands+0x858>
ffffffffc020339e:	21f00593          	li	a1,543
ffffffffc02033a2:	00003517          	auipc	a0,0x3
ffffffffc02033a6:	3ee50513          	addi	a0,a0,1006 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02033aa:	8e4fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc02033ae:	00004697          	auipc	a3,0x4
ffffffffc02033b2:	98a68693          	addi	a3,a3,-1654 # ffffffffc0206d38 <default_pmm_manager+0x6c0>
ffffffffc02033b6:	00003617          	auipc	a2,0x3
ffffffffc02033ba:	f1260613          	addi	a2,a2,-238 # ffffffffc02062c8 <commands+0x858>
ffffffffc02033be:	26600593          	li	a1,614
ffffffffc02033c2:	00003517          	auipc	a0,0x3
ffffffffc02033c6:	3ce50513          	addi	a0,a0,974 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02033ca:	8c4fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02033ce:	00004697          	auipc	a3,0x4
ffffffffc02033d2:	93268693          	addi	a3,a3,-1742 # ffffffffc0206d00 <default_pmm_manager+0x688>
ffffffffc02033d6:	00003617          	auipc	a2,0x3
ffffffffc02033da:	ef260613          	addi	a2,a2,-270 # ffffffffc02062c8 <commands+0x858>
ffffffffc02033de:	26300593          	li	a1,611
ffffffffc02033e2:	00003517          	auipc	a0,0x3
ffffffffc02033e6:	3ae50513          	addi	a0,a0,942 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02033ea:	8a4fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_ref(p) == 2);
ffffffffc02033ee:	00004697          	auipc	a3,0x4
ffffffffc02033f2:	8e268693          	addi	a3,a3,-1822 # ffffffffc0206cd0 <default_pmm_manager+0x658>
ffffffffc02033f6:	00003617          	auipc	a2,0x3
ffffffffc02033fa:	ed260613          	addi	a2,a2,-302 # ffffffffc02062c8 <commands+0x858>
ffffffffc02033fe:	25f00593          	li	a1,607
ffffffffc0203402:	00003517          	auipc	a0,0x3
ffffffffc0203406:	38e50513          	addi	a0,a0,910 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc020340a:	884fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020340e:	00004697          	auipc	a3,0x4
ffffffffc0203412:	87a68693          	addi	a3,a3,-1926 # ffffffffc0206c88 <default_pmm_manager+0x610>
ffffffffc0203416:	00003617          	auipc	a2,0x3
ffffffffc020341a:	eb260613          	addi	a2,a2,-334 # ffffffffc02062c8 <commands+0x858>
ffffffffc020341e:	25e00593          	li	a1,606
ffffffffc0203422:	00003517          	auipc	a0,0x3
ffffffffc0203426:	36e50513          	addi	a0,a0,878 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc020342a:	864fd0ef          	jal	ra,ffffffffc020048e <__panic>
    boot_pgdir_pa = PADDR(boot_pgdir_va);
ffffffffc020342e:	00003617          	auipc	a2,0x3
ffffffffc0203432:	2f260613          	addi	a2,a2,754 # ffffffffc0206720 <default_pmm_manager+0xa8>
ffffffffc0203436:	0c900593          	li	a1,201
ffffffffc020343a:	00003517          	auipc	a0,0x3
ffffffffc020343e:	35650513          	addi	a0,a0,854 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203442:	84cfd0ef          	jal	ra,ffffffffc020048e <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0203446:	00003617          	auipc	a2,0x3
ffffffffc020344a:	2da60613          	addi	a2,a2,730 # ffffffffc0206720 <default_pmm_manager+0xa8>
ffffffffc020344e:	08100593          	li	a1,129
ffffffffc0203452:	00003517          	auipc	a0,0x3
ffffffffc0203456:	33e50513          	addi	a0,a0,830 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc020345a:	834fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert((ptep = get_pte(boot_pgdir_va, 0x0, 0)) != NULL);
ffffffffc020345e:	00003697          	auipc	a3,0x3
ffffffffc0203462:	4fa68693          	addi	a3,a3,1274 # ffffffffc0206958 <default_pmm_manager+0x2e0>
ffffffffc0203466:	00003617          	auipc	a2,0x3
ffffffffc020346a:	e6260613          	addi	a2,a2,-414 # ffffffffc02062c8 <commands+0x858>
ffffffffc020346e:	21e00593          	li	a1,542
ffffffffc0203472:	00003517          	auipc	a0,0x3
ffffffffc0203476:	31e50513          	addi	a0,a0,798 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc020347a:	814fd0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(page_insert(boot_pgdir_va, p1, 0x0, 0) == 0);
ffffffffc020347e:	00003697          	auipc	a3,0x3
ffffffffc0203482:	4aa68693          	addi	a3,a3,1194 # ffffffffc0206928 <default_pmm_manager+0x2b0>
ffffffffc0203486:	00003617          	auipc	a2,0x3
ffffffffc020348a:	e4260613          	addi	a2,a2,-446 # ffffffffc02062c8 <commands+0x858>
ffffffffc020348e:	21b00593          	li	a1,539
ffffffffc0203492:	00003517          	auipc	a0,0x3
ffffffffc0203496:	2fe50513          	addi	a0,a0,766 # ffffffffc0206790 <default_pmm_manager+0x118>
...
{
ffffffffc02034a4:	fc86                	sd	ra,120(sp)
ffffffffc02034a6:	f8a2                	sd	s0,112(sp)
ffffffffc02034a8:	f4a6                	sd	s1,104(sp)
ffffffffc02034aa:	f0ca                	sd	s2,96(sp)
ffffffffc02034ac:	ecce                	sd	s3,88(sp)
ffffffffc02034ae:	e8d2                	sd	s4,80(sp)
ffffffffc02034b0:	e4d6                	sd	s5,72(sp)
ffffffffc02034b2:	e0da                	sd	s6,64(sp)
ffffffffc02034b4:	fc5e                	sd	s7,56(sp)
ffffffffc02034b6:	f862                	sd	s8,48(sp)
ffffffffc02034b8:	f466                	sd	s9,40(sp)
ffffffffc02034ba:	f06a                	sd	s10,32(sp)
ffffffffc02034bc:	ec6e                	sd	s11,24(sp)
    assert(start % PGSIZE == 0 && end % PGSIZE == 0);
ffffffffc02034be:	17d2                	slli	a5,a5,0x34
ffffffffc02034c0:	26079263          	bnez	a5,ffffffffc0203724 <copy_range+0x286>
    assert(USER_ACCESS(start, end));
ffffffffc02034c4:	002007b7          	lui	a5,0x200
ffffffffc02034c8:	8bb2                	mv	s7,a2
ffffffffc02034ca:	1af66863          	bltu	a2,a5,ffffffffc020367a <copy_range+0x1dc>
ffffffffc02034ce:	8436                	mv	s0,a3
ffffffffc02034d0:	1ad67563          	bgeu	a2,a3,ffffffffc020367a <copy_range+0x1dc>
ffffffffc02034d4:	4785                	li	a5,1
ffffffffc02034d6:	07fe                	slli	a5,a5,0x1f
ffffffffc02034d8:	1ad7e163          	bltu	a5,a3,ffffffffc020367a <copy_range+0x1dc>
ffffffffc02034dc:	5b7d                	li	s6,-1
ffffffffc02034de:	00cb5793          	srli	a5,s6,0xc
ffffffffc02034e2:	89aa                	mv	s3,a0
ffffffffc02034e4:	84ae                	mv	s1,a1
ffffffffc02034e6:	8aba                	mv	s5,a4
        start += PGSIZE;
ffffffffc02034e8:	6905                	lui	s2,0x1
    if (PPN(pa) >= npage)
ffffffffc02034ea:	000a7c97          	auipc	s9,0xa7
ffffffffc02034ee:	1e6c8c93          	addi	s9,s9,486 # ffffffffc02aa6d0 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02034f2:	000a7c17          	auipc	s8,0xa7
ffffffffc02034f6:	1e6c0c13          	addi	s8,s8,486 # ffffffffc02aa6d8 <pages>
    return KADDR(page2pa(page));
ffffffffc02034fa:	e43e                	sd	a5,8(sp)
        page = pmm_manager->alloc_pages(n);
ffffffffc02034fc:	000a7d17          	auipc	s10,0xa7
ffffffffc0203500:	1e4d0d13          	addi	s10,s10,484 # ffffffffc02aa6e0 <pmm_manager>
        pte_t *ptep = get_pte(from, start, 0), *nptep;
ffffffffc0203504:	4601                	li	a2,0
ffffffffc0203506:	85de                	mv	a1,s7
ffffffffc0203508:	8526                	mv	a0,s1
ffffffffc020350a:	b6ffe0ef          	jal	ra,ffffffffc0202078 <get_pte>
ffffffffc020350e:	8b2a                	mv	s6,a0
        if (ptep == NULL)
ffffffffc0203510:	cd51                	beqz	a0,ffffffffc02035ac <copy_range+0x10e>
        if (*ptep & PTE_V)
ffffffffc0203512:	6118                	ld	a4,0(a0)
ffffffffc0203514:	8b05                	andi	a4,a4,1
ffffffffc0203516:	e705                	bnez	a4,ffffffffc020353e <copy_range+0xa0>
        start += PGSIZE;
ffffffffc0203518:	9bca                	add	s7,s7,s2
    } while (start != 0 && start < end);
ffffffffc020351a:	fe8be5e3          	bltu	s7,s0,ffffffffc0203504 <copy_range+0x66>
    return 0;
ffffffffc020351e:	4501                	li	a0,0
}
ffffffffc0203520:	70e6                	ld	ra,120(sp)
ffffffffc0203522:	7446                	ld	s0,112(sp)
ffffffffc0203524:	74a6                	ld	s1,104(sp)
ffffffffc0203526:	7906                	ld	s2,96(sp)
ffffffffc0203528:	69e6                	ld	s3,88(sp)
ffffffffc020352a:	6a46                	ld	s4,80(sp)
ffffffffc020352c:	6aa6                	ld	s5,72(sp)
ffffffffc020352e:	6b06                	ld	s6,64(sp)
ffffffffc0203530:	7be2                	ld	s7,56(sp)
ffffffffc0203532:	7c42                	ld	s8,48(sp)
ffffffffc0203534:	7ca2                	ld	s9,40(sp)
ffffffffc0203536:	7d02                	ld	s10,32(sp)
ffffffffc0203538:	6de2                	ld	s11,24(sp)
ffffffffc020353a:	6109                	addi	sp,sp,128
ffffffffc020353c:	8082                	ret
            if ((nptep = get_pte(to, start, 1)) == NULL)
ffffffffc020353e:	4605                	li	a2,1
ffffffffc0203540:	85de                	mv	a1,s7
ffffffffc0203542:	854e                	mv	a0,s3
ffffffffc0203544:	b35fe0ef          	jal	ra,ffffffffc0202078 <get_pte>
ffffffffc0203548:	12050163          	beqz	a0,ffffffffc020366a <copy_range+0x1cc>
            uint32_t perm = (*ptep & PTE_USER);
ffffffffc020354c:	000b3703          	ld	a4,0(s6)
ffffffffc0203550:	00070a1b          	sext.w	s4,a4
            if (share) {
ffffffffc0203554:	060a8963          	beqz	s5,ffffffffc02035c6 <copy_range+0x128>
    if (!(pte & PTE_V))
ffffffffc0203558:	00177693          	andi	a3,a4,1
ffffffffc020355c:	12068f63          	beqz	a3,ffffffffc020369a <copy_range+0x1fc>
    if (PPN(pa) >= npage)
ffffffffc0203560:	000cb683          	ld	a3,0(s9)
    return pa2page(PTE_ADDR(pte));
ffffffffc0203564:	070a                	slli	a4,a4,0x2
ffffffffc0203566:	8331                	srli	a4,a4,0xc
    if (PPN(pa) >= npage)
ffffffffc0203568:	1ad77263          	bgeu	a4,a3,ffffffffc020370c <copy_range+0x26e>
    return &pages[PPN(pa) - nbase];
ffffffffc020356c:	000c3583          	ld	a1,0(s8)
ffffffffc0203570:	fff807b7          	lui	a5,0xfff80
ffffffffc0203574:	973e                	add	a4,a4,a5
ffffffffc0203576:	071a                	slli	a4,a4,0x6
ffffffffc0203578:	00e58db3          	add	s11,a1,a4
                assert(page != NULL);
ffffffffc020357c:	160d8863          	beqz	s11,ffffffffc02036ec <copy_range+0x24e>
    page->ref += 1;
ffffffffc0203580:	000da703          	lw	a4,0(s11)
                int ret = page_insert(to, page, start, perm);
ffffffffc0203584:	01ba7693          	andi	a3,s4,27
ffffffffc0203588:	865e                	mv	a2,s7
ffffffffc020358a:	2705                	addiw	a4,a4,1
ffffffffc020358c:	00eda023          	sw	a4,0(s11)
ffffffffc0203590:	85ee                	mv	a1,s11
ffffffffc0203592:	854e                	mv	a0,s3
ffffffffc0203594:	9d4ff0ef          	jal	ra,ffffffffc0202768 <page_insert>
                if (ret != 0) {
ffffffffc0203598:	e979                	bnez	a0,ffffffffc020366e <copy_range+0x1d0>
                *ptep &= ~PTE_W;  // 移除父进程的写权限
ffffffffc020359a:	000b3703          	ld	a4,0(s6)
ffffffffc020359e:	9b6d                	andi	a4,a4,-5
ffffffffc02035a0:	00eb3023          	sd	a4,0(s6)
    asm volatile("sfence.vma %0" : : "r"(la));
ffffffffc02035a4:	120b8073          	sfence.vma	s7
        start += PGSIZE;
ffffffffc02035a8:	9bca                	add	s7,s7,s2
    } while (start != 0 && start < end);
ffffffffc02035aa:	bf85                	j	ffffffffc020351a <copy_range+0x7c>
            start = ROUNDDOWN(start + PTSIZE, PTSIZE);
ffffffffc02035ac:	00200637          	lui	a2,0x200
ffffffffc02035b0:	00cb8833          	add	a6,s7,a2
ffffffffc02035b4:	ffe00637          	lui	a2,0xffe00
ffffffffc02035b8:	00c87bb3          	and	s7,a6,a2
    } while (start != 0 && start < end);
ffffffffc02035bc:	f60b81e3          	beqz	s7,ffffffffc020351e <copy_range+0x80>
ffffffffc02035c0:	f48be2e3          	bltu	s7,s0,ffffffffc0203504 <copy_range+0x66>
ffffffffc02035c4:	bfa9                	j	ffffffffc020351e <copy_range+0x80>
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02035c6:	10002773          	csrr	a4,sstatus
ffffffffc02035ca:	8b09                	andi	a4,a4,2
ffffffffc02035cc:	e741                	bnez	a4,ffffffffc0203654 <copy_range+0x1b6>
        page = pmm_manager->alloc_pages(n);
ffffffffc02035ce:	000d3703          	ld	a4,0(s10)
ffffffffc02035d2:	4505                	li	a0,1
ffffffffc02035d4:	6f18                	ld	a4,24(a4)
ffffffffc02035d6:	9702                	jalr	a4
ffffffffc02035d8:	8daa                	mv	s11,a0
                if (npage == NULL) {
ffffffffc02035da:	080d8863          	beqz	s11,ffffffffc020366a <copy_range+0x1cc>
                struct Page *page = pte2page(*ptep);
ffffffffc02035de:	000b3683          	ld	a3,0(s6)
    if (!(pte & PTE_V))
ffffffffc02035e2:	0016f793          	andi	a5,a3,1
ffffffffc02035e6:	cbd5                	beqz	a5,ffffffffc020369a <copy_range+0x1fc>
    if (PPN(pa) >= npage)
ffffffffc02035e8:	000cb883          	ld	a7,0(s9)
    return pa2page(PTE_ADDR(pte));
ffffffffc02035ec:	068a                	slli	a3,a3,0x2
ffffffffc02035ee:	82b1                	srli	a3,a3,0xc
    if (PPN(pa) >= npage)
ffffffffc02035f0:	1116fe63          	bgeu	a3,a7,ffffffffc020370c <copy_range+0x26e>
    return &pages[PPN(pa) - nbase];
...
ffffffffc0203600:	00d607b3          	add	a5,a2,a3
                assert(page != NULL);
ffffffffc0203604:	c7e1                	beqz	a5,ffffffffc02036cc <copy_range+0x22e>
    return KADDR(page2pa(page));
...
ffffffffc0203612:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0203614:	0b17f063          	bgeu	a5,a7,ffffffffc02036b4 <copy_range+0x216>
...
ffffffffc0203634:	07b2                	slli	a5,a5,0xc
    return KADDR(page2pa(page));
ffffffffc0203636:	07167e63          	bgeu	a2,a7,ffffffffc02036b2 <copy_range+0x214>
                memcpy(dst_kvaddr, src_kvaddr, PGSIZE); // 复制页面内容
ffffffffc020363a:	6605                	lui	a2,0x1
ffffffffc020363c:	953e                	add	a0,a0,a5
ffffffffc020363e:	1b0020ef          	jal	ra,ffffffffc02057ee <memcpy>
                int ret = page_insert(to, npage, start, perm); // 将目标页面插入到目标进程的页表中
ffffffffc0203642:	865e                	mv	a2,s7
ffffffffc0203644:	01fa7693          	andi	a3,s4,31
ffffffffc0203648:	85ee                	mv	a1,s11
ffffffffc020364a:	854e                	mv	a0,s3
ffffffffc020364c:	91cff0ef          	jal	ra,ffffffffc0202768 <page_insert>
        start += PGSIZE;
ffffffffc0203650:	9bca                	add	s7,s7,s2
    } while (start != 0 && start < end);
ffffffffc0203652:	b5e1                	j	ffffffffc020351a <copy_range+0x7c>
        intr_disable();
ffffffffc0203654:	b60fd0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
        page = pmm_manager->alloc_pages(n);
ffffffffc0203658:	000d3703          	ld	a4,0(s10)
ffffffffc020365c:	4505                	li	a0,1
ffffffffc020365e:	6f18                	ld	a4,24(a4)
ffffffffc0203660:	9702                	jalr	a4
ffffffffc0203662:	8daa                	mv	s11,a0
        intr_enable();
ffffffffc0203664:	b4afd0ef          	jal	ra,ffffffffc02009ae <intr_enable>
ffffffffc0203668:	bf8d                	j	ffffffffc02035da <copy_range+0x13c>
                return -E_NO_MEM;
ffffffffc020366a:	5571                	li	a0,-4
ffffffffc020366c:	bd55                	j	ffffffffc0203520 <copy_range+0x82>
    page->ref -= 1;
ffffffffc020366e:	000da783          	lw	a5,0(s11)
ffffffffc0203672:	37fd                	addiw	a5,a5,-1
ffffffffc0203674:	00fda023          	sw	a5,0(s11)
                    return ret;
ffffffffc0203678:	b565                	j	ffffffffc0203520 <copy_range+0x82>
    assert(USER_ACCESS(start, end));
ffffffffc020367a:	00003697          	auipc	a3,0x3
ffffffffc020367e:	15668693          	addi	a3,a3,342 # ffffffffc02067d0 <default_pmm_manager+0x158>
ffffffffc0203682:	00003617          	auipc	a2,0x3
ffffffffc0203686:	c4660613          	addi	a2,a2,-954 # ffffffffc02062c8 <commands+0x858>
ffffffffc020368a:	17c00593          	li	a1,380
ffffffffc020368e:	00003517          	auipc	a0,0x3
ffffffffc0203692:	10250513          	addi	a0,a0,258 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203696:	df9fc0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("pte2page called with invalid pte");
ffffffffc020369a:	00003617          	auipc	a2,0x3
ffffffffc020369e:	0ce60613          	addi	a2,a2,206 # ffffffffc0206768 <default_pmm_manager+0xf0>
ffffffffc02036a2:	07f00593          	li	a1,127
ffffffffc02036a6:	00003517          	auipc	a0,0x3
ffffffffc02036aa:	ba250513          	addi	a0,a0,-1118 # ffffffffc0206248 <commands+0x7d8>
ffffffffc02036ae:	de1fc0ef          	jal	ra,ffffffffc020048e <__panic>
    return KADDR(page2pa(page));
ffffffffc02036b2:	86be                	mv	a3,a5
ffffffffc02036b4:	00003617          	auipc	a2,0x3
ffffffffc02036b8:	b6c60613          	addi	a2,a2,-1172 # ffffffffc0206220 <commands+0x7b0>
ffffffffc02036bc:	07100593          	li	a1,113
ffffffffc02036c0:	00003517          	auipc	a0,0x3
ffffffffc02036c4:	b8850513          	addi	a0,a0,-1144 # ffffffffc0206248 <commands+0x7d8>
ffffffffc02036c8:	dc7fc0ef          	jal	ra,ffffffffc020048e <__panic>
                assert(page != NULL);
ffffffffc02036cc:	00003697          	auipc	a3,0x3
ffffffffc02036d0:	6b468693          	addi	a3,a3,1716 # ffffffffc0206d80 <default_pmm_manager+0x708>
ffffffffc02036d4:	00003617          	auipc	a2,0x3
ffffffffc02036d8:	bf460613          	addi	a2,a2,-1036 # ffffffffc02062c8 <commands+0x858>
ffffffffc02036dc:	1ab00593          	li	a1,427
ffffffffc02036e0:	00003517          	auipc	a0,0x3
ffffffffc02036e4:	0b050513          	addi	a0,a0,176 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc02036e8:	da7fc0ef          	jal	ra,ffffffffc020048e <__panic>
                assert(page != NULL);
ffffffffc02036ec:	00003697          	auipc	a3,0x3
ffffffffc02036f0:	69468693          	addi	a3,a3,1684 # ffffffffc0206d80 <default_pmm_manager+0x708>
ffffffffc02036f4:	00003617          	auipc	a2,0x3
ffffffffc02036f8:	bd460613          	addi	a2,a2,-1068 # ffffffffc02062c8 <commands+0x858>
ffffffffc02036fc:	19500593          	li	a1,405
ffffffffc0203700:	00003517          	auipc	a0,0x3
ffffffffc0203704:	09050513          	addi	a0,a0,144 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203708:	d87fc0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("pa2page called with invalid pa");
ffffffffc020370c:	00003617          	auipc	a2,0x3
ffffffffc0203710:	03c60613          	addi	a2,a2,60 # ffffffffc0206748 <default_pmm_manager+0xd0>
ffffffffc0203714:	06900593          	li	a1,105
ffffffffc0203718:	00003517          	auipc	a0,0x3
ffffffffc020371c:	b3050513          	addi	a0,a0,-1232 # ffffffffc0206248 <commands+0x7d8>
ffffffffc0203720:	d6ffc0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(start % PGSIZE == 0 && end % PGSIZE == 0);
ffffffffc0203724:	00003697          	auipc	a3,0x3
ffffffffc0203728:	07c68693          	addi	a3,a3,124 # ffffffffc02067a0 <default_pmm_manager+0x128>
ffffffffc020372c:	00003617          	auipc	a2,0x3
ffffffffc0203730:	b9c60613          	addi	a2,a2,-1124 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203734:	17b00593          	li	a1,379
ffffffffc0203738:	00003517          	auipc	a0,0x3
ffffffffc020373c:	05850513          	addi	a0,a0,88 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203740:	d4ffc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0203744 <tlb_invalidate>:
    asm volatile("sfence.vma %0" : : "r"(la));
ffffffffc0203744:	12058073          	sfence.vma	a1
}
...
ffffffffc020374c:	ec26                	sd	s1,24(sp)
ffffffffc020374e:	e84a                	sd	s2,16(sp)
ffffffffc0203750:	e052                	sd	s4,0(sp)
ffffffffc0203752:	f406                	sd	ra,40(sp)
ffffffffc0203754:	f022                	sd	s0,32(sp)
ffffffffc0203756:	e44e                	sd	s3,8(sp)
ffffffffc0203758:	8a2a                	mv	s4,a0
ffffffffc020375a:	84ae                	mv	s1,a1
ffffffffc020375c:	8932                	mv	s2,a2
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc020375e:	100027f3          	csrr	a5,sstatus
ffffffffc0203762:	8b89                	andi	a5,a5,2
        page = pmm_manager->alloc_pages(n);
ffffffffc0203764:	000a7997          	auipc	s3,0xa7
ffffffffc0203768:	f7c98993          	addi	s3,s3,-132 # ffffffffc02aa6e0 <pmm_manager>
ffffffffc020376c:	ef8d                	bnez	a5,ffffffffc02037a6 <pgdir_alloc_page+0x5c>
ffffffffc020376e:	0009b783          	ld	a5,0(s3)
ffffffffc0203772:	4505                	li	a0,1
ffffffffc0203774:	6f9c                	ld	a5,24(a5)
ffffffffc0203776:	9782                	jalr	a5
ffffffffc0203778:	842a                	mv	s0,a0
    if (page != NULL)
ffffffffc020377a:	cc09                	beqz	s0,ffffffffc0203794 <pgdir_alloc_page+0x4a>
        if (page_insert(pgdir, page, la, perm) != 0)
ffffffffc020377c:	86ca                	mv	a3,s2
ffffffffc020377e:	8626                	mv	a2,s1
ffffffffc0203780:	85a2                	mv	a1,s0
ffffffffc0203782:	8552                	mv	a0,s4
ffffffffc0203784:	fe5fe0ef          	jal	ra,ffffffffc0202768 <page_insert>
ffffffffc0203788:	e915                	bnez	a0,ffffffffc02037bc <pgdir_alloc_page+0x72>
        assert(page_ref(page) == 1);
ffffffffc020378a:	4018                	lw	a4,0(s0)
        page->pra_vaddr = la;
ffffffffc020378c:	fc04                	sd	s1,56(s0)
        assert(page_ref(page) == 1);
ffffffffc020378e:	4785                	li	a5,1
ffffffffc0203790:	04f71e63          	bne	a4,a5,ffffffffc02037ec <pgdir_alloc_page+0xa2>
}
ffffffffc0203794:	70a2                	ld	ra,40(sp)
ffffffffc0203796:	8522                	mv	a0,s0
ffffffffc0203798:	7402                	ld	s0,32(sp)
ffffffffc020379a:	64e2                	ld	s1,24(sp)
ffffffffc020379c:	6942                	ld	s2,16(sp)
ffffffffc020379e:	69a2                	ld	s3,8(sp)
ffffffffc02037a0:	6a02                	ld	s4,0(sp)
ffffffffc02037a2:	6145                	addi	sp,sp,48
ffffffffc02037a4:	8082                	ret
        intr_disable();
ffffffffc02037a6:	a0efd0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
        page = pmm_manager->alloc_pages(n);
ffffffffc02037aa:	0009b783          	ld	a5,0(s3)
ffffffffc02037ae:	4505                	li	a0,1
ffffffffc02037b0:	6f9c                	ld	a5,24(a5)
ffffffffc02037b2:	9782                	jalr	a5
ffffffffc02037b4:	842a                	mv	s0,a0
        intr_enable();
ffffffffc02037b6:	9f8fd0ef          	jal	ra,ffffffffc02009ae <intr_enable>
ffffffffc02037ba:	b7c1                	j	ffffffffc020377a <pgdir_alloc_page+0x30>
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02037bc:	100027f3          	csrr	a5,sstatus
ffffffffc02037c0:	8b89                	andi	a5,a5,2
ffffffffc02037c2:	eb89                	bnez	a5,ffffffffc02037d4 <pgdir_alloc_page+0x8a>
        pmm_manager->free_pages(base, n);
ffffffffc02037c4:	0009b783          	ld	a5,0(s3)
ffffffffc02037c8:	8522                	mv	a0,s0
ffffffffc02037ca:	4585                	li	a1,1
ffffffffc02037cc:	739c                	ld	a5,32(a5)
            return NULL;
ffffffffc02037ce:	4401                	li	s0,0
        pmm_manager->free_pages(base, n);
ffffffffc02037d0:	9782                	jalr	a5
    if (flag)
ffffffffc02037d2:	b7c9                	j	ffffffffc0203794 <pgdir_alloc_page+0x4a>
        intr_disable();
ffffffffc02037d4:	9e0fd0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
ffffffffc02037d8:	0009b783          	ld	a5,0(s3)
ffffffffc02037dc:	8522                	mv	a0,s0
ffffffffc02037de:	4585                	li	a1,1
ffffffffc02037e0:	739c                	ld	a5,32(a5)
            return NULL;
ffffffffc02037e2:	4401                	li	s0,0
        pmm_manager->free_pages(base, n);
ffffffffc02037e4:	9782                	jalr	a5
        intr_enable();
ffffffffc02037e6:	9c8fd0ef          	jal	ra,ffffffffc02009ae <intr_enable>
ffffffffc02037ea:	b76d                	j	ffffffffc0203794 <pgdir_alloc_page+0x4a>
        assert(page_ref(page) == 1);
ffffffffc02037ec:	00003697          	auipc	a3,0x3
ffffffffc02037f0:	5a468693          	addi	a3,a3,1444 # ffffffffc0206d90 <default_pmm_manager+0x718>
ffffffffc02037f4:	00003617          	auipc	a2,0x3
ffffffffc02037f8:	ad460613          	addi	a2,a2,-1324 # ffffffffc02062c8 <commands+0x858>
ffffffffc02037fc:	1fc00593          	li	a1,508
ffffffffc0203800:	00003517          	auipc	a0,0x3
ffffffffc0203804:	f9050513          	addi	a0,a0,-112 # ffffffffc0206790 <default_pmm_manager+0x118>
ffffffffc0203808:	c87fc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc020380c <check_vma_overlap.part.0>:
    return vma;
}
...
ffffffffc020380c:	1141                	addi	sp,sp,-16
{
    assert(prev->vm_start < prev->vm_end);
    assert(prev->vm_end <= next->vm_start);
    assert(next->vm_start < next->vm_end);
ffffffffc020380e:	00003697          	auipc	a3,0x3
ffffffffc0203812:	59a68693          	addi	a3,a3,1434 # ffffffffc0206da8 <default_pmm_manager+0x730>
ffffffffc0203816:	00003617          	auipc	a2,0x3
ffffffffc020381a:	ab260613          	addi	a2,a2,-1358 # ffffffffc02062c8 <commands+0x858>
ffffffffc020381e:	07400593          	li	a1,116
ffffffffc0203822:	00003517          	auipc	a0,0x3
ffffffffc0203826:	5a650513          	addi	a0,a0,1446 # ffffffffc0206dc8 <default_pmm_manager+0x750>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next)
ffffffffc020382a:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc020382c:	c63fc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0203830 <mm_create>:
{
ffffffffc0203830:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203832:	04000513          	li	a0,64
{
ffffffffc0203836:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203838:	daafe0ef          	jal	ra,ffffffffc0201de2 <kmalloc>
    if (mm != NULL)
ffffffffc020383c:	cd19                	beqz	a0,ffffffffc020385a <mm_create+0x2a>
    elm->prev = elm->next = elm;
ffffffffc020383e:	e508                	sd	a0,8(a0)
ffffffffc0203840:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203842:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203846:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc020384a:	02052023          	sw	zero,32(a0)
        mm->sm_priv = NULL;
ffffffffc020384e:	02053423          	sd	zero,40(a0)
}
...
{
    mm->mm_count = val;
ffffffffc0203852:	02052823          	sw	zero,48(a0)
...
{
    *lock = 0;
ffffffffc0203856:	02053c23          	sd	zero,56(a0)
}
ffffffffc020385a:	60a2                	ld	ra,8(sp)
ffffffffc020385c:	0141                	addi	sp,sp,16
ffffffffc020385e:	8082                	ret

ffffffffc0203860 <find_vma>:
{
ffffffffc0203860:	86aa                	mv	a3,a0
    if (mm != NULL)
ffffffffc0203862:	c505                	beqz	a0,ffffffffc020388a <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc0203864:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr))
ffffffffc0203866:	c501                	beqz	a0,ffffffffc020386e <find_vma+0xe>
ffffffffc0203868:	651c                	ld	a5,8(a0)
ffffffffc020386a:	02f5f263          	bgeu	a1,a5,ffffffffc020388e <find_vma+0x2e>
    return listelm->next;
ffffffffc020386e:	669c                	ld	a5,8(a3)
            while ((le = list_next(le)) != list)
ffffffffc0203870:	00f68d63          	beq	a3,a5,ffffffffc020388a <find_vma+0x2a>
                if (vma->vm_start <= addr && addr < vma->vm_end)
ffffffffc0203874:	fe87b703          	ld	a4,-24(a5) # fffffffffff7ffe8 <end+0x3fcd58dc>
ffffffffc0203878:	00e5e663          	bltu	a1,a4,ffffffffc0203884 <find_vma+0x24>
ffffffffc020387c:	ff07b703          	ld	a4,-16(a5)
ffffffffc0203880:	00e5ec63          	bltu	a1,a4,ffffffffc0203898 <find_vma+0x38>
ffffffffc0203884:	679c                	ld	a5,8(a5)
            while ((le = list_next(le)) != list)
ffffffffc0203886:	fef697e3          	bne	a3,a5,ffffffffc0203874 <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc020388a:	4501                	li	a0,0
}
ffffffffc020388c:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr))
ffffffffc020388e:	691c                	ld	a5,16(a0)
ffffffffc0203890:	fcf5ffe3          	bgeu	a1,a5,ffffffffc020386e <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc0203894:	ea88                	sd	a0,16(a3)
ffffffffc0203896:	8082                	ret
                vma = le2vma(le, list_link);
ffffffffc0203898:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc020389c:	ea88                	sd	a0,16(a3)
ffffffffc020389e:	8082                	ret

ffffffffc02038a0 <insert_vma_struct>:
}
...
ffffffffc02038a0:	6590                	ld	a2,8(a1)
ffffffffc02038a2:	0105b803          	ld	a6,16(a1) # 80010 <_binary_obj___user_exit_out_size+0x74ef0>
{
ffffffffc02038a6:	1141                	addi	sp,sp,-16
ffffffffc02038a8:	e406                	sd	ra,8(sp)
ffffffffc02038aa:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc02038ac:	01066763          	bltu	a2,a6,ffffffffc02038ba <insert_vma_struct+0x1a>
ffffffffc02038b0:	a085                	j	ffffffffc0203910 <insert_vma_struct+0x70>
...
ffffffffc02038b2:	fe87b703          	ld	a4,-24(a5)
ffffffffc02038b6:	04e66863          	bltu	a2,a4,ffffffffc0203906 <insert_vma_struct+0x66>
ffffffffc02038ba:	86be                	mv	a3,a5
ffffffffc02038bc:	679c                	ld	a5,8(a5)
    while ((le = list_next(le)) != list)
ffffffffc02038be:	fef51ae3          	bne	a0,a5,ffffffffc02038b2 <insert_vma_struct+0x12>
    }
    ...
    /* check overlap */
    if (le_prev != list)
ffffffffc02038c2:	02a68463          	beq	a3,a0,ffffffffc02038ea <insert_vma_struct+0x4a>
    {
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc02038c6:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02038ca:	fe86b883          	ld	a7,-24(a3)
ffffffffc02038ce:	08e8f163          	bgeu	a7,a4,ffffffffc0203950 <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02038d2:	04e66f63          	bltu	a2,a4,ffffffffc0203930 <insert_vma_struct+0x90>
    }
    if (le_next != list)
ffffffffc02038d6:	00f50a63          	beq	a0,a5,ffffffffc02038ea <insert_vma_struct+0x4a>
        if (mmap_prev->vm_start > vma->vm_start)
ffffffffc02038da:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc02038de:	05076963          	bltu	a4,a6,ffffffffc0203930 <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc02038e2:	ff07b603          	ld	a2,-16(a5)
ffffffffc02038e6:	02c77363          	bgeu	a4,a2,ffffffffc020390c <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count++;
ffffffffc02038ea:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc02038ec:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc02038ee:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc02038f2:	e390                	sd	a2,0(a5)
ffffffffc02038f4:	e690                	sd	a2,8(a3)
}
ffffffffc02038f6:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc02038f8:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc02038fa:	f194                	sd	a3,32(a1)
    mm->map_count++;
ffffffffc02038fc:	0017079b          	addiw	a5,a4,1
ffffffffc0203900:	d11c                	sw	a5,32(a0)
}
ffffffffc0203902:	0141                	addi	sp,sp,16
ffffffffc0203904:	8082                	ret
    if (le_prev != list)
ffffffffc0203906:	fca690e3          	bne	a3,a0,ffffffffc02038c6 <insert_vma_struct+0x26>
ffffffffc020390a:	bfd1                	j	ffffffffc02038de <insert_vma_struct+0x3e>
ffffffffc020390c:	f01ff0ef          	jal	ra,ffffffffc020380c <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203910:	00003697          	auipc	a3,0x3
ffffffffc0203914:	4c868693          	addi	a3,a3,1224 # ffffffffc0206dd8 <default_pmm_manager+0x760>
ffffffffc0203918:	00003617          	auipc	a2,0x3
ffffffffc020391c:	9b060613          	addi	a2,a2,-1616 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203920:	07a00593          	li	a1,122
ffffffffc0203924:	00003517          	auipc	a0,0x3
ffffffffc0203928:	4a450513          	addi	a0,a0,1188 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc020392c:	b63fc0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203930:	00003697          	auipc	a3,0x3
ffffffffc0203934:	4e868693          	addi	a3,a3,1256 # ffffffffc0206e18 <default_pmm_manager+0x7a0>
ffffffffc0203938:	00003617          	auipc	a2,0x3
ffffffffc020393c:	99060613          	addi	a2,a2,-1648 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203940:	07300593          	li	a1,115
ffffffffc0203944:	00003517          	auipc	a0,0x3
ffffffffc0203948:	48450513          	addi	a0,a0,1156 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc020394c:	b43fc0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203950:	00003697          	auipc	a3,0x3
ffffffffc0203954:	4a868693          	addi	a3,a3,1192 # ffffffffc0206df8 <default_pmm_manager+0x780>
ffffffffc0203958:	00003617          	auipc	a2,0x3
ffffffffc020395c:	97060613          	addi	a2,a2,-1680 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203960:	07200593          	li	a1,114
ffffffffc0203964:	00003517          	auipc	a0,0x3
ffffffffc0203968:	46450513          	addi	a0,a0,1124 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc020396c:	b23fc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0203970 <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void mm_destroy(struct mm_struct *mm)
{
    assert(mm_count(mm) == 0);
ffffffffc0203970:	591c                	lw	a5,48(a0)
{
ffffffffc0203972:	1141                	addi	sp,sp,-16
ffffffffc0203974:	e406                	sd	ra,8(sp)
ffffffffc0203976:	e022                	sd	s0,0(sp)
    assert(mm_count(mm) == 0);
ffffffffc0203978:	e78d                	bnez	a5,ffffffffc02039a2 <mm_destroy+0x32>
ffffffffc020397a:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc020397c:	6508                	ld	a0,8(a0)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list)
ffffffffc020397e:	00a40c63          	beq	s0,a0,ffffffffc0203996 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203982:	6118                	ld	a4,0(a0)
ffffffffc0203984:	651c                	ld	a5,8(a0)
    {
        list_del(le);
...
ffffffffc020398c:	d06fe0ef          	jal	ra,ffffffffc0201e92 <kfree>
    return listelm->next;
ffffffffc0203990:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list)
ffffffffc0203992:	fea418e3          	bne	s0,a0,ffffffffc0203982 <mm_destroy+0x12>
    }
    kfree(mm); // kfree mm
ffffffffc0203996:	8522                	mv	a0,s0
    mm = NULL;
}
ffffffffc0203998:	6402                	ld	s0,0(sp)
ffffffffc020399a:	60a2                	ld	ra,8(sp)
ffffffffc020399c:	0141                	addi	sp,sp,16
    kfree(mm); // kfree mm
ffffffffc020399e:	cf4fe06f          	j	ffffffffc0201e92 <kfree>
    assert(mm_count(mm) == 0);
ffffffffc02039a2:	00003697          	auipc	a3,0x3
ffffffffc02039a6:	49668693          	addi	a3,a3,1174 # ffffffffc0206e38 <default_pmm_manager+0x7c0>
ffffffffc02039aa:	00003617          	auipc	a2,0x3
ffffffffc02039ae:	91e60613          	addi	a2,a2,-1762 # ffffffffc02062c8 <commands+0x858>
ffffffffc02039b2:	09e00593          	li	a1,158
ffffffffc02039b6:	00003517          	auipc	a0,0x3
ffffffffc02039ba:	41250513          	addi	a0,a0,1042 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc02039be:	ad1fc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc02039c2 <mm_map>:

int mm_map(struct mm_struct *mm, uintptr_t addr, size_t len, uint32_t vm_flags,
           struct vma_struct **vma_store)
{
ffffffffc02039c2:	7139                	addi	sp,sp,-64
ffffffffc02039c4:	f822                	sd	s0,48(sp)
    uintptr_t start = ROUNDDOWN(addr, PGSIZE), end = ROUNDUP(addr + len, PGSIZE);
ffffffffc02039c6:	6405                	lui	s0,0x1
ffffffffc02039c8:	147d                	addi	s0,s0,-1
ffffffffc02039ca:	77fd                	lui	a5,0xfffff
ffffffffc02039cc:	9622                	add	a2,a2,s0
ffffffffc02039ce:	962e                	add	a2,a2,a1
{
ffffffffc02039d0:	f426                	sd	s1,40(sp)
ffffffffc02039d2:	fc06                	sd	ra,56(sp)
    uintptr_t start = ROUNDDOWN(addr, PGSIZE), end = ROUNDUP(addr + len, PGSIZE);
ffffffffc02039d4:	00f5f4b3          	and	s1,a1,a5
{
...
ffffffffc02039e0:	002005b7          	lui	a1,0x200
ffffffffc02039e4:	00f67433          	and	s0,a2,a5
ffffffffc02039e8:	06b4e363          	bltu	s1,a1,ffffffffc0203a4e <mm_map+0x8c>
ffffffffc02039ec:	0684f163          	bgeu	s1,s0,ffffffffc0203a4e <mm_map+0x8c>
ffffffffc02039f0:	4785                	li	a5,1
ffffffffc02039f2:	07fe                	slli	a5,a5,0x1f
ffffffffc02039f4:	0487ed63          	bltu	a5,s0,ffffffffc0203a4e <mm_map+0x8c>
ffffffffc02039f8:	89aa                	mv	s3,a0
    {
        return -E_INVAL;
    }

    assert(mm != NULL);
ffffffffc02039fa:	cd21                	beqz	a0,ffffffffc0203a52 <mm_map+0x90>

    int ret = -E_INVAL;

    struct vma_struct *vma;
    if ((vma = find_vma(mm, start)) != NULL && end > vma->vm_start)
ffffffffc02039fc:	85a6                	mv	a1,s1
ffffffffc02039fe:	8ab6                	mv	s5,a3
ffffffffc0203a00:	8a3a                	mv	s4,a4
ffffffffc0203a02:	e5fff0ef          	jal	ra,ffffffffc0203860 <find_vma>
ffffffffc0203a06:	c501                	beqz	a0,ffffffffc0203a0e <mm_map+0x4c>
ffffffffc0203a08:	651c                	ld	a5,8(a0)
ffffffffc0203a0a:	0487e263          	bltu	a5,s0,ffffffffc0203a4e <mm_map+0x8c>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203a0e:	03000513          	li	a0,48
ffffffffc0203a12:	bd0fe0ef          	jal	ra,ffffffffc0201de2 <kmalloc>
ffffffffc0203a16:	892a                	mv	s2,a0
    {
        goto out;
    }
    ret = -E_NO_MEM;
ffffffffc0203a18:	5571                	li	a0,-4
    if (vma != NULL)
ffffffffc0203a1a:	02090163          	beqz	s2,ffffffffc0203a3c <mm_map+0x7a>
...
ffffffffc0203a1e:	854e                	mv	a0,s3
        vma->vm_start = vm_start;
ffffffffc0203a20:	00993423          	sd	s1,8(s2) # 1008 <_binary_obj___user_faultread_out_size-0x8ba0>
        vma->vm_end = vm_end;
ffffffffc0203a24:	00893823          	sd	s0,16(s2)
        vma->vm_flags = vm_flags;
ffffffffc0203a28:	01592c23          	sw	s5,24(s2)
    insert_vma_struct(mm, vma);
ffffffffc0203a2c:	85ca                	mv	a1,s2
ffffffffc0203a2e:	e73ff0ef          	jal	ra,ffffffffc02038a0 <insert_vma_struct>
    if (vma_store != NULL)
    {
        *vma_store = vma;
    }
    ret = 0;
ffffffffc0203a32:	4501                	li	a0,0
    if (vma_store != NULL)
ffffffffc0203a34:	000a0463          	beqz	s4,ffffffffc0203a3c <mm_map+0x7a>
        *vma_store = vma;
ffffffffc0203a38:	012a3023          	sd	s2,0(s4)
...
ffffffffc0203a4c:	8082                	ret
        return -E_INVAL;
ffffffffc0203a4e:	5575                	li	a0,-3
ffffffffc0203a50:	b7f5                	j	ffffffffc0203a3c <mm_map+0x7a>
    assert(mm != NULL);
ffffffffc0203a52:	00003697          	auipc	a3,0x3
ffffffffc0203a56:	3fe68693          	addi	a3,a3,1022 # ffffffffc0206e50 <default_pmm_manager+0x7d8>
ffffffffc0203a5a:	00003617          	auipc	a2,0x3
ffffffffc0203a5e:	86e60613          	addi	a2,a2,-1938 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203a62:	0b300593          	li	a1,179
ffffffffc0203a66:	00003517          	auipc	a0,0x3
ffffffffc0203a6a:	36250513          	addi	a0,a0,866 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203a6e:	a21fc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0203a72 <dup_mmap>:

int dup_mmap(struct mm_struct *to, struct mm_struct *from)
{
ffffffffc0203a72:	7139                	addi	sp,sp,-64
...
ffffffffc0203a82:	c52d                	beqz	a0,ffffffffc0203aec <dup_mmap+0x7a>
ffffffffc0203a84:	892a                	mv	s2,a0
ffffffffc0203a86:	84ae                	mv	s1,a1
    list_entry_t *list = &(from->mmap_list), *le = list;
ffffffffc0203a88:	842e                	mv	s0,a1
    assert(to != NULL && from != NULL);
ffffffffc0203a8a:	e595                	bnez	a1,ffffffffc0203ab6 <dup_mmap+0x44>
ffffffffc0203a8c:	a085                	j	ffffffffc0203aec <dup_mmap+0x7a>
        if (nvma == NULL)
        {
            return -E_NO_MEM;
        }
...
ffffffffc0203a8e:	854a                	mv	a0,s2
        vma->vm_start = vm_start;
ffffffffc0203a90:	0155b423          	sd	s5,8(a1) # 200008 <_binary_obj___user_exit_out_size+0x1f4ee8>
        vma->vm_end = vm_end;
ffffffffc0203a94:	0145b823          	sd	s4,16(a1)
        vma->vm_flags = vm_flags;
ffffffffc0203a98:	0135ac23          	sw	s3,24(a1)
        insert_vma_struct(to, nvma);
ffffffffc0203a9c:	e05ff0ef          	jal	ra,ffffffffc02038a0 <insert_vma_struct>

        bool share = 0; // 使用COW机制
        if (copy_range(to->pgdir, from->pgdir, vma->vm_start, vma->vm_end, share) != 0)
ffffffffc0203aa0:	ff043683          	ld	a3,-16(s0) # ff0 <_binary_obj___user_faultread_out_size-0x8bb8>
ffffffffc0203aa4:	fe843603          	ld	a2,-24(s0)
ffffffffc0203aa8:	6c8c                	ld	a1,24(s1)
ffffffffc0203aaa:	01893503          	ld	a0,24(s2)
ffffffffc0203aae:	4701                	li	a4,0
ffffffffc0203ab0:	9efff0ef          	jal	ra,ffffffffc020349e <copy_range>
ffffffffc0203ab4:	e105                	bnez	a0,ffffffffc0203ad4 <dup_mmap+0x62>
    return listelm->prev;
ffffffffc0203ab6:	6000                	ld	s0,0(s0)
    while ((le = list_prev(le)) != list)
ffffffffc0203ab8:	02848863          	beq	s1,s0,ffffffffc0203ae8 <dup_mmap+0x76>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203abc:	03000513          	li	a0,48
        nvma = vma_create(vma->vm_start, vma->vm_end, vma->vm_flags);
ffffffffc0203ac0:	fe843a83          	ld	s5,-24(s0)
ffffffffc0203ac4:	ff043a03          	ld	s4,-16(s0)
ffffffffc0203ac8:	ff842983          	lw	s3,-8(s0)
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203acc:	b16fe0ef          	jal	ra,ffffffffc0201de2 <kmalloc>
ffffffffc0203ad0:	85aa                	mv	a1,a0
    if (vma != NULL)
ffffffffc0203ad2:	fd55                	bnez	a0,ffffffffc0203a8e <dup_mmap+0x1c>
            return -E_NO_MEM;
ffffffffc0203ad4:	5571                	li	a0,-4
        {
            return -E_NO_MEM;
        }
    }
...
ffffffffc0203ad6:	70e2                	ld	ra,56(sp)
ffffffffc0203ad8:	7442                	ld	s0,48(sp)
ffffffffc0203ada:	74a2                	ld	s1,40(sp)
ffffffffc0203adc:	7902                	ld	s2,32(sp)
ffffffffc0203ade:	69e2                	ld	s3,24(sp)
ffffffffc0203ae0:	6a42                	ld	s4,16(sp)
ffffffffc0203ae2:	6aa2                	ld	s5,8(sp)
ffffffffc0203ae4:	6121                	addi	sp,sp,64
ffffffffc0203ae6:	8082                	ret
    return 0;
ffffffffc0203ae8:	4501                	li	a0,0
ffffffffc0203aea:	b7f5                	j	ffffffffc0203ad6 <dup_mmap+0x64>
    assert(to != NULL && from != NULL);
ffffffffc0203aec:	00003697          	auipc	a3,0x3
ffffffffc0203af0:	37468693          	addi	a3,a3,884 # ffffffffc0206e60 <default_pmm_manager+0x7e8>
ffffffffc0203af4:	00002617          	auipc	a2,0x2
ffffffffc0203af8:	7d460613          	addi	a2,a2,2004 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203afc:	0cf00593          	li	a1,207
ffffffffc0203b00:	00003517          	auipc	a0,0x3
ffffffffc0203b04:	2c850513          	addi	a0,a0,712 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203b08:	987fc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0203b0c <exit_mmap>:

void exit_mmap(struct mm_struct *mm)
{
ffffffffc0203b0c:	1101                	addi	sp,sp,-32
ffffffffc0203b0e:	ec06                	sd	ra,24(sp)
ffffffffc0203b10:	e822                	sd	s0,16(sp)
ffffffffc0203b12:	e426                	sd	s1,8(sp)
ffffffffc0203b14:	e04a                	sd	s2,0(sp)
    assert(mm != NULL && mm_count(mm) == 0);
ffffffffc0203b16:	c531                	beqz	a0,ffffffffc0203b62 <exit_mmap+0x56>
ffffffffc0203b18:	591c                	lw	a5,48(a0)
ffffffffc0203b1a:	84aa                	mv	s1,a0
ffffffffc0203b1c:	e3b9                	bnez	a5,ffffffffc0203b62 <exit_mmap+0x56>
    return listelm->next;
ffffffffc0203b1e:	6500                	ld	s0,8(a0)
    pde_t *pgdir = mm->pgdir;
ffffffffc0203b20:	01853903          	ld	s2,24(a0)
    list_entry_t *list = &(mm->mmap_list), *le = list;
    while ((le = list_next(le)) != list)
ffffffffc0203b24:	02850663          	beq	a0,s0,ffffffffc0203b50 <exit_mmap+0x44>
    {
        struct vma_struct *vma = le2vma(le, list_link);
        unmap_range(pgdir, vma->vm_start, vma->vm_end);
ffffffffc0203b28:	ff043603          	ld	a2,-16(s0)
ffffffffc0203b2c:	fe843583          	ld	a1,-24(s0)
ffffffffc0203b30:	854a                	mv	a0,s2
ffffffffc0203b32:	fc2fe0ef          	jal	ra,ffffffffc02022f4 <unmap_range>
ffffffffc0203b36:	6400                	ld	s0,8(s0)
    while ((le = list_next(le)) != list)
ffffffffc0203b38:	fe8498e3          	bne	s1,s0,ffffffffc0203b28 <exit_mmap+0x1c>
ffffffffc0203b3c:	6400                	ld	s0,8(s0)
    }
    while ((le = list_next(le)) != list)
ffffffffc0203b3e:	00848c63          	beq	s1,s0,ffffffffc0203b56 <exit_mmap+0x4a>
    {
        struct vma_struct *vma = le2vma(le, list_link);
        exit_range(pgdir, vma->vm_start, vma->vm_end);
ffffffffc0203b42:	ff043603          	ld	a2,-16(s0)
ffffffffc0203b46:	fe843583          	ld	a1,-24(s0)
ffffffffc0203b4a:	854a                	mv	a0,s2
ffffffffc0203b4c:	8effe0ef          	jal	ra,ffffffffc020243a <exit_range>
ffffffffc0203b50:	6400                	ld	s0,8(s0)
    while ((le = list_next(le)) != list)
ffffffffc0203b52:	fe8498e3          	bne	s1,s0,ffffffffc0203b42 <exit_mmap+0x36>
    }
}
ffffffffc0203b56:	60e2                	ld	ra,24(sp)
ffffffffc0203b58:	6442                	ld	s0,16(sp)
ffffffffc0203b5a:	64a2                	ld	s1,8(sp)
ffffffffc0203b5c:	6902                	ld	s2,0(sp)
ffffffffc0203b5e:	6105                	addi	sp,sp,32
ffffffffc0203b60:	8082                	ret
    assert(mm != NULL && mm_count(mm) == 0);
ffffffffc0203b62:	00003697          	auipc	a3,0x3
ffffffffc0203b66:	31e68693          	addi	a3,a3,798 # ffffffffc0206e80 <default_pmm_manager+0x808>
ffffffffc0203b6a:	00002617          	auipc	a2,0x2
ffffffffc0203b6e:	75e60613          	addi	a2,a2,1886 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203b72:	0e800593          	li	a1,232
ffffffffc0203b76:	00003517          	auipc	a0,0x3
ffffffffc0203b7a:	25250513          	addi	a0,a0,594 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203b7e:	911fc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0203b82 <vmm_init>:
}
...
void vmm_init(void)
{
ffffffffc0203b82:	7139                	addi	sp,sp,-64
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203b84:	04000513          	li	a0,64
{
ffffffffc0203b88:	fc06                	sd	ra,56(sp)
ffffffffc0203b8a:	f822                	sd	s0,48(sp)
ffffffffc0203b8c:	f426                	sd	s1,40(sp)
ffffffffc0203b8e:	f04a                	sd	s2,32(sp)
ffffffffc0203b90:	ec4e                	sd	s3,24(sp)
ffffffffc0203b92:	e852                	sd	s4,16(sp)
ffffffffc0203b94:	e456                	sd	s5,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203b96:	a4cfe0ef          	jal	ra,ffffffffc0201de2 <kmalloc>
    if (mm != NULL)
ffffffffc0203b9a:	2e050663          	beqz	a0,ffffffffc0203e86 <vmm_init+0x304>
...
ffffffffc0203bac:	02052023          	sw	zero,32(a0)
        mm->sm_priv = NULL;
ffffffffc0203bb0:	02053423          	sd	zero,40(a0)
ffffffffc0203bb4:	02052823          	sw	zero,48(a0)
ffffffffc0203bb8:	02053c23          	sd	zero,56(a0)
ffffffffc0203bbc:	03200413          	li	s0,50
ffffffffc0203bc0:	a811                	j	ffffffffc0203bd4 <vmm_init+0x52>
        vma->vm_start = vm_start;
ffffffffc0203bc2:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203bc4:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203bc6:	00052c23          	sw	zero,24(a0)
    assert(mm != NULL);
    ...
    int i;
    for (i = step1; i >= 1; i--)
ffffffffc0203bca:	146d                	addi	s0,s0,-5
    {
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203bcc:	8526                	mv	a0,s1
ffffffffc0203bce:	cd3ff0ef          	jal	ra,ffffffffc02038a0 <insert_vma_struct>
    for (i = step1; i >= 1; i--)
ffffffffc0203bd2:	c80d                	beqz	s0,ffffffffc0203c04 <vmm_init+0x82>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203bd4:	03000513          	li	a0,48
ffffffffc0203bd8:	a0afe0ef          	jal	ra,ffffffffc0201de2 <kmalloc>
ffffffffc0203bdc:	85aa                	mv	a1,a0
ffffffffc0203bde:	00240793          	addi	a5,s0,2
    if (vma != NULL)
ffffffffc0203be2:	f165                	bnez	a0,ffffffffc0203bc2 <vmm_init+0x40>
        assert(vma != NULL);
ffffffffc0203be4:	00003697          	auipc	a3,0x3
ffffffffc0203be8:	43468693          	addi	a3,a3,1076 # ffffffffc0207018 <default_pmm_manager+0x9a0>
ffffffffc0203bec:	00002617          	auipc	a2,0x2
ffffffffc0203bf0:	6dc60613          	addi	a2,a2,1756 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203bf4:	12c00593          	li	a1,300
ffffffffc0203bf8:	00003517          	auipc	a0,0x3
ffffffffc0203bfc:	1d050513          	addi	a0,a0,464 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203c00:	88ffc0ef          	jal	ra,ffffffffc020048e <__panic>
ffffffffc0203c04:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i++)
ffffffffc0203c08:	1f900913          	li	s2,505
ffffffffc0203c0c:	a819                	j	ffffffffc0203c22 <vmm_init+0xa0>
        vma->vm_start = vm_start;
ffffffffc0203c0e:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203c10:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203c12:	00052c23          	sw	zero,24(a0)
    for (i = step1 + 1; i <= step2; i++)
ffffffffc0203c16:	0415                	addi	s0,s0,5
    {
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203c18:	8526                	mv	a0,s1
ffffffffc0203c1a:	c87ff0ef          	jal	ra,ffffffffc02038a0 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i++)
ffffffffc0203c1e:	03240a63          	beq	s0,s2,ffffffffc0203c52 <vmm_init+0xd0>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203c22:	03000513          	li	a0,48
ffffffffc0203c26:	9bcfe0ef          	jal	ra,ffffffffc0201de2 <kmalloc>
ffffffffc0203c2a:	85aa                	mv	a1,a0
ffffffffc0203c2c:	00240793          	addi	a5,s0,2
    if (vma != NULL)
ffffffffc0203c30:	fd79                	bnez	a0,ffffffffc0203c0e <vmm_init+0x8c>
        assert(vma != NULL);
ffffffffc0203c32:	00003697          	auipc	a3,0x3
ffffffffc0203c36:	3e668693          	addi	a3,a3,998 # ffffffffc0207018 <default_pmm_manager+0x9a0>
ffffffffc0203c3a:	00002617          	auipc	a2,0x2
ffffffffc0203c3e:	68e60613          	addi	a2,a2,1678 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203c42:	13300593          	li	a1,307
ffffffffc0203c46:	00003517          	auipc	a0,0x3
ffffffffc0203c4a:	18250513          	addi	a0,a0,386 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203c4e:	841fc0ef          	jal	ra,ffffffffc020048e <__panic>
    return listelm->next;
ffffffffc0203c52:	649c                	ld	a5,8(s1)
ffffffffc0203c54:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i++)
ffffffffc0203c56:	1fb00593          	li	a1,507
    {
        assert(le != &(mm->mmap_list));
ffffffffc0203c5a:	16f48663          	beq	s1,a5,ffffffffc0203dc6 <vmm_init+0x244>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203c5e:	fe87b603          	ld	a2,-24(a5) # ffffffffffffefe8 <end+0x3fd548dc>
ffffffffc0203c62:	ffe70693          	addi	a3,a4,-2
ffffffffc0203c66:	10d61063          	bne	a2,a3,ffffffffc0203d66 <vmm_init+0x1e4>
ffffffffc0203c6a:	ff07b683          	ld	a3,-16(a5)
ffffffffc0203c6e:	0ed71c63          	bne	a4,a3,ffffffffc0203d66 <vmm_init+0x1e4>
    for (i = 1; i <= step2; i++)
ffffffffc0203c72:	0715                	addi	a4,a4,5
ffffffffc0203c74:	679c                	ld	a5,8(a5)
ffffffffc0203c76:	feb712e3          	bne	a4,a1,ffffffffc0203c5a <vmm_init+0xd8>
ffffffffc0203c7a:	4a1d                	li	s4,7
ffffffffc0203c7c:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i += 5)
ffffffffc0203c7e:	1f900a93          	li	s5,505
    {
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc0203c82:	85a2                	mv	a1,s0
ffffffffc0203c84:	8526                	mv	a0,s1
ffffffffc0203c86:	bdbff0ef          	jal	ra,ffffffffc0203860 <find_vma>
ffffffffc0203c8a:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc0203c8c:	16050d63          	beqz	a0,ffffffffc0203e06 <vmm_init+0x284>
        struct vma_struct *vma2 = find_vma(mm, i + 1);
ffffffffc0203c90:	00140593          	addi	a1,s0,1
ffffffffc0203c94:	8526                	mv	a0,s1
ffffffffc0203c96:	bcbff0ef          	jal	ra,ffffffffc0203860 <find_vma>
ffffffffc0203c9a:	89aa                	mv	s3,a0
        assert(vma2 != NULL);
ffffffffc0203c9c:	14050563          	beqz	a0,ffffffffc0203de6 <vmm_init+0x264>
        struct vma_struct *vma3 = find_vma(mm, i + 2);
ffffffffc0203ca0:	85d2                	mv	a1,s4
ffffffffc0203ca2:	8526                	mv	a0,s1
ffffffffc0203ca4:	bbdff0ef          	jal	ra,ffffffffc0203860 <find_vma>
        assert(vma3 == NULL);
ffffffffc0203ca8:	16051f63          	bnez	a0,ffffffffc0203e26 <vmm_init+0x2a4>
        struct vma_struct *vma4 = find_vma(mm, i + 3);
ffffffffc0203cac:	00340593          	addi	a1,s0,3
ffffffffc0203cb0:	8526                	mv	a0,s1
ffffffffc0203cb2:	bafff0ef          	jal	ra,ffffffffc0203860 <find_vma>
        assert(vma4 == NULL);
ffffffffc0203cb6:	1a051863          	bnez	a0,ffffffffc0203e66 <vmm_init+0x2e4>
        struct vma_struct *vma5 = find_vma(mm, i + 4);
ffffffffc0203cba:	00440593          	addi	a1,s0,4
ffffffffc0203cbe:	8526                	mv	a0,s1
ffffffffc0203cc0:	ba1ff0ef          	jal	ra,ffffffffc0203860 <find_vma>
        assert(vma5 == NULL);
ffffffffc0203cc4:	18051163          	bnez	a0,ffffffffc0203e46 <vmm_init+0x2c4>

        assert(vma1->vm_start == i && vma1->vm_end == i + 2);
ffffffffc0203cc8:	00893783          	ld	a5,8(s2)
ffffffffc0203ccc:	0a879d63          	bne	a5,s0,ffffffffc0203d86 <vmm_init+0x204>
ffffffffc0203cd0:	01093783          	ld	a5,16(s2)
ffffffffc0203cd4:	0b479963          	bne	a5,s4,ffffffffc0203d86 <vmm_init+0x204>
        assert(vma2->vm_start == i && vma2->vm_end == i + 2);
ffffffffc0203cd8:	0089b783          	ld	a5,8(s3)
ffffffffc0203cdc:	0c879563          	bne	a5,s0,ffffffffc0203da6 <vmm_init+0x224>
ffffffffc0203ce0:	0109b783          	ld	a5,16(s3)
ffffffffc0203ce4:	0d479163          	bne	a5,s4,ffffffffc0203da6 <vmm_init+0x224>
    for (i = 5; i <= 5 * step2; i += 5)
ffffffffc0203ce8:	0415                	addi	s0,s0,5
ffffffffc0203cea:	0a15                	addi	s4,s4,5
ffffffffc0203cec:	f9541be3          	bne	s0,s5,ffffffffc0203c82 <vmm_init+0x100>
ffffffffc0203cf0:	4411                	li	s0,4
    }

    for (i = 4; i >= 0; i--)
ffffffffc0203cf2:	597d                	li	s2,-1
    {
        struct vma_struct *vma_below_5 = find_vma(mm, i);
ffffffffc0203cf4:	85a2                	mv	a1,s0
ffffffffc0203cf6:	8526                	mv	a0,s1
ffffffffc0203cf8:	b69ff0ef          	jal	ra,ffffffffc0203860 <find_vma>
ffffffffc0203cfc:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL)
ffffffffc0203d00:	c90d                	beqz	a0,ffffffffc0203d32 <vmm_init+0x1b0>
        {
            cprintf("vma_below_5: i %x, start %x, end %x\n", i, vma_below_5->vm_start, vma_below_5->vm_end);
ffffffffc0203d02:	6914                	ld	a3,16(a0)
ffffffffc0203d04:	6510                	ld	a2,8(a0)
ffffffffc0203d06:	00003517          	auipc	a0,0x3
ffffffffc0203d0a:	29a50513          	addi	a0,a0,666 # ffffffffc0206fa0 <default_pmm_manager+0x928>
ffffffffc0203d0e:	c86fc0ef          	jal	ra,ffffffffc0200194 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203d12:	00003697          	auipc	a3,0x3
ffffffffc0203d16:	2b668693          	addi	a3,a3,694 # ffffffffc0206fc8 <default_pmm_manager+0x950>
ffffffffc0203d1a:	00002617          	auipc	a2,0x2
ffffffffc0203d1e:	5ae60613          	addi	a2,a2,1454 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203d22:	15900593          	li	a1,345
ffffffffc0203d26:	00003517          	auipc	a0,0x3
ffffffffc0203d2a:	0a250513          	addi	a0,a0,162 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203d2e:	f60fc0ef          	jal	ra,ffffffffc020048e <__panic>
    for (i = 4; i >= 0; i--)
ffffffffc0203d32:	147d                	addi	s0,s0,-1
ffffffffc0203d34:	fd2410e3          	bne	s0,s2,ffffffffc0203cf4 <vmm_init+0x172>
    }

    mm_destroy(mm);
ffffffffc0203d38:	8526                	mv	a0,s1
ffffffffc0203d3a:	c37ff0ef          	jal	ra,ffffffffc0203970 <mm_destroy>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc0203d3e:	00003517          	auipc	a0,0x3
ffffffffc0203d42:	2a250513          	addi	a0,a0,674 # ffffffffc0206fe0 <default_pmm_manager+0x968>
ffffffffc0203d46:	c4efc0ef          	jal	ra,ffffffffc0200194 <cprintf>
}
ffffffffc0203d4a:	7442                	ld	s0,48(sp)
ffffffffc0203d4c:	70e2                	ld	ra,56(sp)
...
ffffffffc0203d5c:	2a850513          	addi	a0,a0,680 # ffffffffc0207000 <default_pmm_manager+0x988>
}
ffffffffc0203d60:	6121                	addi	sp,sp,64
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203d62:	c32fc06f          	j	ffffffffc0200194 <cprintf>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203d66:	00003697          	auipc	a3,0x3
ffffffffc0203d6a:	15268693          	addi	a3,a3,338 # ffffffffc0206eb8 <default_pmm_manager+0x840>
ffffffffc0203d6e:	00002617          	auipc	a2,0x2
ffffffffc0203d72:	55a60613          	addi	a2,a2,1370 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203d76:	13d00593          	li	a1,317
ffffffffc0203d7a:	00003517          	auipc	a0,0x3
ffffffffc0203d7e:	04e50513          	addi	a0,a0,78 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203d82:	f0cfc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma1->vm_start == i && vma1->vm_end == i + 2);
ffffffffc0203d86:	00003697          	auipc	a3,0x3
ffffffffc0203d8a:	1ba68693          	addi	a3,a3,442 # ffffffffc0206f40 <default_pmm_manager+0x8c8>
ffffffffc0203d8e:	00002617          	auipc	a2,0x2
ffffffffc0203d92:	53a60613          	addi	a2,a2,1338 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203d96:	14e00593          	li	a1,334
ffffffffc0203d9a:	00003517          	auipc	a0,0x3
ffffffffc0203d9e:	02e50513          	addi	a0,a0,46 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203da2:	eecfc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma2->vm_start == i && vma2->vm_end == i + 2);
ffffffffc0203da6:	00003697          	auipc	a3,0x3
ffffffffc0203daa:	1ca68693          	addi	a3,a3,458 # ffffffffc0206f70 <default_pmm_manager+0x8f8>
ffffffffc0203dae:	00002617          	auipc	a2,0x2
ffffffffc0203db2:	51a60613          	addi	a2,a2,1306 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203db6:	14f00593          	li	a1,335
ffffffffc0203dba:	00003517          	auipc	a0,0x3
ffffffffc0203dbe:	00e50513          	addi	a0,a0,14 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203dc2:	eccfc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203dc6:	00003697          	auipc	a3,0x3
ffffffffc0203dca:	0da68693          	addi	a3,a3,218 # ffffffffc0206ea0 <default_pmm_manager+0x828>
ffffffffc0203dce:	00002617          	auipc	a2,0x2
ffffffffc0203dd2:	4fa60613          	addi	a2,a2,1274 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203dd6:	13b00593          	li	a1,315
ffffffffc0203dda:	00003517          	auipc	a0,0x3
ffffffffc0203dde:	fee50513          	addi	a0,a0,-18 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203de2:	eacfc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma2 != NULL);
ffffffffc0203de6:	00003697          	auipc	a3,0x3
ffffffffc0203dea:	11a68693          	addi	a3,a3,282 # ffffffffc0206f00 <default_pmm_manager+0x888>
ffffffffc0203dee:	00002617          	auipc	a2,0x2
ffffffffc0203df2:	4da60613          	addi	a2,a2,1242 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203df6:	14600593          	li	a1,326
ffffffffc0203dfa:	00003517          	auipc	a0,0x3
ffffffffc0203dfe:	fce50513          	addi	a0,a0,-50 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203e02:	e8cfc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma1 != NULL);
ffffffffc0203e06:	00003697          	auipc	a3,0x3
ffffffffc0203e0a:	0ea68693          	addi	a3,a3,234 # ffffffffc0206ef0 <default_pmm_manager+0x878>
ffffffffc0203e0e:	00002617          	auipc	a2,0x2
ffffffffc0203e12:	4ba60613          	addi	a2,a2,1210 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203e16:	14400593          	li	a1,324
ffffffffc0203e1a:	00003517          	auipc	a0,0x3
ffffffffc0203e1e:	fae50513          	addi	a0,a0,-82 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203e22:	e6cfc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma3 == NULL);
ffffffffc0203e26:	00003697          	auipc	a3,0x3
ffffffffc0203e2a:	0ea68693          	addi	a3,a3,234 # ffffffffc0206f10 <default_pmm_manager+0x898>
ffffffffc0203e2e:	00002617          	auipc	a2,0x2
ffffffffc0203e32:	49a60613          	addi	a2,a2,1178 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203e36:	14800593          	li	a1,328
ffffffffc0203e3a:	00003517          	auipc	a0,0x3
ffffffffc0203e3e:	f8e50513          	addi	a0,a0,-114 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203e42:	e4cfc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma5 == NULL);
ffffffffc0203e46:	00003697          	auipc	a3,0x3
ffffffffc0203e4a:	0ea68693          	addi	a3,a3,234 # ffffffffc0206f30 <default_pmm_manager+0x8b8>
ffffffffc0203e4e:	00002617          	auipc	a2,0x2
ffffffffc0203e52:	47a60613          	addi	a2,a2,1146 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203e56:	14c00593          	li	a1,332
ffffffffc0203e5a:	00003517          	auipc	a0,0x3
ffffffffc0203e5e:	f6e50513          	addi	a0,a0,-146 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203e62:	e2cfc0ef          	jal	ra,ffffffffc020048e <__panic>
        assert(vma4 == NULL);
ffffffffc0203e66:	00003697          	auipc	a3,0x3
ffffffffc0203e6a:	0ba68693          	addi	a3,a3,186 # ffffffffc0206f20 <default_pmm_manager+0x8a8>
ffffffffc0203e6e:	00002617          	auipc	a2,0x2
ffffffffc0203e72:	45a60613          	addi	a2,a2,1114 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203e76:	14a00593          	li	a1,330
ffffffffc0203e7a:	00003517          	auipc	a0,0x3
ffffffffc0203e7e:	f4e50513          	addi	a0,a0,-178 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203e82:	e0cfc0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(mm != NULL);
ffffffffc0203e86:	00003697          	auipc	a3,0x3
ffffffffc0203e8a:	fca68693          	addi	a3,a3,-54 # ffffffffc0206e50 <default_pmm_manager+0x7d8>
ffffffffc0203e8e:	00002617          	auipc	a2,0x2
ffffffffc0203e92:	43a60613          	addi	a2,a2,1082 # ffffffffc02062c8 <commands+0x858>
ffffffffc0203e96:	12400593          	li	a1,292
ffffffffc0203e9a:	00003517          	auipc	a0,0x3
ffffffffc0203e9e:	f2e50513          	addi	a0,a0,-210 # ffffffffc0206dc8 <default_pmm_manager+0x750>
ffffffffc0203ea2:	decfc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0203ea6 <user_mem_check>:
}
bool user_mem_check(struct mm_struct *mm, uintptr_t addr, size_t len, bool write)
{
ffffffffc0203ea6:	7179                	addi	sp,sp,-48
ffffffffc0203ea8:	f022                	sd	s0,32(sp)
ffffffffc0203eaa:	f406                	sd	ra,40(sp)
ffffffffc0203eac:	ec26                	sd	s1,24(sp)
ffffffffc0203eae:	e84a                	sd	s2,16(sp)
ffffffffc0203eb0:	e44e                	sd	s3,8(sp)
ffffffffc0203eb2:	e052                	sd	s4,0(sp)
ffffffffc0203eb4:	842e                	mv	s0,a1
    if (mm != NULL)
ffffffffc0203eb6:	c135                	beqz	a0,ffffffffc0203f1a <user_mem_check+0x74>
    {
        if (!USER_ACCESS(addr, addr + len))
ffffffffc0203eb8:	002007b7          	lui	a5,0x200
ffffffffc0203ebc:	04f5e663          	bltu	a1,a5,ffffffffc0203f08 <user_mem_check+0x62>
ffffffffc0203ec0:	00c584b3          	add	s1,a1,a2
ffffffffc0203ec4:	0495f263          	bgeu	a1,s1,ffffffffc0203f08 <user_mem_check+0x62>
ffffffffc0203ec8:	4785                	li	a5,1
ffffffffc0203eca:	07fe                	slli	a5,a5,0x1f
ffffffffc0203ecc:	0297ee63          	bltu	a5,s1,ffffffffc0203f08 <user_mem_check+0x62>
ffffffffc0203ed0:	892a                	mv	s2,a0
ffffffffc0203ed2:	89b6                	mv	s3,a3
            {
                return 0;
            }
...
ffffffffc0203ed4:	6a05                	lui	s4,0x1
ffffffffc0203ed6:	a821                	j	ffffffffc0203eee <user_mem_check+0x48>
            if (!(vma->vm_flags & ((write) ? VM_WRITE : VM_READ)))
ffffffffc0203ed8:	0027f693          	andi	a3,a5,2
                if (start < vma->vm_start + PGSIZE)
ffffffffc0203edc:	9752                	add	a4,a4,s4
            if (write && (vma->vm_flags & VM_STACK))
ffffffffc0203ede:	8ba1                	andi	a5,a5,8
            if (!(vma->vm_flags & ((write) ? VM_WRITE : VM_READ)))
ffffffffc0203ee0:	c685                	beqz	a3,ffffffffc0203f08 <user_mem_check+0x62>
            if (write && (vma->vm_flags & VM_STACK))
ffffffffc0203ee2:	c399                	beqz	a5,ffffffffc0203ee8 <user_mem_check+0x42>
                if (start < vma->vm_start + PGSIZE)
ffffffffc0203ee4:	02e46263          	bltu	s0,a4,ffffffffc0203f08 <user_mem_check+0x62>
                { // check stack start & size
                    return 0;
                }
            }
            start = vma->vm_end;
ffffffffc0203ee8:	6900                	ld	s0,16(a0)
        while (start < end)
ffffffffc0203eea:	04947663          	bgeu	s0,s1,ffffffffc0203f36 <user_mem_check+0x90>
            if ((vma = find_vma(mm, start)) == NULL || start < vma->vm_start)
ffffffffc0203eee:	85a2                	mv	a1,s0
ffffffffc0203ef0:	854a                	mv	a0,s2
ffffffffc0203ef2:	96fff0ef          	jal	ra,ffffffffc0203860 <find_vma>
ffffffffc0203ef6:	c909                	beqz	a0,ffffffffc0203f08 <user_mem_check+0x62>
ffffffffc0203ef8:	6518                	ld	a4,8(a0)
ffffffffc0203efa:	00e46763          	bltu	s0,a4,ffffffffc0203f08 <user_mem_check+0x62>
            if (!(vma->vm_flags & ((write) ? VM_WRITE : VM_READ)))
ffffffffc0203efe:	4d1c                	lw	a5,24(a0)
ffffffffc0203f00:	fc099ce3          	bnez	s3,ffffffffc0203ed8 <user_mem_check+0x32>
ffffffffc0203f04:	8b85                	andi	a5,a5,1
ffffffffc0203f06:	f3ed                	bnez	a5,ffffffffc0203ee8 <user_mem_check+0x42>
            return 0;
ffffffffc0203f08:	4501                	li	a0,0
        }
        return 1;
    }
    return KERN_ACCESS(addr, addr + len);
ffffffffc0203f0a:	70a2                	ld	ra,40(sp)
ffffffffc0203f0c:	7402                	ld	s0,32(sp)
ffffffffc0203f0e:	64e2                	ld	s1,24(sp)
ffffffffc0203f10:	6942                	ld	s2,16(sp)
...
ffffffffc0203f18:	8082                	ret
    return KERN_ACCESS(addr, addr + len);
ffffffffc0203f1a:	c02007b7          	lui	a5,0xc0200
ffffffffc0203f1e:	4501                	li	a0,0
ffffffffc0203f20:	fef5e5e3          	bltu	a1,a5,ffffffffc0203f0a <user_mem_check+0x64>
ffffffffc0203f24:	962e                	add	a2,a2,a1
ffffffffc0203f26:	fec5f2e3          	bgeu	a1,a2,ffffffffc0203f0a <user_mem_check+0x64>
ffffffffc0203f2a:	c8000537          	lui	a0,0xc8000
ffffffffc0203f2e:	0505                	addi	a0,a0,1
ffffffffc0203f30:	00a63533          	sltu	a0,a2,a0
ffffffffc0203f34:	bfd9                	j	ffffffffc0203f0a <user_mem_check+0x64>
        return 1;
ffffffffc0203f36:	4505                	li	a0,1
ffffffffc0203f38:	bfc9                	j	ffffffffc0203f0a <user_mem_check+0x64>

ffffffffc0203f3a <kernel_thread_entry>:
.text
...
ffffffffc0203f3a:	8526                	mv	a0,s1
	jalr s0
ffffffffc0203f3c:	9402                	jalr	s0

	jal do_exit
ffffffffc0203f3e:	5d2000ef          	jal	ra,ffffffffc0204510 <do_exit>

ffffffffc0203f42 <alloc_proc>:
...
ffffffffc0203f44:	10800513          	li	a0,264
{
ffffffffc0203f48:	e022                	sd	s0,0(sp)
ffffffffc0203f4a:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0203f4c:	e97fd0ef          	jal	ra,ffffffffc0201de2 <kmalloc>
ffffffffc0203f50:	842a                	mv	s0,a0
    if (proc != NULL)
ffffffffc0203f52:	cd21                	beqz	a0,ffffffffc0203faa <alloc_proc+0x68>
...
ffffffffc0203f54:	57fd                	li	a5,-1
ffffffffc0203f56:	1782                	slli	a5,a5,0x20
ffffffffc0203f58:	e11c                	sd	a5,0(a0)
         proc->runs = 0;
         proc->kstack = 0;
...
ffffffffc0203f5e:	4581                	li	a1,0
         proc->runs = 0;
ffffffffc0203f60:	00052423          	sw	zero,8(a0) # ffffffffc8000008 <end+0x7d558fc>
         proc->kstack = 0;
ffffffffc0203f64:	00053823          	sd	zero,16(a0)
         proc->need_resched = 0; //不用schedule调度其他进程
ffffffffc0203f68:	00053c23          	sd	zero,24(a0)
         proc->parent = NULL;
ffffffffc0203f6c:	02053023          	sd	zero,32(a0)
         proc->mm = NULL;
ffffffffc0203f70:	02053423          	sd	zero,40(a0)
         memset(&proc->context, 0, sizeof(struct context));
ffffffffc0203f74:	03050513          	addi	a0,a0,48
ffffffffc0203f78:	065010ef          	jal	ra,ffffffffc02057dc <memset>
         proc->tf = NULL;
         proc->pgdir = boot_pgdir_pa;
ffffffffc0203f7c:	000a6797          	auipc	a5,0xa6
ffffffffc0203f80:	7447b783          	ld	a5,1860(a5) # ffffffffc02aa6c0 <boot_pgdir_pa>
         proc->tf = NULL;
ffffffffc0203f84:	0a043023          	sd	zero,160(s0)
         proc->pgdir = boot_pgdir_pa;
ffffffffc0203f88:	f45c                	sd	a5,168(s0)
         //cprintf("boot_pgdir_pa: %lx\n", boot_pgdir_pa);
         proc->flags = 0;
ffffffffc0203f8a:	0a042823          	sw	zero,176(s0)
         memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203f8e:	4641                	li	a2,16
ffffffffc0203f90:	4581                	li	a1,0
ffffffffc0203f92:	0b440513          	addi	a0,s0,180
ffffffffc0203f96:	047010ef          	jal	ra,ffffffffc02057dc <memset>
        /*
         ...
         */
         proc->wait_state = 0;
ffffffffc0203f9a:	0e042623          	sw	zero,236(s0)
            proc->cptr = NULL;
ffffffffc0203f9e:	0e043823          	sd	zero,240(s0)
            proc->yptr = NULL;
ffffffffc0203fa2:	0e043c23          	sd	zero,248(s0)
            proc->optr = NULL;
ffffffffc0203fa6:	10043023          	sd	zero,256(s0)
    }
    return proc;
}
ffffffffc0203faa:	60a2                	ld	ra,8(sp)
ffffffffc0203fac:	8522                	mv	a0,s0
ffffffffc0203fae:	6402                	ld	s0,0(sp)
ffffffffc0203fb0:	0141                	addi	sp,sp,16
ffffffffc0203fb2:	8082                	ret

ffffffffc0203fb4 <forkret>:
...
{
    forkrets(current->tf);
ffffffffc0203fb4:	000a6797          	auipc	a5,0xa6
ffffffffc0203fb8:	73c7b783          	ld	a5,1852(a5) # ffffffffc02aa6f0 <current>
ffffffffc0203fbc:	73c8                	ld	a0,160(a5)
ffffffffc0203fbe:	898fd06f          	j	ffffffffc0201056 <forkrets>

ffffffffc0203fc2 <user_main>:
...
ffffffffc0203fc2:	000a6797          	auipc	a5,0xa6
ffffffffc0203fc6:	72e7b783          	ld	a5,1838(a5) # ffffffffc02aa6f0 <current>
ffffffffc0203fca:	43cc                	lw	a1,4(a5)
{
ffffffffc0203fcc:	7139                	addi	sp,sp,-64
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0203fce:	00003617          	auipc	a2,0x3
ffffffffc0203fd2:	05a60613          	addi	a2,a2,90 # ffffffffc0207028 <default_pmm_manager+0x9b0>
ffffffffc0203fd6:	00003517          	auipc	a0,0x3
ffffffffc0203fda:	06250513          	addi	a0,a0,98 # ffffffffc0207038 <default_pmm_manager+0x9c0>
{
ffffffffc0203fde:	fc06                	sd	ra,56(sp)
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0203fe0:	9b4fc0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc0203fe4:	3fe07797          	auipc	a5,0x3fe07
ffffffffc0203fe8:	97c78793          	addi	a5,a5,-1668 # a960 <_binary_obj___user_forktest_out_size>
ffffffffc0203fec:	e43e                	sd	a5,8(sp)
ffffffffc0203fee:	00003517          	auipc	a0,0x3
ffffffffc0203ff2:	03a50513          	addi	a0,a0,58 # ffffffffc0207028 <default_pmm_manager+0x9b0>
ffffffffc0203ff6:	00045797          	auipc	a5,0x45
ffffffffc0203ffa:	6fa78793          	addi	a5,a5,1786 # ffffffffc02496f0 <_binary_obj___user_forktest_out_start>
ffffffffc0203ffe:	f03e                	sd	a5,32(sp)
ffffffffc0204000:	f42a                	sd	a0,40(sp)
    int64_t ret = 0, len = strlen(name);
ffffffffc0204002:	e802                	sd	zero,16(sp)
ffffffffc0204004:	736010ef          	jal	ra,ffffffffc020573a <strlen>
ffffffffc0204008:	ec2a                	sd	a0,24(sp)
    asm volatile(
ffffffffc020400a:	4511                	li	a0,4
ffffffffc020400c:	55a2                	lw	a1,40(sp)
ffffffffc020400e:	4662                	lw	a2,24(sp)
ffffffffc0204010:	5682                	lw	a3,32(sp)
ffffffffc0204012:	4722                	lw	a4,8(sp)
ffffffffc0204014:	48a9                	li	a7,10
ffffffffc0204016:	9002                	ebreak
ffffffffc0204018:	c82a                	sw	a0,16(sp)
    cprintf("ret = %d\n", ret);
ffffffffc020401a:	65c2                	ld	a1,16(sp)
ffffffffc020401c:	00003517          	auipc	a0,0x3
ffffffffc0204020:	04450513          	addi	a0,a0,68 # ffffffffc0207060 <default_pmm_manager+0x9e8>
...
ffffffffc020402c:	04860613          	addi	a2,a2,72 # ffffffffc0207070 <default_pmm_manager+0x9f8>
ffffffffc0204030:	3ab00593          	li	a1,939
ffffffffc0204034:	00003517          	auipc	a0,0x3
ffffffffc0204038:	05c50513          	addi	a0,a0,92 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc020403c:	c52fc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0204040 <put_pgdir>:
    return pa2page(PADDR(kva));
ffffffffc0204040:	6d14                	ld	a3,24(a0)
{
ffffffffc0204042:	1141                	addi	sp,sp,-16
ffffffffc0204044:	e406                	sd	ra,8(sp)
ffffffffc0204046:	c02007b7          	lui	a5,0xc0200
ffffffffc020404a:	02f6ee63          	bltu	a3,a5,ffffffffc0204086 <put_pgdir+0x46>
ffffffffc020404e:	000a6517          	auipc	a0,0xa6
ffffffffc0204052:	69a53503          	ld	a0,1690(a0) # ffffffffc02aa6e8 <va_pa_offset>
ffffffffc0204056:	8e89                	sub	a3,a3,a0
    if (PPN(pa) >= npage)
ffffffffc0204058:	82b1                	srli	a3,a3,0xc
ffffffffc020405a:	000a6797          	auipc	a5,0xa6
ffffffffc020405e:	6767b783          	ld	a5,1654(a5) # ffffffffc02aa6d0 <npage>
ffffffffc0204062:	02f6fe63          	bgeu	a3,a5,ffffffffc020409e <put_pgdir+0x5e>
    return &pages[PPN(pa) - nbase];
ffffffffc0204066:	00004517          	auipc	a0,0x4
ffffffffc020406a:	8c253503          	ld	a0,-1854(a0) # ffffffffc0207928 <nbase>
}
ffffffffc020406e:	60a2                	ld	ra,8(sp)
ffffffffc0204070:	8e89                	sub	a3,a3,a0
ffffffffc0204072:	069a                	slli	a3,a3,0x6
    free_page(kva2page(mm->pgdir));
ffffffffc0204074:	000a6517          	auipc	a0,0xa6
ffffffffc0204078:	66453503          	ld	a0,1636(a0) # ffffffffc02aa6d8 <pages>
ffffffffc020407c:	4585                	li	a1,1
ffffffffc020407e:	9536                	add	a0,a0,a3
}
ffffffffc0204080:	0141                	addi	sp,sp,16
    free_page(kva2page(mm->pgdir));
ffffffffc0204082:	f7dfd06f          	j	ffffffffc0201ffe <free_pages>
    return pa2page(PADDR(kva));
ffffffffc0204086:	00002617          	auipc	a2,0x2
ffffffffc020408a:	69a60613          	addi	a2,a2,1690 # ffffffffc0206720 <default_pmm_manager+0xa8>
ffffffffc020408e:	07700593          	li	a1,119
ffffffffc0204092:	00002517          	auipc	a0,0x2
ffffffffc0204096:	1b650513          	addi	a0,a0,438 # ffffffffc0206248 <commands+0x7d8>
ffffffffc020409a:	bf4fc0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("pa2page called with invalid pa");
ffffffffc020409e:	00002617          	auipc	a2,0x2
ffffffffc02040a2:	6aa60613          	addi	a2,a2,1706 # ffffffffc0206748 <default_pmm_manager+0xd0>
ffffffffc02040a6:	06900593          	li	a1,105
ffffffffc02040aa:	00002517          	auipc	a0,0x2
ffffffffc02040ae:	19e50513          	addi	a0,a0,414 # ffffffffc0206248 <commands+0x7d8>
ffffffffc02040b2:	bdcfc0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc02040b6 <proc_run>:
{
ffffffffc02040b6:	7179                	addi	sp,sp,-48
ffffffffc02040b8:	f026                	sd	s1,32(sp)
    if (proc != current)
ffffffffc02040ba:	000a6497          	auipc	s1,0xa6
ffffffffc02040be:	63648493          	addi	s1,s1,1590 # ffffffffc02aa6f0 <current>
ffffffffc02040c2:	6098                	ld	a4,0(s1)
{
ffffffffc02040c4:	f406                	sd	ra,40(sp)
ffffffffc02040c6:	ec4a                	sd	s2,24(sp)
    if (proc != current)
ffffffffc02040c8:	02a70763          	beq	a4,a0,ffffffffc02040f6 <proc_run+0x40>
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02040cc:	100027f3          	csrr	a5,sstatus
ffffffffc02040d0:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02040d2:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02040d4:	ef85                	bnez	a5,ffffffffc020410c <proc_run+0x56>
...
ffffffffc02040d8:	56fd                	li	a3,-1
ffffffffc02040da:	16fe                	slli	a3,a3,0x3f
ffffffffc02040dc:	83b1                	srli	a5,a5,0xc
         current = proc;
ffffffffc02040de:	e088                	sd	a0,0(s1)
ffffffffc02040e0:	8fd5                	or	a5,a5,a3
ffffffffc02040e2:	18079073          	csrw	satp,a5
         switch_to(&prev->context,&current->context);
ffffffffc02040e6:	03050593          	addi	a1,a0,48
ffffffffc02040ea:	03070513          	addi	a0,a4,48
ffffffffc02040ee:	7f3000ef          	jal	ra,ffffffffc02050e0 <switch_to>
    if (flag)
ffffffffc02040f2:	00091763          	bnez	s2,ffffffffc0204100 <proc_run+0x4a>
}
ffffffffc02040f6:	70a2                	ld	ra,40(sp)
ffffffffc02040f8:	7482                	ld	s1,32(sp)
ffffffffc02040fa:	6962                	ld	s2,24(sp)
ffffffffc02040fc:	6145                	addi	sp,sp,48
ffffffffc02040fe:	8082                	ret
ffffffffc0204100:	70a2                	ld	ra,40(sp)
ffffffffc0204102:	7482                	ld	s1,32(sp)
ffffffffc0204104:	6962                	ld	s2,24(sp)
ffffffffc0204106:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0204108:	8a7fc06f          	j	ffffffffc02009ae <intr_enable>
ffffffffc020410c:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc020410e:	8a7fc0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
         struct proc_struct *prev = current;
ffffffffc0204112:	6098                	ld	a4,0(s1)
        return 1;
ffffffffc0204114:	6522                	ld	a0,8(sp)
ffffffffc0204116:	4905                	li	s2,1
ffffffffc0204118:	bf7d                	j	ffffffffc02040d6 <proc_run+0x20>

ffffffffc020411a <do_fork>:
{
ffffffffc020411a:	7119                	addi	sp,sp,-128
ffffffffc020411c:	f0ca                	sd	s2,96(sp)
    if (nr_process >= MAX_PROCESS)
ffffffffc020411e:	000a6917          	auipc	s2,0xa6
ffffffffc0204122:	5ea90913          	addi	s2,s2,1514 # ffffffffc02aa708 <nr_process>
ffffffffc0204126:	00092703          	lw	a4,0(s2)
{
ffffffffc020412a:	fc86                	sd	ra,120(sp)
ffffffffc020412c:	f8a2                	sd	s0,112(sp)
ffffffffc020412e:	f4a6                	sd	s1,104(sp)
ffffffffc0204130:	ecce                	sd	s3,88(sp)
ffffffffc0204132:	e8d2                	sd	s4,80(sp)
ffffffffc0204134:	e4d6                	sd	s5,72(sp)
ffffffffc0204136:	e0da                	sd	s6,64(sp)
ffffffffc0204138:	fc5e                	sd	s7,56(sp)
ffffffffc020413a:	f862                	sd	s8,48(sp)
ffffffffc020413c:	f466                	sd	s9,40(sp)
ffffffffc020413e:	f06a                	sd	s10,32(sp)
ffffffffc0204140:	ec6e                	sd	s11,24(sp)
    if (nr_process >= MAX_PROCESS)
ffffffffc0204142:	6785                	lui	a5,0x1
ffffffffc0204144:	2ef75c63          	bge	a4,a5,ffffffffc020443c <do_fork+0x322>
ffffffffc0204148:	8a2a                	mv	s4,a0
ffffffffc020414a:	89ae                	mv	s3,a1
ffffffffc020414c:	8432                	mv	s0,a2
    proc = alloc_proc();
ffffffffc020414e:	df5ff0ef          	jal	ra,ffffffffc0203f42 <alloc_proc>
ffffffffc0204152:	84aa                	mv	s1,a0
    if(proc == NULL)
ffffffffc0204154:	2c050863          	beqz	a0,ffffffffc0204424 <do_fork+0x30a>
    proc->parent = current;          // 父进程为当前进程
ffffffffc0204158:	000a6c17          	auipc	s8,0xa6
ffffffffc020415c:	598c0c13          	addi	s8,s8,1432 # ffffffffc02aa6f0 <current>
ffffffffc0204160:	000c3783          	ld	a5,0(s8)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204164:	4509                	li	a0,2
    proc->parent = current;          // 父进程为当前进程
ffffffffc0204166:	f09c                	sd	a5,32(s1)
    current->wait_state = 0; // 确保当前进程的 wait_state 为 0
ffffffffc0204168:	0e07a623          	sw	zero,236(a5) # 10ec <_binary_obj___user_faultread_out_size-0x8abc>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc020416c:	e55fd0ef          	jal	ra,ffffffffc0201fc0 <alloc_pages>
    if (page != NULL)
ffffffffc0204170:	2a050763          	beqz	a0,ffffffffc020441e <do_fork+0x304>
    return page - pages + nbase;
ffffffffc0204174:	000a6a97          	auipc	s5,0xa6
ffffffffc0204178:	564a8a93          	addi	s5,s5,1380 # ffffffffc02aa6d8 <pages>
ffffffffc020417c:	000ab683          	ld	a3,0(s5)
ffffffffc0204180:	00003b17          	auipc	s6,0x3
ffffffffc0204184:	7a8b0b13          	addi	s6,s6,1960 # ffffffffc0207928 <nbase>
ffffffffc0204188:	000b3783          	ld	a5,0(s6)
ffffffffc020418c:	40d506b3          	sub	a3,a0,a3
    return KADDR(page2pa(page));
ffffffffc0204190:	000a6b97          	auipc	s7,0xa6
ffffffffc0204194:	540b8b93          	addi	s7,s7,1344 # ffffffffc02aa6d0 <npage>
    return page - pages + nbase;
ffffffffc0204198:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc020419a:	5dfd                	li	s11,-1
ffffffffc020419c:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc02041a0:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc02041a2:	00cddd93          	srli	s11,s11,0xc
ffffffffc02041a6:	01b6f633          	and	a2,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc02041aa:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02041ac:	2ce67563          	bgeu	a2,a4,ffffffffc0204476 <do_fork+0x35c>
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc02041b0:	000c3603          	ld	a2,0(s8)
ffffffffc02041b4:	000a6c17          	auipc	s8,0xa6
ffffffffc02041b8:	534c0c13          	addi	s8,s8,1332 # ffffffffc02aa6e8 <va_pa_offset>
ffffffffc02041bc:	000c3703          	ld	a4,0(s8)
ffffffffc02041c0:	02863d03          	ld	s10,40(a2)
ffffffffc02041c4:	e43e                	sd	a5,8(sp)
ffffffffc02041c6:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02041c8:	e894                	sd	a3,16(s1)
    if (oldmm == NULL)
ffffffffc02041ca:	020d0863          	beqz	s10,ffffffffc02041fa <do_fork+0xe0>
    if (clone_flags & CLONE_VM)
ffffffffc02041ce:	100a7a13          	andi	s4,s4,256
ffffffffc02041d2:	180a0863          	beqz	s4,ffffffffc0204362 <do_fork+0x248>
}
...
{
    mm->mm_count += 1;
ffffffffc02041d6:	030d2703          	lw	a4,48(s10)
    proc->pgdir = PADDR(mm->pgdir);
ffffffffc02041da:	018d3783          	ld	a5,24(s10)
ffffffffc02041de:	c02006b7          	lui	a3,0xc0200
ffffffffc02041e2:	2705                	addiw	a4,a4,1
ffffffffc02041e4:	02ed2823          	sw	a4,48(s10)
    proc->mm = mm;
ffffffffc02041e8:	03a4b423          	sd	s10,40(s1)
    proc->pgdir = PADDR(mm->pgdir);
ffffffffc02041ec:	2ad7e163          	bltu	a5,a3,ffffffffc020448e <do_fork+0x374>
ffffffffc02041f0:	000c3703          	ld	a4,0(s8)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc02041f4:	6894                	ld	a3,16(s1)
    proc->pgdir = PADDR(mm->pgdir);
ffffffffc02041f6:	8f99                	sub	a5,a5,a4
ffffffffc02041f8:	f4dc                	sd	a5,168(s1)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc02041fa:	6789                	lui	a5,0x2
ffffffffc02041fc:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7cc8>
ffffffffc0204200:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204202:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204204:	f0d4                	sd	a3,160(s1)
    *(proc->tf) = *tf;
ffffffffc0204206:	87b6                	mv	a5,a3
ffffffffc0204208:	12040893          	addi	a7,s0,288
ffffffffc020420c:	00063803          	ld	a6,0(a2)
ffffffffc0204210:	6608                	ld	a0,8(a2)
ffffffffc0204212:	6a0c                	ld	a1,16(a2)
ffffffffc0204214:	6e18                	ld	a4,24(a2)
ffffffffc0204216:	0107b023          	sd	a6,0(a5)
ffffffffc020421a:	e788                	sd	a0,8(a5)
ffffffffc020421c:	eb8c                	sd	a1,16(a5)
ffffffffc020421e:	ef98                	sd	a4,24(a5)
ffffffffc0204220:	02060613          	addi	a2,a2,32
ffffffffc0204224:	02078793          	addi	a5,a5,32
ffffffffc0204228:	ff1612e3          	bne	a2,a7,ffffffffc020420c <do_fork+0xf2>
    proc->tf->gpr.a0 = 0;
ffffffffc020422c:	0406b823          	sd	zero,80(a3) # ffffffffc0200050 <kern_init+0x6>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204230:	12098763          	beqz	s3,ffffffffc020435e <do_fork+0x244>
    if (++last_pid >= MAX_PID)
ffffffffc0204234:	000a2817          	auipc	a6,0xa2
ffffffffc0204238:	02c80813          	addi	a6,a6,44 # ffffffffc02a6260 <last_pid.1>
ffffffffc020423c:	00082783          	lw	a5,0(a6)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204240:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204244:	00000717          	auipc	a4,0x0
ffffffffc0204248:	d7070713          	addi	a4,a4,-656 # ffffffffc0203fb4 <forkret>
    if (++last_pid >= MAX_PID)
ffffffffc020424c:	0017851b          	addiw	a0,a5,1
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204250:	f898                	sd	a4,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204252:	fc94                	sd	a3,56(s1)
    if (++last_pid >= MAX_PID)
ffffffffc0204254:	00a82023          	sw	a0,0(a6)
ffffffffc0204258:	6789                	lui	a5,0x2
ffffffffc020425a:	08f55b63          	bge	a0,a5,ffffffffc02042f0 <do_fork+0x1d6>
    if (last_pid >= next_safe)
ffffffffc020425e:	000a2317          	auipc	t1,0xa2
ffffffffc0204262:	00630313          	addi	t1,t1,6 # ffffffffc02a6264 <next_safe.0>
ffffffffc0204266:	00032783          	lw	a5,0(t1)
ffffffffc020426a:	000a6417          	auipc	s0,0xa6
ffffffffc020426e:	41640413          	addi	s0,s0,1046 # ffffffffc02aa680 <proc_list>
ffffffffc0204272:	08f55763          	bge	a0,a5,ffffffffc0204300 <do_fork+0x1e6>
...
ffffffffc020427c:	0ba010ef          	jal	ra,ffffffffc0205336 <hash32>
ffffffffc0204280:	02051793          	slli	a5,a0,0x20
ffffffffc0204284:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204288:	000a2797          	auipc	a5,0xa2
ffffffffc020428c:	3f878793          	addi	a5,a5,1016 # ffffffffc02a6680 <hash_list>
...
ffffffffc02042ba:	c311                	beqz	a4,ffffffffc02042be <do_fork+0x1a4>
        proc->optr->yptr = proc;
...
ffffffffc02042c8:	00f92023          	sw	a5,0(s2)
    wakeup_proc(proc);
ffffffffc02042cc:	67f000ef          	jal	ra,ffffffffc020514a <wakeup_proc>
    ret = proc->pid;
...
ffffffffc02042fc:	f6c30313          	addi	t1,t1,-148 # ffffffffc02a6264 <next_safe.0>
    return listelm->next;
ffffffffc0204300:	000a6417          	auipc	s0,0xa6
ffffffffc0204304:	38040413          	addi	s0,s0,896 # ffffffffc02aa680 <proc_list>
...
ffffffffc0204318:	108e0d63          	beq	t3,s0,ffffffffc0204432 <do_fork+0x318>
ffffffffc020431c:	88ae                	mv	a7,a1
ffffffffc020431e:	87f2                	mv	a5,t3
ffffffffc0204320:	6609                	lui	a2,0x2
ffffffffc0204322:	a811                	j	ffffffffc0204336 <do_fork+0x21c>
            else if (proc->pid > last_pid && next_safe > proc->pid)
ffffffffc0204324:	00e6d663          	bge	a3,a4,ffffffffc0204330 <do_fork+0x216>
ffffffffc0204328:	00c75463          	bge	a4,a2,ffffffffc0204330 <do_fork+0x216>
ffffffffc020432c:	863a                	mv	a2,a4
ffffffffc020432e:	4885                	li	a7,1
ffffffffc0204330:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0204332:	00878d63          	beq	a5,s0,ffffffffc020434c <do_fork+0x232>
            if (proc->pid == last_pid)
ffffffffc0204336:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_faultread_out_size-0x7c6c>
ffffffffc020433a:	fed715e3          	bne	a4,a3,ffffffffc0204324 <do_fork+0x20a>
                if (++last_pid >= next_safe)
ffffffffc020433e:	2685                	addiw	a3,a3,1
ffffffffc0204340:	0ec6d463          	bge	a3,a2,ffffffffc0204428 <do_fork+0x30e>
ffffffffc0204344:	679c                	ld	a5,8(a5)
ffffffffc0204346:	4585                	li	a1,1
        while ((le = list_next(le)) != list)
ffffffffc0204348:	fe8797e3          	bne	a5,s0,ffffffffc0204336 <do_fork+0x21c>
ffffffffc020434c:	c581                	beqz	a1,ffffffffc0204354 <do_fork+0x23a>
ffffffffc020434e:	00d82023          	sw	a3,0(a6)
ffffffffc0204352:	8536                	mv	a0,a3
ffffffffc0204354:	f20881e3          	beqz	a7,ffffffffc0204276 <do_fork+0x15c>
ffffffffc0204358:	00c32023          	sw	a2,0(t1)
ffffffffc020435c:	bf29                	j	ffffffffc0204276 <do_fork+0x15c>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020435e:	89b6                	mv	s3,a3
ffffffffc0204360:	bdd1                	j	ffffffffc0204234 <do_fork+0x11a>
    if ((mm = mm_create()) == NULL)
ffffffffc0204362:	cceff0ef          	jal	ra,ffffffffc0203830 <mm_create>
ffffffffc0204366:	8caa                	mv	s9,a0
ffffffffc0204368:	c159                	beqz	a0,ffffffffc02043ee <do_fork+0x2d4>
    if ((page = alloc_page()) == NULL)
ffffffffc020436a:	4505                	li	a0,1
ffffffffc020436c:	c55fd0ef          	jal	ra,ffffffffc0201fc0 <alloc_pages>
ffffffffc0204370:	cd25                	beqz	a0,ffffffffc02043e8 <do_fork+0x2ce>
    return page - pages + nbase;
ffffffffc0204372:	000ab683          	ld	a3,0(s5)
ffffffffc0204376:	67a2                	ld	a5,8(sp)
    return KADDR(page2pa(page));
ffffffffc0204378:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc020437c:	40d506b3          	sub	a3,a0,a3
ffffffffc0204380:	8699                	srai	a3,a3,0x6
ffffffffc0204382:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204384:	01b6fdb3          	and	s11,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0204388:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc020438a:	0eedf663          	bgeu	s11,a4,ffffffffc0204476 <do_fork+0x35c>
ffffffffc020438e:	000c3a03          	ld	s4,0(s8)
    memcpy(pgdir, boot_pgdir_va, PGSIZE);
ffffffffc0204392:	6605                	lui	a2,0x1
ffffffffc0204394:	000a6597          	auipc	a1,0xa6
ffffffffc0204398:	3345b583          	ld	a1,820(a1) # ffffffffc02aa6c8 <boot_pgdir_va>
ffffffffc020439c:	9a36                	add	s4,s4,a3
ffffffffc020439e:	8552                	mv	a0,s4
ffffffffc02043a0:	44e010ef          	jal	ra,ffffffffc02057ee <memcpy>
static inline void
lock_mm(struct mm_struct *mm)
{
    ...
    {
        lock(&(mm->mm_lock));
ffffffffc02043a4:	038d0d93          	addi	s11,s10,56
    mm->pgdir = pgdir;
ffffffffc02043a8:	014cbc23          	sd	s4,24(s9)
...
ffffffffc02043ae:	40fdb7af          	amoor.d	a5,a5,(s11)
}
...
ffffffffc02043b6:	c799                	beqz	a5,ffffffffc02043c4 <do_fork+0x2aa>
    {
        schedule();
ffffffffc02043b8:	613000ef          	jal	ra,ffffffffc02051ca <schedule>
ffffffffc02043bc:	414db7af          	amoor.d	a5,s4,(s11)
    while (!try_lock(lock))
ffffffffc02043c0:	8b85                	andi	a5,a5,1
ffffffffc02043c2:	fbfd                	bnez	a5,ffffffffc02043b8 <do_fork+0x29e>
        ret = dup_mmap(mm, oldmm);
ffffffffc02043c4:	85ea                	mv	a1,s10
ffffffffc02043c6:	8566                	mv	a0,s9
ffffffffc02043c8:	eaaff0ef          	jal	ra,ffffffffc0203a72 <dup_mmap>
...
ffffffffc02043ce:	60fdb7af          	amoand.d	a5,a5,(s11)
...
ffffffffc02043d4:	cbad                	beqz	a5,ffffffffc0204446 <do_fork+0x32c>
good_mm:
ffffffffc02043d6:	8d66                	mv	s10,s9
    if (ret != 0)
ffffffffc02043d8:	de050fe3          	beqz	a0,ffffffffc02041d6 <do_fork+0xbc>
    exit_mmap(mm);
ffffffffc02043dc:	8566                	mv	a0,s9
ffffffffc02043de:	f2eff0ef          	jal	ra,ffffffffc0203b0c <exit_mmap>
    put_pgdir(mm);
ffffffffc02043e2:	8566                	mv	a0,s9
ffffffffc02043e4:	c5dff0ef          	jal	ra,ffffffffc0204040 <put_pgdir>
    mm_destroy(mm);
ffffffffc02043e8:	8566                	mv	a0,s9
ffffffffc02043ea:	d86ff0ef          	jal	ra,ffffffffc0203970 <mm_destroy>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02043ee:	6894                	ld	a3,16(s1)
    return pa2page(PADDR(kva));
ffffffffc02043f0:	c02007b7          	lui	a5,0xc0200
ffffffffc02043f4:	0af6ea63          	bltu	a3,a5,ffffffffc02044a8 <do_fork+0x38e>
...
ffffffffc0204406:	04e7fc63          	bgeu	a5,a4,ffffffffc020445e <do_fork+0x344>
    return &pages[PPN(pa) - nbase];
ffffffffc020440a:	000b3703          	ld	a4,0(s6)
ffffffffc020440e:	000ab503          	ld	a0,0(s5)
ffffffffc0204412:	4589                	li	a1,2
ffffffffc0204414:	8f99                	sub	a5,a5,a4
ffffffffc0204416:	079a                	slli	a5,a5,0x6
ffffffffc0204418:	953e                	add	a0,a0,a5
ffffffffc020441a:	be5fd0ef          	jal	ra,ffffffffc0201ffe <free_pages>
    kfree(proc);
ffffffffc020441e:	8526                	mv	a0,s1
ffffffffc0204420:	a73fd0ef          	jal	ra,ffffffffc0201e92 <kfree>
    ret = -E_NO_MEM;
ffffffffc0204424:	5571                	li	a0,-4
    return ret;
ffffffffc0204426:	b575                	j	ffffffffc02042d2 <do_fork+0x1b8>
                    if (last_pid >= MAX_PID)
ffffffffc0204428:	01d6c363          	blt	a3,t4,ffffffffc020442e <do_fork+0x314>
                        last_pid = 1;
ffffffffc020442c:	4685                	li	a3,1
                    goto repeat;
ffffffffc020442e:	4585                	li	a1,1
ffffffffc0204430:	b5e5                	j	ffffffffc0204318 <do_fork+0x1fe>
ffffffffc0204432:	c599                	beqz	a1,ffffffffc0204440 <do_fork+0x326>
ffffffffc0204434:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc0204438:	8536                	mv	a0,a3
ffffffffc020443a:	bd35                	j	ffffffffc0204276 <do_fork+0x15c>
    int ret = -E_NO_FREE_PROC;
ffffffffc020443c:	556d                	li	a0,-5
ffffffffc020443e:	bd51                	j	ffffffffc02042d2 <do_fork+0x1b8>
    return last_pid;
ffffffffc0204440:	00082503          	lw	a0,0(a6)
ffffffffc0204444:	bd0d                	j	ffffffffc0204276 <do_fork+0x15c>
    {
        panic("Unlock failed.\n");
ffffffffc0204446:	00003617          	auipc	a2,0x3
ffffffffc020444a:	c6260613          	addi	a2,a2,-926 # ffffffffc02070a8 <default_pmm_manager+0xa30>
ffffffffc020444e:	03f00593          	li	a1,63
ffffffffc0204452:	00003517          	auipc	a0,0x3
ffffffffc0204456:	c6650513          	addi	a0,a0,-922 # ffffffffc02070b8 <default_pmm_manager+0xa40>
ffffffffc020445a:	834fc0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("pa2page called with invalid pa");
ffffffffc020445e:	00002617          	auipc	a2,0x2
ffffffffc0204462:	2ea60613          	addi	a2,a2,746 # ffffffffc0206748 <default_pmm_manager+0xd0>
ffffffffc0204466:	06900593          	li	a1,105
ffffffffc020446a:	00002517          	auipc	a0,0x2
ffffffffc020446e:	dde50513          	addi	a0,a0,-546 # ffffffffc0206248 <commands+0x7d8>
ffffffffc0204472:	81cfc0ef          	jal	ra,ffffffffc020048e <__panic>
    return KADDR(page2pa(page));
ffffffffc0204476:	00002617          	auipc	a2,0x2
ffffffffc020447a:	daa60613          	addi	a2,a2,-598 # ffffffffc0206220 <commands+0x7b0>
ffffffffc020447e:	07100593          	li	a1,113
ffffffffc0204482:	00002517          	auipc	a0,0x2
ffffffffc0204486:	dc650513          	addi	a0,a0,-570 # ffffffffc0206248 <commands+0x7d8>
ffffffffc020448a:	804fc0ef          	jal	ra,ffffffffc020048e <__panic>
    proc->pgdir = PADDR(mm->pgdir);
ffffffffc020448e:	86be                	mv	a3,a5
ffffffffc0204490:	00002617          	auipc	a2,0x2
ffffffffc0204494:	29060613          	addi	a2,a2,656 # ffffffffc0206720 <default_pmm_manager+0xa8>
ffffffffc0204498:	18b00593          	li	a1,395
ffffffffc020449c:	00003517          	auipc	a0,0x3
ffffffffc02044a0:	bf450513          	addi	a0,a0,-1036 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc02044a4:	febfb0ef          	jal	ra,ffffffffc020048e <__panic>
    return pa2page(PADDR(kva));
ffffffffc02044a8:	00002617          	auipc	a2,0x2
ffffffffc02044ac:	27860613          	addi	a2,a2,632 # ffffffffc0206720 <default_pmm_manager+0xa8>
ffffffffc02044b0:	07700593          	li	a1,119
ffffffffc02044b4:	00002517          	auipc	a0,0x2
ffffffffc02044b8:	d9450513          	addi	a0,a0,-620 # ffffffffc0206248 <commands+0x7d8>
ffffffffc02044bc:	fd3fb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc02044c0 <kernel_thread>:
{
ffffffffc02044c0:	7129                	addi	sp,sp,-320
ffffffffc02044c2:	fa22                	sd	s0,304(sp)
ffffffffc02044c4:	f626                	sd	s1,296(sp)
ffffffffc02044c6:	f24a                	sd	s2,288(sp)
ffffffffc02044c8:	84ae                	mv	s1,a1
ffffffffc02044ca:	892a                	mv	s2,a0
ffffffffc02044cc:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02044ce:	4581                	li	a1,0
ffffffffc02044d0:	12000613          	li	a2,288
ffffffffc02044d4:	850a                	mv	a0,sp
{
ffffffffc02044d6:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02044d8:	304010ef          	jal	ra,ffffffffc02057dc <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02044dc:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02044de:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02044e0:	100027f3          	csrr	a5,sstatus
ffffffffc02044e4:	edd7f793          	andi	a5,a5,-291
ffffffffc02044e8:	1207e793          	ori	a5,a5,288
ffffffffc02044ec:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02044ee:	860a                	mv	a2,sp
ffffffffc02044f0:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02044f4:	00000797          	auipc	a5,0x0
ffffffffc02044f8:	a4678793          	addi	a5,a5,-1466 # ffffffffc0203f3a <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02044fc:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02044fe:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204500:	c1bff0ef          	jal	ra,ffffffffc020411a <do_fork>
}
ffffffffc0204504:	70f2                	ld	ra,312(sp)
ffffffffc0204506:	7452                	ld	s0,304(sp)
ffffffffc0204508:	74b2                	ld	s1,296(sp)
ffffffffc020450a:	7912                	ld	s2,288(sp)
ffffffffc020450c:	6131                	addi	sp,sp,320
ffffffffc020450e:	8082                	ret

ffffffffc0204510 <do_exit>:
{
ffffffffc0204510:	7179                	addi	sp,sp,-48
ffffffffc0204512:	f022                	sd	s0,32(sp)
    if (current == idleproc)
ffffffffc0204514:	000a6417          	auipc	s0,0xa6
ffffffffc0204518:	1dc40413          	addi	s0,s0,476 # ffffffffc02aa6f0 <current>
ffffffffc020451c:	601c                	ld	a5,0(s0)
{
ffffffffc020451e:	f406                	sd	ra,40(sp)
ffffffffc0204520:	ec26                	sd	s1,24(sp)
ffffffffc0204522:	e84a                	sd	s2,16(sp)
ffffffffc0204524:	e44e                	sd	s3,8(sp)
ffffffffc0204526:	e052                	sd	s4,0(sp)
    if (current == idleproc)
ffffffffc0204528:	000a6717          	auipc	a4,0xa6
ffffffffc020452c:	1d073703          	ld	a4,464(a4) # ffffffffc02aa6f8 <idleproc>
ffffffffc0204530:	0ce78c63          	beq	a5,a4,ffffffffc0204608 <do_exit+0xf8>
    if (current == initproc)
ffffffffc0204534:	000a6497          	auipc	s1,0xa6
ffffffffc0204538:	1cc48493          	addi	s1,s1,460 # ffffffffc02aa700 <initproc>
ffffffffc020453c:	6098                	ld	a4,0(s1)
ffffffffc020453e:	0ee78b63          	beq	a5,a4,ffffffffc0204634 <do_exit+0x124>
    struct mm_struct *mm = current->mm;
ffffffffc0204542:	0287b983          	ld	s3,40(a5)
ffffffffc0204546:	892a                	mv	s2,a0
    if (mm != NULL)
ffffffffc0204548:	02098663          	beqz	s3,ffffffffc0204574 <do_exit+0x64>
ffffffffc020454c:	000a6797          	auipc	a5,0xa6
ffffffffc0204550:	1747b783          	ld	a5,372(a5) # ffffffffc02aa6c0 <boot_pgdir_pa>
ffffffffc0204554:	577d                	li	a4,-1
ffffffffc0204556:	177e                	slli	a4,a4,0x3f
ffffffffc0204558:	83b1                	srli	a5,a5,0xc
ffffffffc020455a:	8fd9                	or	a5,a5,a4
ffffffffc020455c:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc0204560:	0309a783          	lw	a5,48(s3)
ffffffffc0204564:	fff7871b          	addiw	a4,a5,-1
ffffffffc0204568:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0)
ffffffffc020456c:	cb55                	beqz	a4,ffffffffc0204620 <do_exit+0x110>
        current->mm = NULL;
ffffffffc020456e:	601c                	ld	a5,0(s0)
ffffffffc0204570:	0207b423          	sd	zero,40(a5)
    current->state = PROC_ZOMBIE;
ffffffffc0204574:	601c                	ld	a5,0(s0)
ffffffffc0204576:	470d                	li	a4,3
ffffffffc0204578:	c398                	sw	a4,0(a5)
...
ffffffffc0204582:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204584:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0204586:	e3f9                	bnez	a5,ffffffffc020464c <do_exit+0x13c>
        proc = current->parent;
ffffffffc0204588:	6018                	ld	a4,0(s0)
        if (proc->wait_state == WT_CHILD)
ffffffffc020458a:	800007b7          	lui	a5,0x80000
ffffffffc020458e:	0785                	addi	a5,a5,1
        proc = current->parent;
ffffffffc0204590:	7308                	ld	a0,32(a4)
        if (proc->wait_state == WT_CHILD)
ffffffffc0204592:	0ec52703          	lw	a4,236(a0)
ffffffffc0204596:	0af70f63          	beq	a4,a5,ffffffffc0204654 <do_exit+0x144>
        while (current->cptr != NULL)
ffffffffc020459a:	6018                	ld	a4,0(s0)
ffffffffc020459c:	7b7c                	ld	a5,240(a4)
ffffffffc020459e:	c3a1                	beqz	a5,ffffffffc02045de <do_exit+0xce>
                if (initproc->wait_state == WT_CHILD)
ffffffffc02045a0:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE)
ffffffffc02045a4:	490d                	li	s2,3
                if (initproc->wait_state == WT_CHILD)
ffffffffc02045a6:	0985                	addi	s3,s3,1
ffffffffc02045a8:	a021                	j	ffffffffc02045b0 <do_exit+0xa0>
        while (current->cptr != NULL)
ffffffffc02045aa:	6018                	ld	a4,0(s0)
ffffffffc02045ac:	7b7c                	ld	a5,240(a4)
ffffffffc02045ae:	cb85                	beqz	a5,ffffffffc02045de <do_exit+0xce>
            current->cptr = proc->optr;
ffffffffc02045b0:	1007b683          	ld	a3,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff4fe0>
            if ((proc->optr = initproc->cptr) != NULL)
ffffffffc02045b4:	6088                	ld	a0,0(s1)
            current->cptr = proc->optr;
ffffffffc02045b6:	fb74                	sd	a3,240(a4)
            if ((proc->optr = initproc->cptr) != NULL)
ffffffffc02045b8:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc02045ba:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL)
ffffffffc02045be:	10e7b023          	sd	a4,256(a5)
ffffffffc02045c2:	c311                	beqz	a4,ffffffffc02045c6 <do_exit+0xb6>
                initproc->cptr->yptr = proc;
ffffffffc02045c4:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE)
ffffffffc02045c6:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc02045c8:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc02045ca:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE)
ffffffffc02045cc:	fd271fe3          	bne	a4,s2,ffffffffc02045aa <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD)
ffffffffc02045d0:	0ec52783          	lw	a5,236(a0)
ffffffffc02045d4:	fd379be3          	bne	a5,s3,ffffffffc02045aa <do_exit+0x9a>
                    wakeup_proc(initproc);
ffffffffc02045d8:	373000ef          	jal	ra,ffffffffc020514a <wakeup_proc>
ffffffffc02045dc:	b7f9                	j	ffffffffc02045aa <do_exit+0x9a>
    if (flag)
ffffffffc02045de:	020a1263          	bnez	s4,ffffffffc0204602 <do_exit+0xf2>
    schedule();
ffffffffc02045e2:	3e9000ef          	jal	ra,ffffffffc02051ca <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc02045e6:	601c                	ld	a5,0(s0)
ffffffffc02045e8:	00003617          	auipc	a2,0x3
ffffffffc02045ec:	b0860613          	addi	a2,a2,-1272 # ffffffffc02070f0 <default_pmm_manager+0xa78>
ffffffffc02045f0:	23300593          	li	a1,563
ffffffffc02045f4:	43d4                	lw	a3,4(a5)
ffffffffc02045f6:	00003517          	auipc	a0,0x3
ffffffffc02045fa:	a9a50513          	addi	a0,a0,-1382 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc02045fe:	e91fb0ef          	jal	ra,ffffffffc020048e <__panic>
        intr_enable();
ffffffffc0204602:	bacfc0ef          	jal	ra,ffffffffc02009ae <intr_enable>
ffffffffc0204606:	bff1                	j	ffffffffc02045e2 <do_exit+0xd2>
        panic("idleproc exit.\n");
ffffffffc0204608:	00003617          	auipc	a2,0x3
ffffffffc020460c:	ac860613          	addi	a2,a2,-1336 # ffffffffc02070d0 <default_pmm_manager+0xa58>
ffffffffc0204610:	1ff00593          	li	a1,511
ffffffffc0204614:	00003517          	auipc	a0,0x3
ffffffffc0204618:	a7c50513          	addi	a0,a0,-1412 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc020461c:	e73fb0ef          	jal	ra,ffffffffc020048e <__panic>
            exit_mmap(mm);
ffffffffc0204620:	854e                	mv	a0,s3
ffffffffc0204622:	ceaff0ef          	jal	ra,ffffffffc0203b0c <exit_mmap>
            put_pgdir(mm);
ffffffffc0204626:	854e                	mv	a0,s3
ffffffffc0204628:	a19ff0ef          	jal	ra,ffffffffc0204040 <put_pgdir>
            mm_destroy(mm);
ffffffffc020462c:	854e                	mv	a0,s3
ffffffffc020462e:	b42ff0ef          	jal	ra,ffffffffc0203970 <mm_destroy>
ffffffffc0204632:	bf35                	j	ffffffffc020456e <do_exit+0x5e>
        panic("initproc exit.\n");
ffffffffc0204634:	00003617          	auipc	a2,0x3
ffffffffc0204638:	aac60613          	addi	a2,a2,-1364 # ffffffffc02070e0 <default_pmm_manager+0xa68>
ffffffffc020463c:	20300593          	li	a1,515
ffffffffc0204640:	00003517          	auipc	a0,0x3
ffffffffc0204644:	a5050513          	addi	a0,a0,-1456 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc0204648:	e47fb0ef          	jal	ra,ffffffffc020048e <__panic>
        intr_disable();
ffffffffc020464c:	b68fc0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
        return 1;
ffffffffc0204650:	4a05                	li	s4,1
ffffffffc0204652:	bf1d                	j	ffffffffc0204588 <do_exit+0x78>
            wakeup_proc(proc);
ffffffffc0204654:	2f7000ef          	jal	ra,ffffffffc020514a <wakeup_proc>
ffffffffc0204658:	b789                	j	ffffffffc020459a <do_exit+0x8a>

ffffffffc020465a <do_wait.part.0>:
int do_wait(int pid, int *code_store)
ffffffffc020465a:	715d                	addi	sp,sp,-80
ffffffffc020465c:	f84a                	sd	s2,48(sp)
ffffffffc020465e:	f44e                	sd	s3,40(sp)
        current->wait_state = WT_CHILD;
ffffffffc0204660:	80000937          	lui	s2,0x80000
    if (0 < pid && pid < MAX_PID)
ffffffffc0204664:	6989                	lui	s3,0x2
int do_wait(int pid, int *code_store)
ffffffffc0204666:	fc26                	sd	s1,56(sp)
ffffffffc0204668:	f052                	sd	s4,32(sp)
ffffffffc020466a:	ec56                	sd	s5,24(sp)
ffffffffc020466c:	e85a                	sd	s6,16(sp)
ffffffffc020466e:	e45e                	sd	s7,8(sp)
ffffffffc0204670:	e486                	sd	ra,72(sp)
ffffffffc0204672:	e0a2                	sd	s0,64(sp)
ffffffffc0204674:	84aa                	mv	s1,a0
ffffffffc0204676:	8a2e                	mv	s4,a1
        proc = current->cptr;
ffffffffc0204678:	000a6b97          	auipc	s7,0xa6
ffffffffc020467c:	078b8b93          	addi	s7,s7,120 # ffffffffc02aa6f0 <current>
    if (0 < pid && pid < MAX_PID)
ffffffffc0204680:	00050b1b          	sext.w	s6,a0
ffffffffc0204684:	fff50a9b          	addiw	s5,a0,-1
ffffffffc0204688:	19f9                	addi	s3,s3,-2
        current->wait_state = WT_CHILD;
ffffffffc020468a:	0905                	addi	s2,s2,1
    if (pid != 0)
ffffffffc020468c:	ccbd                	beqz	s1,ffffffffc020470a <do_wait.part.0+0xb0>
    if (0 < pid && pid < MAX_PID)
ffffffffc020468e:	0359e863          	bltu	s3,s5,ffffffffc02046be <do_wait.part.0+0x64>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204692:	45a9                	li	a1,10
ffffffffc0204694:	855a                	mv	a0,s6
ffffffffc0204696:	4a1000ef          	jal	ra,ffffffffc0205336 <hash32>
ffffffffc020469a:	02051793          	slli	a5,a0,0x20
ffffffffc020469e:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02046a2:	000a2797          	auipc	a5,0xa2
ffffffffc02046a6:	fde78793          	addi	a5,a5,-34 # ffffffffc02a6680 <hash_list>
ffffffffc02046aa:	953e                	add	a0,a0,a5
ffffffffc02046ac:	842a                	mv	s0,a0
        while ((le = list_next(le)) != list)
ffffffffc02046ae:	a029                	j	ffffffffc02046b8 <do_wait.part.0+0x5e>
            if (proc->pid == pid)
ffffffffc02046b0:	f2c42783          	lw	a5,-212(s0)
ffffffffc02046b4:	02978163          	beq	a5,s1,ffffffffc02046d6 <do_wait.part.0+0x7c>
ffffffffc02046b8:	6400                	ld	s0,8(s0)
        while ((le = list_next(le)) != list)
ffffffffc02046ba:	fe851be3          	bne	a0,s0,ffffffffc02046b0 <do_wait.part.0+0x56>
    return -E_BAD_PROC;
ffffffffc02046be:	5579                	li	a0,-2
}
ffffffffc02046c0:	60a6                	ld	ra,72(sp)
ffffffffc02046c2:	6406                	ld	s0,64(sp)
ffffffffc02046c4:	74e2                	ld	s1,56(sp)
ffffffffc02046c6:	7942                	ld	s2,48(sp)
ffffffffc02046c8:	79a2                	ld	s3,40(sp)
ffffffffc02046ca:	7a02                	ld	s4,32(sp)
ffffffffc02046cc:	6ae2                	ld	s5,24(sp)
ffffffffc02046ce:	6b42                	ld	s6,16(sp)
ffffffffc02046d0:	6ba2                	ld	s7,8(sp)
ffffffffc02046d2:	6161                	addi	sp,sp,80
ffffffffc02046d4:	8082                	ret
        if (proc != NULL && proc->parent == current)
ffffffffc02046d6:	000bb683          	ld	a3,0(s7)
ffffffffc02046da:	f4843783          	ld	a5,-184(s0)
ffffffffc02046de:	fed790e3          	bne	a5,a3,ffffffffc02046be <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE)
ffffffffc02046e2:	f2842703          	lw	a4,-216(s0)
ffffffffc02046e6:	478d                	li	a5,3
ffffffffc02046e8:	0ef70b63          	beq	a4,a5,ffffffffc02047de <do_wait.part.0+0x184>
        current->state = PROC_SLEEPING;
ffffffffc02046ec:	4785                	li	a5,1
ffffffffc02046ee:	c29c                	sw	a5,0(a3)
        current->wait_state = WT_CHILD;
ffffffffc02046f0:	0f26a623          	sw	s2,236(a3)
        schedule();
ffffffffc02046f4:	2d7000ef          	jal	ra,ffffffffc02051ca <schedule>
        if (current->flags & PF_EXITING)
ffffffffc02046f8:	000bb783          	ld	a5,0(s7)
ffffffffc02046fc:	0b07a783          	lw	a5,176(a5)
ffffffffc0204700:	8b85                	andi	a5,a5,1
ffffffffc0204702:	d7c9                	beqz	a5,ffffffffc020468c <do_wait.part.0+0x32>
            do_exit(-E_KILLED);
ffffffffc0204704:	555d                	li	a0,-9
ffffffffc0204706:	e0bff0ef          	jal	ra,ffffffffc0204510 <do_exit>
        proc = current->cptr;
ffffffffc020470a:	000bb683          	ld	a3,0(s7)
ffffffffc020470e:	7ae0                	ld	s0,240(a3)
        for (; proc != NULL; proc = proc->optr)
ffffffffc0204710:	d45d                	beqz	s0,ffffffffc02046be <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE)
ffffffffc0204712:	470d                	li	a4,3
ffffffffc0204714:	a021                	j	ffffffffc020471c <do_wait.part.0+0xc2>
        for (; proc != NULL; proc = proc->optr)
ffffffffc0204716:	10043403          	ld	s0,256(s0)
ffffffffc020471a:	d869                	beqz	s0,ffffffffc02046ec <do_wait.part.0+0x92>
            if (proc->state == PROC_ZOMBIE)
ffffffffc020471c:	401c                	lw	a5,0(s0)
ffffffffc020471e:	fee79ce3          	bne	a5,a4,ffffffffc0204716 <do_wait.part.0+0xbc>
    if (proc == idleproc || proc == initproc)
ffffffffc0204722:	000a6797          	auipc	a5,0xa6
ffffffffc0204726:	fd67b783          	ld	a5,-42(a5) # ffffffffc02aa6f8 <idleproc>
ffffffffc020472a:	0c878963          	beq	a5,s0,ffffffffc02047fc <do_wait.part.0+0x1a2>
ffffffffc020472e:	000a6797          	auipc	a5,0xa6
ffffffffc0204732:	fd27b783          	ld	a5,-46(a5) # ffffffffc02aa700 <initproc>
ffffffffc0204736:	0cf40363          	beq	s0,a5,ffffffffc02047fc <do_wait.part.0+0x1a2>
    if (code_store != NULL)
ffffffffc020473a:	000a0663          	beqz	s4,ffffffffc0204746 <do_wait.part.0+0xec>
        *code_store = proc->exit_code;
ffffffffc020473e:	0e842783          	lw	a5,232(s0)
ffffffffc0204742:	00fa2023          	sw	a5,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8ba8>
    if (read_csr(sstatus) & SSTATUS_SIE)
...
ffffffffc020474c:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc020474e:	e7c1                	bnez	a5,ffffffffc02047d6 <do_wait.part.0+0x17c>
    __list_del(listelm->prev, listelm->next);
ffffffffc0204750:	6c70                	ld	a2,216(s0)
ffffffffc0204752:	7074                	ld	a3,224(s0)
    if (proc->optr != NULL)
ffffffffc0204754:	10043703          	ld	a4,256(s0)
        proc->optr->yptr = proc->yptr;
ffffffffc0204758:	7c7c                	ld	a5,248(s0)
    prev->next = next;
ffffffffc020475a:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc020475c:	e290                	sd	a2,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc020475e:	6470                	ld	a2,200(s0)
ffffffffc0204760:	6874                	ld	a3,208(s0)
    prev->next = next;
ffffffffc0204762:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc0204764:	e290                	sd	a2,0(a3)
    if (proc->optr != NULL)
ffffffffc0204766:	c319                	beqz	a4,ffffffffc020476c <do_wait.part.0+0x112>
        proc->optr->yptr = proc->yptr;
ffffffffc0204768:	ff7c                	sd	a5,248(a4)
    if (proc->yptr != NULL)
ffffffffc020476a:	7c7c                	ld	a5,248(s0)
ffffffffc020476c:	c3b5                	beqz	a5,ffffffffc02047d0 <do_wait.part.0+0x176>
        proc->yptr->optr = proc->optr;
ffffffffc020476e:	10e7b023          	sd	a4,256(a5)
    nr_process--;
ffffffffc0204772:	000a6717          	auipc	a4,0xa6
ffffffffc0204776:	f9670713          	addi	a4,a4,-106 # ffffffffc02aa708 <nr_process>
ffffffffc020477a:	431c                	lw	a5,0(a4)
ffffffffc020477c:	37fd                	addiw	a5,a5,-1
ffffffffc020477e:	c31c                	sw	a5,0(a4)
    if (flag)
ffffffffc0204780:	e5a9                	bnez	a1,ffffffffc02047ca <do_wait.part.0+0x170>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0204782:	6814                	ld	a3,16(s0)
ffffffffc0204784:	c02007b7          	lui	a5,0xc0200
ffffffffc0204788:	04f6ee63          	bltu	a3,a5,ffffffffc02047e4 <do_wait.part.0+0x18a>
ffffffffc020478c:	000a6797          	auipc	a5,0xa6
ffffffffc0204790:	f5c7b783          	ld	a5,-164(a5) # ffffffffc02aa6e8 <va_pa_offset>
ffffffffc0204794:	8e9d                	sub	a3,a3,a5
    if (PPN(pa) >= npage)
ffffffffc0204796:	82b1                	srli	a3,a3,0xc
ffffffffc0204798:	000a6797          	auipc	a5,0xa6
ffffffffc020479c:	f387b783          	ld	a5,-200(a5) # ffffffffc02aa6d0 <npage>
ffffffffc02047a0:	06f6fa63          	bgeu	a3,a5,ffffffffc0204814 <do_wait.part.0+0x1ba>
    return &pages[PPN(pa) - nbase];
ffffffffc02047a4:	00003517          	auipc	a0,0x3
ffffffffc02047a8:	18453503          	ld	a0,388(a0) # ffffffffc0207928 <nbase>
ffffffffc02047ac:	8e89                	sub	a3,a3,a0
ffffffffc02047ae:	069a                	slli	a3,a3,0x6
ffffffffc02047b0:	000a6517          	auipc	a0,0xa6
ffffffffc02047b4:	f2853503          	ld	a0,-216(a0) # ffffffffc02aa6d8 <pages>
ffffffffc02047b8:	9536                	add	a0,a0,a3
ffffffffc02047ba:	4589                	li	a1,2
ffffffffc02047bc:	843fd0ef          	jal	ra,ffffffffc0201ffe <free_pages>
    kfree(proc);
ffffffffc02047c0:	8522                	mv	a0,s0
ffffffffc02047c2:	ed0fd0ef          	jal	ra,ffffffffc0201e92 <kfree>
    return 0;
ffffffffc02047c6:	4501                	li	a0,0
ffffffffc02047c8:	bde5                	j	ffffffffc02046c0 <do_wait.part.0+0x66>
        intr_enable();
ffffffffc02047ca:	9e4fc0ef          	jal	ra,ffffffffc02009ae <intr_enable>
ffffffffc02047ce:	bf55                	j	ffffffffc0204782 <do_wait.part.0+0x128>
        proc->parent->cptr = proc->optr;
ffffffffc02047d0:	701c                	ld	a5,32(s0)
ffffffffc02047d2:	fbf8                	sd	a4,240(a5)
ffffffffc02047d4:	bf79                	j	ffffffffc0204772 <do_wait.part.0+0x118>
        intr_disable();
ffffffffc02047d6:	9defc0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
        return 1;
ffffffffc02047da:	4585                	li	a1,1
ffffffffc02047dc:	bf95                	j	ffffffffc0204750 <do_wait.part.0+0xf6>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02047de:	f2840413          	addi	s0,s0,-216
ffffffffc02047e2:	b781                	j	ffffffffc0204722 <do_wait.part.0+0xc8>
    return pa2page(PADDR(kva));
ffffffffc02047e4:	00002617          	auipc	a2,0x2
ffffffffc02047e8:	f3c60613          	addi	a2,a2,-196 # ffffffffc0206720 <default_pmm_manager+0xa8>
ffffffffc02047ec:	07700593          	li	a1,119
ffffffffc02047f0:	00002517          	auipc	a0,0x2
ffffffffc02047f4:	a5850513          	addi	a0,a0,-1448 # ffffffffc0206248 <commands+0x7d8>
ffffffffc02047f8:	c97fb0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("wait idleproc or initproc.\n");
ffffffffc02047fc:	00003617          	auipc	a2,0x3
ffffffffc0204800:	91460613          	addi	a2,a2,-1772 # ffffffffc0207110 <default_pmm_manager+0xa98>
ffffffffc0204804:	35300593          	li	a1,851
ffffffffc0204808:	00003517          	auipc	a0,0x3
ffffffffc020480c:	88850513          	addi	a0,a0,-1912 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc0204810:	c7ffb0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204814:	00002617          	auipc	a2,0x2
ffffffffc0204818:	f3460613          	addi	a2,a2,-204 # ffffffffc0206748 <default_pmm_manager+0xd0>
ffffffffc020481c:	06900593          	li	a1,105
ffffffffc0204820:	00002517          	auipc	a0,0x2
ffffffffc0204824:	a2850513          	addi	a0,a0,-1496 # ffffffffc0206248 <commands+0x7d8>
ffffffffc0204828:	c67fb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc020482c <init_main>:
}
...
ffffffffc0204830:	80ffd0ef          	jal	ra,ffffffffc020203e <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc0204834:	daafd0ef          	jal	ra,ffffffffc0201dde <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc0204838:	4601                	li	a2,0
ffffffffc020483a:	4581                	li	a1,0
ffffffffc020483c:	fffff517          	auipc	a0,0xfffff
ffffffffc0204840:	78650513          	addi	a0,a0,1926 # ffffffffc0203fc2 <user_main>
ffffffffc0204844:	c7dff0ef          	jal	ra,ffffffffc02044c0 <kernel_thread>
    if (pid <= 0)
ffffffffc0204848:	00a04563          	bgtz	a0,ffffffffc0204852 <init_main+0x26>
ffffffffc020484c:	a071                	j	ffffffffc02048d8 <init_main+0xac>
    ...
    {
        schedule();
ffffffffc020484e:	17d000ef          	jal	ra,ffffffffc02051ca <schedule>
    if (code_store != NULL)
ffffffffc0204852:	4581                	li	a1,0
ffffffffc0204854:	4501                	li	a0,0
ffffffffc0204856:	e05ff0ef          	jal	ra,ffffffffc020465a <do_wait.part.0>
    while (do_wait(0, NULL) == 0)
ffffffffc020485a:	d975                	beqz	a0,ffffffffc020484e <init_main+0x22>
    }

    cprintf("all user-mode processes have quit.\n");
ffffffffc020485c:	00003517          	auipc	a0,0x3
ffffffffc0204860:	8f450513          	addi	a0,a0,-1804 # ffffffffc0207150 <default_pmm_manager+0xad8>
ffffffffc0204864:	931fb0ef          	jal	ra,ffffffffc0200194 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc0204868:	000a6797          	auipc	a5,0xa6
ffffffffc020486c:	e987b783          	ld	a5,-360(a5) # ffffffffc02aa700 <initproc>
ffffffffc0204870:	7bf8                	ld	a4,240(a5)
ffffffffc0204872:	e339                	bnez	a4,ffffffffc02048b8 <init_main+0x8c>
ffffffffc0204874:	7ff8                	ld	a4,248(a5)
ffffffffc0204876:	e329                	bnez	a4,ffffffffc02048b8 <init_main+0x8c>
ffffffffc0204878:	1007b703          	ld	a4,256(a5)
ffffffffc020487c:	ef15                	bnez	a4,ffffffffc02048b8 <init_main+0x8c>
    assert(nr_process == 2);
ffffffffc020487e:	000a6697          	auipc	a3,0xa6
ffffffffc0204882:	e8a6a683          	lw	a3,-374(a3) # ffffffffc02aa708 <nr_process>
ffffffffc0204886:	4709                	li	a4,2
ffffffffc0204888:	0ae69463          	bne	a3,a4,ffffffffc0204930 <init_main+0x104>
    return listelm->next;
ffffffffc020488c:	000a6697          	auipc	a3,0xa6
ffffffffc0204890:	df468693          	addi	a3,a3,-524 # ffffffffc02aa680 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc0204894:	6698                	ld	a4,8(a3)
ffffffffc0204896:	0c878793          	addi	a5,a5,200
ffffffffc020489a:	06f71b63          	bne	a4,a5,ffffffffc0204910 <init_main+0xe4>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc020489e:	629c                	ld	a5,0(a3)
ffffffffc02048a0:	04f71863          	bne	a4,a5,ffffffffc02048f0 <init_main+0xc4>

    cprintf("init check memory pass.\n");
ffffffffc02048a4:	00003517          	auipc	a0,0x3
ffffffffc02048a8:	99450513          	addi	a0,a0,-1644 # ffffffffc0207238 <default_pmm_manager+0xbc0>
ffffffffc02048ac:	8e9fb0ef          	jal	ra,ffffffffc0200194 <cprintf>
    return 0;
}
ffffffffc02048b0:	60a2                	ld	ra,8(sp)
ffffffffc02048b2:	4501                	li	a0,0
ffffffffc02048b4:	0141                	addi	sp,sp,16
ffffffffc02048b6:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc02048b8:	00003697          	auipc	a3,0x3
ffffffffc02048bc:	8c068693          	addi	a3,a3,-1856 # ffffffffc0207178 <default_pmm_manager+0xb00>
ffffffffc02048c0:	00002617          	auipc	a2,0x2
ffffffffc02048c4:	a0860613          	addi	a2,a2,-1528 # ffffffffc02062c8 <commands+0x858>
ffffffffc02048c8:	3c100593          	li	a1,961
ffffffffc02048cc:	00002517          	auipc	a0,0x2
ffffffffc02048d0:	7c450513          	addi	a0,a0,1988 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc02048d4:	bbbfb0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("create user_main failed.\n");
ffffffffc02048d8:	00003617          	auipc	a2,0x3
ffffffffc02048dc:	85860613          	addi	a2,a2,-1960 # ffffffffc0207130 <default_pmm_manager+0xab8>
ffffffffc02048e0:	3b800593          	li	a1,952
ffffffffc02048e4:	00002517          	auipc	a0,0x2
ffffffffc02048e8:	7ac50513          	addi	a0,a0,1964 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc02048ec:	ba3fb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02048f0:	00003697          	auipc	a3,0x3
ffffffffc02048f4:	91868693          	addi	a3,a3,-1768 # ffffffffc0207208 <default_pmm_manager+0xb90>
ffffffffc02048f8:	00002617          	auipc	a2,0x2
ffffffffc02048fc:	9d060613          	addi	a2,a2,-1584 # ffffffffc02062c8 <commands+0x858>
ffffffffc0204900:	3c400593          	li	a1,964
ffffffffc0204904:	00002517          	auipc	a0,0x2
ffffffffc0204908:	78c50513          	addi	a0,a0,1932 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc020490c:	b83fb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc0204910:	00003697          	auipc	a3,0x3
ffffffffc0204914:	8c868693          	addi	a3,a3,-1848 # ffffffffc02071d8 <default_pmm_manager+0xb60>
ffffffffc0204918:	00002617          	auipc	a2,0x2
ffffffffc020491c:	9b060613          	addi	a2,a2,-1616 # ffffffffc02062c8 <commands+0x858>
ffffffffc0204920:	3c300593          	li	a1,963
ffffffffc0204924:	00002517          	auipc	a0,0x2
ffffffffc0204928:	76c50513          	addi	a0,a0,1900 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc020492c:	b63fb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(nr_process == 2);
ffffffffc0204930:	00003697          	auipc	a3,0x3
ffffffffc0204934:	89868693          	addi	a3,a3,-1896 # ffffffffc02071c8 <default_pmm_manager+0xb50>
ffffffffc0204938:	00002617          	auipc	a2,0x2
ffffffffc020493c:	99060613          	addi	a2,a2,-1648 # ffffffffc02062c8 <commands+0x858>
ffffffffc0204940:	3c200593          	li	a1,962
ffffffffc0204944:	00002517          	auipc	a0,0x2
ffffffffc0204948:	74c50513          	addi	a0,a0,1868 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc020494c:	b43fb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0204950 <do_execve>:
{
ffffffffc0204950:	7171                	addi	sp,sp,-176
ffffffffc0204952:	e4ee                	sd	s11,72(sp)
    struct mm_struct *mm = current->mm;
ffffffffc0204954:	000a6d97          	auipc	s11,0xa6
ffffffffc0204958:	d9cd8d93          	addi	s11,s11,-612 # ffffffffc02aa6f0 <current>
ffffffffc020495c:	000db783          	ld	a5,0(s11)
{
ffffffffc0204960:	e54e                	sd	s3,136(sp)
ffffffffc0204962:	ed26                	sd	s1,152(sp)
    struct mm_struct *mm = current->mm;
ffffffffc0204964:	0287b983          	ld	s3,40(a5)
{
ffffffffc0204968:	e94a                	sd	s2,144(sp)
ffffffffc020496a:	f4de                	sd	s7,104(sp)
ffffffffc020496c:	892a                	mv	s2,a0
ffffffffc020496e:	8bb2                	mv	s7,a2
ffffffffc0204970:	84ae                	mv	s1,a1
    if (!user_mem_check(mm, (uintptr_t)name, len, 0))
ffffffffc0204972:	862e                	mv	a2,a1
ffffffffc0204974:	4681                	li	a3,0
ffffffffc0204976:	85aa                	mv	a1,a0
ffffffffc0204978:	854e                	mv	a0,s3
{
ffffffffc020497a:	f506                	sd	ra,168(sp)
...
ffffffffc0204984:	f0e2                	sd	s8,96(sp)
ffffffffc0204986:	ece6                	sd	s9,88(sp)
ffffffffc0204988:	e8ea                	sd	s10,80(sp)
ffffffffc020498a:	f05e                	sd	s7,32(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0))
ffffffffc020498c:	d1aff0ef          	jal	ra,ffffffffc0203ea6 <user_mem_check>
ffffffffc0204990:	40050a63          	beqz	a0,ffffffffc0204da4 <do_execve+0x454>
    memset(local_name, 0, sizeof(local_name));
ffffffffc0204994:	4641                	li	a2,16
ffffffffc0204996:	4581                	li	a1,0
ffffffffc0204998:	1808                	addi	a0,sp,48
ffffffffc020499a:	643000ef          	jal	ra,ffffffffc02057dc <memset>
    memcpy(local_name, name, len);
ffffffffc020499e:	47bd                	li	a5,15
ffffffffc02049a0:	8626                	mv	a2,s1
ffffffffc02049a2:	1e97e263          	bltu	a5,s1,ffffffffc0204b86 <do_execve+0x236>
ffffffffc02049a6:	85ca                	mv	a1,s2
ffffffffc02049a8:	1808                	addi	a0,sp,48
ffffffffc02049aa:	645000ef          	jal	ra,ffffffffc02057ee <memcpy>
    if (mm != NULL)
ffffffffc02049ae:	1e098363          	beqz	s3,ffffffffc0204b94 <do_execve+0x244>
        cputs("mm != NULL");
ffffffffc02049b2:	00002517          	auipc	a0,0x2
ffffffffc02049b6:	49e50513          	addi	a0,a0,1182 # ffffffffc0206e50 <default_pmm_manager+0x7d8>
ffffffffc02049ba:	813fb0ef          	jal	ra,ffffffffc02001cc <cputs>
ffffffffc02049be:	000a6797          	auipc	a5,0xa6
ffffffffc02049c2:	d027b783          	ld	a5,-766(a5) # ffffffffc02aa6c0 <boot_pgdir_pa>
ffffffffc02049c6:	577d                	li	a4,-1
ffffffffc02049c8:	177e                	slli	a4,a4,0x3f
ffffffffc02049ca:	83b1                	srli	a5,a5,0xc
ffffffffc02049cc:	8fd9                	or	a5,a5,a4
ffffffffc02049ce:	18079073          	csrw	satp,a5
ffffffffc02049d2:	0309a783          	lw	a5,48(s3) # 2030 <_binary_obj___user_faultread_out_size-0x7b78>
ffffffffc02049d6:	fff7871b          	addiw	a4,a5,-1
ffffffffc02049da:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0)
ffffffffc02049de:	2c070463          	beqz	a4,ffffffffc0204ca6 <do_execve+0x356>
        current->mm = NULL;
ffffffffc02049e2:	000db783          	ld	a5,0(s11)
ffffffffc02049e6:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL)
ffffffffc02049ea:	e47fe0ef          	jal	ra,ffffffffc0203830 <mm_create>
ffffffffc02049ee:	84aa                	mv	s1,a0
ffffffffc02049f0:	1c050d63          	beqz	a0,ffffffffc0204bca <do_execve+0x27a>
    if ((page = alloc_page()) == NULL)
ffffffffc02049f4:	4505                	li	a0,1
ffffffffc02049f6:	dcafd0ef          	jal	ra,ffffffffc0201fc0 <alloc_pages>
ffffffffc02049fa:	3a050963          	beqz	a0,ffffffffc0204dac <do_execve+0x45c>
    return page - pages + nbase;
ffffffffc02049fe:	000a6c97          	auipc	s9,0xa6
ffffffffc0204a02:	cdac8c93          	addi	s9,s9,-806 # ffffffffc02aa6d8 <pages>
ffffffffc0204a06:	000cb683          	ld	a3,0(s9)
    return KADDR(page2pa(page));
ffffffffc0204a0a:	000a6c17          	auipc	s8,0xa6
ffffffffc0204a0e:	cc6c0c13          	addi	s8,s8,-826 # ffffffffc02aa6d0 <npage>
    return page - pages + nbase;
ffffffffc0204a12:	00003717          	auipc	a4,0x3
ffffffffc0204a16:	f1673703          	ld	a4,-234(a4) # ffffffffc0207928 <nbase>
ffffffffc0204a1a:	40d506b3          	sub	a3,a0,a3
ffffffffc0204a1e:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0204a20:	5afd                	li	s5,-1
ffffffffc0204a22:	000c3783          	ld	a5,0(s8)
    return page - pages + nbase;
ffffffffc0204a26:	96ba                	add	a3,a3,a4
ffffffffc0204a28:	e83a                	sd	a4,16(sp)
    return KADDR(page2pa(page));
ffffffffc0204a2a:	00cad713          	srli	a4,s5,0xc
ffffffffc0204a2e:	ec3a                	sd	a4,24(sp)
ffffffffc0204a30:	8f75                	and	a4,a4,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204a32:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204a34:	38f77063          	bgeu	a4,a5,ffffffffc0204db4 <do_execve+0x464>
ffffffffc0204a38:	000a6b17          	auipc	s6,0xa6
ffffffffc0204a3c:	cb0b0b13          	addi	s6,s6,-848 # ffffffffc02aa6e8 <va_pa_offset>
ffffffffc0204a40:	000b3903          	ld	s2,0(s6)
    memcpy(pgdir, boot_pgdir_va, PGSIZE);
ffffffffc0204a44:	6605                	lui	a2,0x1
ffffffffc0204a46:	000a6597          	auipc	a1,0xa6
ffffffffc0204a4a:	c825b583          	ld	a1,-894(a1) # ffffffffc02aa6c8 <boot_pgdir_va>
ffffffffc0204a4e:	9936                	add	s2,s2,a3
ffffffffc0204a50:	854a                	mv	a0,s2
ffffffffc0204a52:	59d000ef          	jal	ra,ffffffffc02057ee <memcpy>
    if (elf->e_magic != ELF_MAGIC)
ffffffffc0204a56:	7782                	ld	a5,32(sp)
ffffffffc0204a58:	4398                	lw	a4,0(a5)
ffffffffc0204a5a:	464c47b7          	lui	a5,0x464c4
    mm->pgdir = pgdir;
ffffffffc0204a5e:	0124bc23          	sd	s2,24(s1)
    if (elf->e_magic != ELF_MAGIC)
ffffffffc0204a62:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b945f>
ffffffffc0204a66:	14f71863          	bne	a4,a5,ffffffffc0204bb6 <do_execve+0x266>
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0204a6a:	7682                	ld	a3,32(sp)
ffffffffc0204a6c:	0386d703          	lhu	a4,56(a3)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0204a70:	0206b983          	ld	s3,32(a3)
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0204a74:	00371793          	slli	a5,a4,0x3
ffffffffc0204a78:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0204a7a:	99b6                	add	s3,s3,a3
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0204a7c:	078e                	slli	a5,a5,0x3
ffffffffc0204a7e:	97ce                	add	a5,a5,s3
ffffffffc0204a80:	f43e                	sd	a5,40(sp)
    for (; ph < ph_end; ph++)
ffffffffc0204a82:	00f9fc63          	bgeu	s3,a5,ffffffffc0204a9a <do_execve+0x14a>
        if (ph->p_type != ELF_PT_LOAD)
ffffffffc0204a86:	0009a783          	lw	a5,0(s3)
ffffffffc0204a8a:	4705                	li	a4,1
ffffffffc0204a8c:	14e78163          	beq	a5,a4,ffffffffc0204bce <do_execve+0x27e>
    for (; ph < ph_end; ph++)
ffffffffc0204a90:	77a2                	ld	a5,40(sp)
ffffffffc0204a92:	03898993          	addi	s3,s3,56
ffffffffc0204a96:	fef9e8e3          	bltu	s3,a5,ffffffffc0204a86 <do_execve+0x136>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0)
ffffffffc0204a9a:	4701                	li	a4,0
ffffffffc0204a9c:	46ad                	li	a3,11
ffffffffc0204a9e:	00100637          	lui	a2,0x100
ffffffffc0204aa2:	7ff005b7          	lui	a1,0x7ff00
ffffffffc0204aa6:	8526                	mv	a0,s1
ffffffffc0204aa8:	f1bfe0ef          	jal	ra,ffffffffc02039c2 <mm_map>
ffffffffc0204aac:	8a2a                	mv	s4,a0
ffffffffc0204aae:	1e051263          	bnez	a0,ffffffffc0204c92 <do_execve+0x342>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - PGSIZE, PTE_USER) != NULL);
ffffffffc0204ab2:	6c88                	ld	a0,24(s1)
ffffffffc0204ab4:	467d                	li	a2,31
ffffffffc0204ab6:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc0204aba:	c91fe0ef          	jal	ra,ffffffffc020374a <pgdir_alloc_page>
ffffffffc0204abe:	38050363          	beqz	a0,ffffffffc0204e44 <do_execve+0x4f4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 2 * PGSIZE, PTE_USER) != NULL);
ffffffffc0204ac2:	6c88                	ld	a0,24(s1)
ffffffffc0204ac4:	467d                	li	a2,31
ffffffffc0204ac6:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc0204aca:	c81fe0ef          	jal	ra,ffffffffc020374a <pgdir_alloc_page>
ffffffffc0204ace:	34050b63          	beqz	a0,ffffffffc0204e24 <do_execve+0x4d4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 3 * PGSIZE, PTE_USER) != NULL);
ffffffffc0204ad2:	6c88                	ld	a0,24(s1)
ffffffffc0204ad4:	467d                	li	a2,31
ffffffffc0204ad6:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc0204ada:	c71fe0ef          	jal	ra,ffffffffc020374a <pgdir_alloc_page>
ffffffffc0204ade:	32050363          	beqz	a0,ffffffffc0204e04 <do_execve+0x4b4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 4 * PGSIZE, PTE_USER) != NULL);
ffffffffc0204ae2:	6c88                	ld	a0,24(s1)
ffffffffc0204ae4:	467d                	li	a2,31
ffffffffc0204ae6:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc0204aea:	c61fe0ef          	jal	ra,ffffffffc020374a <pgdir_alloc_page>
ffffffffc0204aee:	2e050b63          	beqz	a0,ffffffffc0204de4 <do_execve+0x494>
    mm->mm_count += 1;
ffffffffc0204af2:	589c                	lw	a5,48(s1)
    current->mm = mm;
ffffffffc0204af4:	000db603          	ld	a2,0(s11)
    current->pgdir = PADDR(mm->pgdir);
ffffffffc0204af8:	6c94                	ld	a3,24(s1)
ffffffffc0204afa:	2785                	addiw	a5,a5,1
ffffffffc0204afc:	d89c                	sw	a5,48(s1)
    current->mm = mm;
ffffffffc0204afe:	f604                	sd	s1,40(a2)
    current->pgdir = PADDR(mm->pgdir);
ffffffffc0204b00:	c02007b7          	lui	a5,0xc0200
ffffffffc0204b04:	2cf6e463          	bltu	a3,a5,ffffffffc0204dcc <do_execve+0x47c>
ffffffffc0204b08:	000b3783          	ld	a5,0(s6)
ffffffffc0204b0c:	577d                	li	a4,-1
ffffffffc0204b0e:	177e                	slli	a4,a4,0x3f
ffffffffc0204b10:	8e9d                	sub	a3,a3,a5
ffffffffc0204b12:	00c6d793          	srli	a5,a3,0xc
ffffffffc0204b16:	f654                	sd	a3,168(a2)
ffffffffc0204b18:	8fd9                	or	a5,a5,a4
ffffffffc0204b1a:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc0204b1e:	7240                	ld	s0,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc0204b20:	4581                	li	a1,0
ffffffffc0204b22:	12000613          	li	a2,288
ffffffffc0204b26:	8522                	mv	a0,s0
    uintptr_t sstatus = tf->status;
ffffffffc0204b28:	10043483          	ld	s1,256(s0)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc0204b2c:	4b1000ef          	jal	ra,ffffffffc02057dc <memset>
    tf->epc = elf->e_entry;
ffffffffc0204b30:	7782                	ld	a5,32(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204b32:	000db903          	ld	s2,0(s11)
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc0204b36:	edf4f493          	andi	s1,s1,-289
    tf->epc = elf->e_entry;
ffffffffc0204b3a:	6f98                	ld	a4,24(a5)
    tf->gpr.sp = USTACKTOP;
ffffffffc0204b3c:	4785                	li	a5,1
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204b3e:	0b490913          	addi	s2,s2,180 # ffffffff800000b4 <_binary_obj___user_exit_out_size+0xffffffff7fff4f94>
    tf->gpr.sp = USTACKTOP;
ffffffffc0204b42:	07fe                	slli	a5,a5,0x1f
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc0204b44:	0204e493          	ori	s1,s1,32
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204b48:	4641                	li	a2,16
ffffffffc0204b4a:	4581                	li	a1,0
    tf->gpr.sp = USTACKTOP;
ffffffffc0204b4c:	e81c                	sd	a5,16(s0)
    tf->epc = elf->e_entry;
ffffffffc0204b4e:	10e43423          	sd	a4,264(s0)
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc0204b52:	10943023          	sd	s1,256(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204b56:	854a                	mv	a0,s2
ffffffffc0204b58:	485000ef          	jal	ra,ffffffffc02057dc <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204b5c:	463d                	li	a2,15
ffffffffc0204b5e:	180c                	addi	a1,sp,48
ffffffffc0204b60:	854a                	mv	a0,s2
ffffffffc0204b62:	48d000ef          	jal	ra,ffffffffc02057ee <memcpy>
}
ffffffffc0204b66:	70aa                	ld	ra,168(sp)
ffffffffc0204b68:	740a                	ld	s0,160(sp)
ffffffffc0204b6a:	64ea                	ld	s1,152(sp)
ffffffffc0204b6c:	694a                	ld	s2,144(sp)
ffffffffc0204b6e:	69aa                	ld	s3,136(sp)
ffffffffc0204b70:	7ae6                	ld	s5,120(sp)
ffffffffc0204b72:	7b46                	ld	s6,112(sp)
ffffffffc0204b74:	7ba6                	ld	s7,104(sp)
ffffffffc0204b76:	7c06                	ld	s8,96(sp)
ffffffffc0204b78:	6ce6                	ld	s9,88(sp)
ffffffffc0204b7a:	6d46                	ld	s10,80(sp)
ffffffffc0204b7c:	6da6                	ld	s11,72(sp)
ffffffffc0204b7e:	8552                	mv	a0,s4
ffffffffc0204b80:	6a0a                	ld	s4,128(sp)
ffffffffc0204b82:	614d                	addi	sp,sp,176
ffffffffc0204b84:	8082                	ret
    memcpy(local_name, name, len);
ffffffffc0204b86:	463d                	li	a2,15
ffffffffc0204b88:	85ca                	mv	a1,s2
ffffffffc0204b8a:	1808                	addi	a0,sp,48
ffffffffc0204b8c:	463000ef          	jal	ra,ffffffffc02057ee <memcpy>
    if (mm != NULL)
ffffffffc0204b90:	e20991e3          	bnez	s3,ffffffffc02049b2 <do_execve+0x62>
    if (current->mm != NULL)
ffffffffc0204b94:	000db783          	ld	a5,0(s11)
ffffffffc0204b98:	779c                	ld	a5,40(a5)
ffffffffc0204b9a:	e40788e3          	beqz	a5,ffffffffc02049ea <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc0204b9e:	00002617          	auipc	a2,0x2
ffffffffc0204ba2:	6ba60613          	addi	a2,a2,1722 # ffffffffc0207258 <default_pmm_manager+0xbe0>
ffffffffc0204ba6:	23f00593          	li	a1,575
ffffffffc0204baa:	00002517          	auipc	a0,0x2
ffffffffc0204bae:	4e650513          	addi	a0,a0,1254 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc0204bb2:	8ddfb0ef          	jal	ra,ffffffffc020048e <__panic>
    put_pgdir(mm);
ffffffffc0204bb6:	8526                	mv	a0,s1
ffffffffc0204bb8:	c88ff0ef          	jal	ra,ffffffffc0204040 <put_pgdir>
    mm_destroy(mm);
ffffffffc0204bbc:	8526                	mv	a0,s1
ffffffffc0204bbe:	db3fe0ef          	jal	ra,ffffffffc0203970 <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc0204bc2:	5a61                	li	s4,-8
    do_exit(ret);
ffffffffc0204bc4:	8552                	mv	a0,s4
ffffffffc0204bc6:	94bff0ef          	jal	ra,ffffffffc0204510 <do_exit>
    int ret = -E_NO_MEM;
ffffffffc0204bca:	5a71                	li	s4,-4
ffffffffc0204bcc:	bfe5                	j	ffffffffc0204bc4 <do_execve+0x274>
        if (ph->p_filesz > ph->p_memsz)
ffffffffc0204bce:	0289b603          	ld	a2,40(s3)
ffffffffc0204bd2:	0209b783          	ld	a5,32(s3)
ffffffffc0204bd6:	1cf66d63          	bltu	a2,a5,ffffffffc0204db0 <do_execve+0x460>
        if (ph->p_flags & ELF_PF_X)
ffffffffc0204bda:	0049a783          	lw	a5,4(s3)
ffffffffc0204bde:	0017f693          	andi	a3,a5,1
ffffffffc0204be2:	c291                	beqz	a3,ffffffffc0204be6 <do_execve+0x296>
            vm_flags |= VM_EXEC;
ffffffffc0204be4:	4691                	li	a3,4
        if (ph->p_flags & ELF_PF_W)
ffffffffc0204be6:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_R)
ffffffffc0204bea:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W)
ffffffffc0204bec:	e779                	bnez	a4,ffffffffc0204cba <do_execve+0x36a>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc0204bee:	4d45                	li	s10,17
        if (ph->p_flags & ELF_PF_R)
ffffffffc0204bf0:	c781                	beqz	a5,ffffffffc0204bf8 <do_execve+0x2a8>
            vm_flags |= VM_READ;
ffffffffc0204bf2:	0016e693          	ori	a3,a3,1
            perm |= PTE_R;
ffffffffc0204bf6:	4d4d                	li	s10,19
        if (vm_flags & VM_WRITE)
ffffffffc0204bf8:	0026f793          	andi	a5,a3,2
ffffffffc0204bfc:	e3f1                	bnez	a5,ffffffffc0204cc0 <do_execve+0x370>
        if (vm_flags & VM_EXEC)
ffffffffc0204bfe:	0046f793          	andi	a5,a3,4
ffffffffc0204c02:	c399                	beqz	a5,ffffffffc0204c08 <do_execve+0x2b8>
            perm |= PTE_X;
ffffffffc0204c04:	008d6d13          	ori	s10,s10,8
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0)
ffffffffc0204c08:	0109b583          	ld	a1,16(s3)
ffffffffc0204c0c:	4701                	li	a4,0
ffffffffc0204c0e:	8526                	mv	a0,s1
ffffffffc0204c10:	db3fe0ef          	jal	ra,ffffffffc02039c2 <mm_map>
ffffffffc0204c14:	8a2a                	mv	s4,a0
ffffffffc0204c16:	ed35                	bnez	a0,ffffffffc0204c92 <do_execve+0x342>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0204c18:	0109bb83          	ld	s7,16(s3)
ffffffffc0204c1c:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc0204c1e:	0209ba03          	ld	s4,32(s3)
        unsigned char *from = binary + ph->p_offset;
ffffffffc0204c22:	0089b903          	ld	s2,8(s3)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0204c26:	00fbfab3          	and	s5,s7,a5
        unsigned char *from = binary + ph->p_offset;
ffffffffc0204c2a:	7782                	ld	a5,32(sp)
        end = ph->p_va + ph->p_filesz;
ffffffffc0204c2c:	9a5e                	add	s4,s4,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc0204c2e:	993e                	add	s2,s2,a5
        while (start < end)
ffffffffc0204c30:	054be963          	bltu	s7,s4,ffffffffc0204c82 <do_execve+0x332>
ffffffffc0204c34:	aa95                	j	ffffffffc0204da8 <do_execve+0x458>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0204c36:	6785                	lui	a5,0x1
ffffffffc0204c38:	415b8533          	sub	a0,s7,s5
ffffffffc0204c3c:	9abe                	add	s5,s5,a5
ffffffffc0204c3e:	417a8633          	sub	a2,s5,s7
            if (end < la)
ffffffffc0204c42:	015a7463          	bgeu	s4,s5,ffffffffc0204c4a <do_execve+0x2fa>
                size -= la - end;
ffffffffc0204c46:	417a0633          	sub	a2,s4,s7
    return page - pages + nbase;
ffffffffc0204c4a:	000cb683          	ld	a3,0(s9)
ffffffffc0204c4e:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0204c50:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0204c54:	40d406b3          	sub	a3,s0,a3
ffffffffc0204c58:	8699                	srai	a3,a3,0x6
ffffffffc0204c5a:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204c5c:	67e2                	ld	a5,24(sp)
ffffffffc0204c5e:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0204c62:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204c64:	14b87863          	bgeu	a6,a1,ffffffffc0204db4 <do_execve+0x464>
ffffffffc0204c68:	000b3803          	ld	a6,0(s6)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0204c6c:	85ca                	mv	a1,s2
            start += size, from += size;
ffffffffc0204c6e:	9bb2                	add	s7,s7,a2
ffffffffc0204c70:	96c2                	add	a3,a3,a6
            memcpy(page2kva(page) + off, from, size);
ffffffffc0204c72:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0204c74:	e432                	sd	a2,8(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0204c76:	379000ef          	jal	ra,ffffffffc02057ee <memcpy>
            start += size, from += size;
ffffffffc0204c7a:	6622                	ld	a2,8(sp)
ffffffffc0204c7c:	9932                	add	s2,s2,a2
        while (start < end)
ffffffffc0204c7e:	054bf363          	bgeu	s7,s4,ffffffffc0204cc4 <do_execve+0x374>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL)
ffffffffc0204c82:	6c88                	ld	a0,24(s1)
ffffffffc0204c84:	866a                	mv	a2,s10
ffffffffc0204c86:	85d6                	mv	a1,s5
ffffffffc0204c88:	ac3fe0ef          	jal	ra,ffffffffc020374a <pgdir_alloc_page>
ffffffffc0204c8c:	842a                	mv	s0,a0
ffffffffc0204c8e:	f545                	bnez	a0,ffffffffc0204c36 <do_execve+0x2e6>
        ret = -E_NO_MEM;
ffffffffc0204c90:	5a71                	li	s4,-4
    exit_mmap(mm);
ffffffffc0204c92:	8526                	mv	a0,s1
ffffffffc0204c94:	e79fe0ef          	jal	ra,ffffffffc0203b0c <exit_mmap>
    put_pgdir(mm);
ffffffffc0204c98:	8526                	mv	a0,s1
ffffffffc0204c9a:	ba6ff0ef          	jal	ra,ffffffffc0204040 <put_pgdir>
    mm_destroy(mm);
ffffffffc0204c9e:	8526                	mv	a0,s1
ffffffffc0204ca0:	cd1fe0ef          	jal	ra,ffffffffc0203970 <mm_destroy>
    return ret;
ffffffffc0204ca4:	b705                	j	ffffffffc0204bc4 <do_execve+0x274>
            exit_mmap(mm);
ffffffffc0204ca6:	854e                	mv	a0,s3
ffffffffc0204ca8:	e65fe0ef          	jal	ra,ffffffffc0203b0c <exit_mmap>
            put_pgdir(mm);
ffffffffc0204cac:	854e                	mv	a0,s3
ffffffffc0204cae:	b92ff0ef          	jal	ra,ffffffffc0204040 <put_pgdir>
            mm_destroy(mm);
ffffffffc0204cb2:	854e                	mv	a0,s3
ffffffffc0204cb4:	cbdfe0ef          	jal	ra,ffffffffc0203970 <mm_destroy>
ffffffffc0204cb8:	b32d                	j	ffffffffc02049e2 <do_execve+0x92>
            vm_flags |= VM_WRITE;
ffffffffc0204cba:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R)
ffffffffc0204cbe:	fb95                	bnez	a5,ffffffffc0204bf2 <do_execve+0x2a2>
            perm |= (PTE_W | PTE_R);
ffffffffc0204cc0:	4d5d                	li	s10,23
ffffffffc0204cc2:	bf35                	j	ffffffffc0204bfe <do_execve+0x2ae>
        end = ph->p_va + ph->p_memsz;
ffffffffc0204cc4:	0109b683          	ld	a3,16(s3)
ffffffffc0204cc8:	0289b903          	ld	s2,40(s3)
ffffffffc0204ccc:	9936                	add	s2,s2,a3
        if (start < la)
ffffffffc0204cce:	075bfd63          	bgeu	s7,s5,ffffffffc0204d48 <do_execve+0x3f8>
            if (start == end)
ffffffffc0204cd2:	db790fe3          	beq	s2,s7,ffffffffc0204a90 <do_execve+0x140>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0204cd6:	6785                	lui	a5,0x1
ffffffffc0204cd8:	00fb8533          	add	a0,s7,a5
ffffffffc0204cdc:	41550533          	sub	a0,a0,s5
                size -= la - end;
ffffffffc0204ce0:	41790a33          	sub	s4,s2,s7
            if (end < la)
ffffffffc0204ce4:	0b597d63          	bgeu	s2,s5,ffffffffc0204d9e <do_execve+0x44e>
    return page - pages + nbase;
ffffffffc0204ce8:	000cb683          	ld	a3,0(s9)
ffffffffc0204cec:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0204cee:	000c3603          	ld	a2,0(s8)
    return page - pages + nbase;
ffffffffc0204cf2:	40d406b3          	sub	a3,s0,a3
ffffffffc0204cf6:	8699                	srai	a3,a3,0x6
ffffffffc0204cf8:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204cfa:	67e2                	ld	a5,24(sp)
ffffffffc0204cfc:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0204d00:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204d02:	0ac5f963          	bgeu	a1,a2,ffffffffc0204db4 <do_execve+0x464>
ffffffffc0204d06:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0204d0a:	8652                	mv	a2,s4
ffffffffc0204d0c:	4581                	li	a1,0
ffffffffc0204d0e:	96c2                	add	a3,a3,a6
ffffffffc0204d10:	9536                	add	a0,a0,a3
ffffffffc0204d12:	2cb000ef          	jal	ra,ffffffffc02057dc <memset>
            start += size;
ffffffffc0204d16:	017a0733          	add	a4,s4,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0204d1a:	03597463          	bgeu	s2,s5,ffffffffc0204d42 <do_execve+0x3f2>
ffffffffc0204d1e:	d6e909e3          	beq	s2,a4,ffffffffc0204a90 <do_execve+0x140>
ffffffffc0204d22:	00002697          	auipc	a3,0x2
ffffffffc0204d26:	55e68693          	addi	a3,a3,1374 # ffffffffc0207280 <default_pmm_manager+0xc08>
ffffffffc0204d2a:	00001617          	auipc	a2,0x1
ffffffffc0204d2e:	59e60613          	addi	a2,a2,1438 # ffffffffc02062c8 <commands+0x858>
ffffffffc0204d32:	2a800593          	li	a1,680
ffffffffc0204d36:	00002517          	auipc	a0,0x2
ffffffffc0204d3a:	35a50513          	addi	a0,a0,858 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc0204d3e:	f50fb0ef          	jal	ra,ffffffffc020048e <__panic>
ffffffffc0204d42:	ff5710e3          	bne	a4,s5,ffffffffc0204d22 <do_execve+0x3d2>
ffffffffc0204d46:	8bd6                	mv	s7,s5
        while (start < end)
ffffffffc0204d48:	d52bf4e3          	bgeu	s7,s2,ffffffffc0204a90 <do_execve+0x140>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL)
ffffffffc0204d4c:	6c88                	ld	a0,24(s1)
ffffffffc0204d4e:	866a                	mv	a2,s10
ffffffffc0204d50:	85d6                	mv	a1,s5
ffffffffc0204d52:	9f9fe0ef          	jal	ra,ffffffffc020374a <pgdir_alloc_page>
ffffffffc0204d56:	842a                	mv	s0,a0
ffffffffc0204d58:	dd05                	beqz	a0,ffffffffc0204c90 <do_execve+0x340>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0204d5a:	6785                	lui	a5,0x1
ffffffffc0204d5c:	415b8533          	sub	a0,s7,s5
ffffffffc0204d60:	9abe                	add	s5,s5,a5
ffffffffc0204d62:	417a8633          	sub	a2,s5,s7
            if (end < la)
ffffffffc0204d66:	01597463          	bgeu	s2,s5,ffffffffc0204d6e <do_execve+0x41e>
                size -= la - end;
ffffffffc0204d6a:	41790633          	sub	a2,s2,s7
    return page - pages + nbase;
ffffffffc0204d6e:	000cb683          	ld	a3,0(s9)
ffffffffc0204d72:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0204d74:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0204d78:	40d406b3          	sub	a3,s0,a3
ffffffffc0204d7c:	8699                	srai	a3,a3,0x6
ffffffffc0204d7e:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204d80:	67e2                	ld	a5,24(sp)
ffffffffc0204d82:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0204d86:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204d88:	02b87663          	bgeu	a6,a1,ffffffffc0204db4 <do_execve+0x464>
ffffffffc0204d8c:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0204d90:	4581                	li	a1,0
            start += size;
ffffffffc0204d92:	9bb2                	add	s7,s7,a2
ffffffffc0204d94:	96c2                	add	a3,a3,a6
            memset(page2kva(page) + off, 0, size);
ffffffffc0204d96:	9536                	add	a0,a0,a3
ffffffffc0204d98:	245000ef          	jal	ra,ffffffffc02057dc <memset>
ffffffffc0204d9c:	b775                	j	ffffffffc0204d48 <do_execve+0x3f8>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0204d9e:	417a8a33          	sub	s4,s5,s7
ffffffffc0204da2:	b799                	j	ffffffffc0204ce8 <do_execve+0x398>
        return -E_INVAL;
ffffffffc0204da4:	5a75                	li	s4,-3
ffffffffc0204da6:	b3c1                	j	ffffffffc0204b66 <do_execve+0x216>
        while (start < end)
ffffffffc0204da8:	86de                	mv	a3,s7
ffffffffc0204daa:	bf39                	j	ffffffffc0204cc8 <do_execve+0x378>
    int ret = -E_NO_MEM;
ffffffffc0204dac:	5a71                	li	s4,-4
ffffffffc0204dae:	bdc5                	j	ffffffffc0204c9e <do_execve+0x34e>
            ret = -E_INVAL_ELF;
ffffffffc0204db0:	5a61                	li	s4,-8
ffffffffc0204db2:	b5c5                	j	ffffffffc0204c92 <do_execve+0x342>
ffffffffc0204db4:	00001617          	auipc	a2,0x1
ffffffffc0204db8:	46c60613          	addi	a2,a2,1132 # ffffffffc0206220 <commands+0x7b0>
ffffffffc0204dbc:	07100593          	li	a1,113
ffffffffc0204dc0:	00001517          	auipc	a0,0x1
ffffffffc0204dc4:	48850513          	addi	a0,a0,1160 # ffffffffc0206248 <commands+0x7d8>
ffffffffc0204dc8:	ec6fb0ef          	jal	ra,ffffffffc020048e <__panic>
    current->pgdir = PADDR(mm->pgdir);
ffffffffc0204dcc:	00002617          	auipc	a2,0x2
ffffffffc0204dd0:	95460613          	addi	a2,a2,-1708 # ffffffffc0206720 <default_pmm_manager+0xa8>
ffffffffc0204dd4:	2c700593          	li	a1,711
ffffffffc0204dd8:	00002517          	auipc	a0,0x2
ffffffffc0204ddc:	2b850513          	addi	a0,a0,696 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc0204de0:	eaefb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 4 * PGSIZE, PTE_USER) != NULL);
ffffffffc0204de4:	00002697          	auipc	a3,0x2
ffffffffc0204de8:	5b468693          	addi	a3,a3,1460 # ffffffffc0207398 <default_pmm_manager+0xd20>
ffffffffc0204dec:	00001617          	auipc	a2,0x1
ffffffffc0204df0:	4dc60613          	addi	a2,a2,1244 # ffffffffc02062c8 <commands+0x858>
ffffffffc0204df4:	2c200593          	li	a1,706
ffffffffc0204df8:	00002517          	auipc	a0,0x2
ffffffffc0204dfc:	29850513          	addi	a0,a0,664 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc0204e00:	e8efb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 3 * PGSIZE, PTE_USER) != NULL);
ffffffffc0204e04:	00002697          	auipc	a3,0x2
ffffffffc0204e08:	54c68693          	addi	a3,a3,1356 # ffffffffc0207350 <default_pmm_manager+0xcd8>
ffffffffc0204e0c:	00001617          	auipc	a2,0x1
ffffffffc0204e10:	4bc60613          	addi	a2,a2,1212 # ffffffffc02062c8 <commands+0x858>
ffffffffc0204e14:	2c100593          	li	a1,705
ffffffffc0204e18:	00002517          	auipc	a0,0x2
ffffffffc0204e1c:	27850513          	addi	a0,a0,632 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc0204e20:	e6efb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 2 * PGSIZE, PTE_USER) != NULL);
ffffffffc0204e24:	00002697          	auipc	a3,0x2
ffffffffc0204e28:	4e468693          	addi	a3,a3,1252 # ffffffffc0207308 <default_pmm_manager+0xc90>
ffffffffc0204e2c:	00001617          	auipc	a2,0x1
ffffffffc0204e30:	49c60613          	addi	a2,a2,1180 # ffffffffc02062c8 <commands+0x858>
ffffffffc0204e34:	2c000593          	li	a1,704
ffffffffc0204e38:	00002517          	auipc	a0,0x2
ffffffffc0204e3c:	25850513          	addi	a0,a0,600 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc0204e40:	e4efb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - PGSIZE, PTE_USER) != NULL);
ffffffffc0204e44:	00002697          	auipc	a3,0x2
ffffffffc0204e48:	47c68693          	addi	a3,a3,1148 # ffffffffc02072c0 <default_pmm_manager+0xc48>
ffffffffc0204e4c:	00001617          	auipc	a2,0x1
ffffffffc0204e50:	47c60613          	addi	a2,a2,1148 # ffffffffc02062c8 <commands+0x858>
ffffffffc0204e54:	2bf00593          	li	a1,703
ffffffffc0204e58:	00002517          	auipc	a0,0x2
ffffffffc0204e5c:	23850513          	addi	a0,a0,568 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc0204e60:	e2efb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0204e64 <do_yield>:
    current->need_resched = 1;
ffffffffc0204e64:	000a6797          	auipc	a5,0xa6
ffffffffc0204e68:	88c7b783          	ld	a5,-1908(a5) # ffffffffc02aa6f0 <current>
ffffffffc0204e6c:	4705                	li	a4,1
ffffffffc0204e6e:	ef98                	sd	a4,24(a5)
}
ffffffffc0204e70:	4501                	li	a0,0
ffffffffc0204e72:	8082                	ret

ffffffffc0204e74 <do_wait>:
{
ffffffffc0204e74:	1101                	addi	sp,sp,-32
ffffffffc0204e76:	e822                	sd	s0,16(sp)
ffffffffc0204e78:	e426                	sd	s1,8(sp)
ffffffffc0204e7a:	ec06                	sd	ra,24(sp)
ffffffffc0204e7c:	842e                	mv	s0,a1
ffffffffc0204e7e:	84aa                	mv	s1,a0
    if (code_store != NULL)
ffffffffc0204e80:	c999                	beqz	a1,ffffffffc0204e96 <do_wait+0x22>
    struct mm_struct *mm = current->mm;
ffffffffc0204e82:	000a6797          	auipc	a5,0xa6
ffffffffc0204e86:	86e7b783          	ld	a5,-1938(a5) # ffffffffc02aa6f0 <current>
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1))
ffffffffc0204e8a:	7788                	ld	a0,40(a5)
ffffffffc0204e8c:	4685                	li	a3,1
ffffffffc0204e8e:	4611                	li	a2,4
ffffffffc0204e90:	816ff0ef          	jal	ra,ffffffffc0203ea6 <user_mem_check>
ffffffffc0204e94:	c909                	beqz	a0,ffffffffc0204ea6 <do_wait+0x32>
ffffffffc0204e96:	85a2                	mv	a1,s0
}
...
ffffffffc0204ea2:	fb8ff06f          	j	ffffffffc020465a <do_wait.part.0>
ffffffffc0204ea6:	60e2                	ld	ra,24(sp)
ffffffffc0204ea8:	6442                	ld	s0,16(sp)
...
ffffffffc0204eb2 <do_kill>:
{
ffffffffc0204eb2:	1141                	addi	sp,sp,-16
    if (0 < pid && pid < MAX_PID)
ffffffffc0204eb4:	6789                	lui	a5,0x2
{
ffffffffc0204eb6:	e406                	sd	ra,8(sp)
ffffffffc0204eb8:	e022                	sd	s0,0(sp)
    if (0 < pid && pid < MAX_PID)
ffffffffc0204eba:	fff5071b          	addiw	a4,a0,-1
ffffffffc0204ebe:	17f9                	addi	a5,a5,-2
ffffffffc0204ec0:	02e7e963          	bltu	a5,a4,ffffffffc0204ef2 <do_kill+0x40>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204ec4:	842a                	mv	s0,a0
ffffffffc0204ec6:	45a9                	li	a1,10
ffffffffc0204ec8:	2501                	sext.w	a0,a0
ffffffffc0204eca:	46c000ef          	jal	ra,ffffffffc0205336 <hash32>
ffffffffc0204ece:	02051793          	slli	a5,a0,0x20
ffffffffc0204ed2:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204ed6:	000a1797          	auipc	a5,0xa1
ffffffffc0204eda:	7aa78793          	addi	a5,a5,1962 # ffffffffc02a6680 <hash_list>
ffffffffc0204ede:	953e                	add	a0,a0,a5
ffffffffc0204ee0:	87aa                	mv	a5,a0
        while ((le = list_next(le)) != list)
ffffffffc0204ee2:	a029                	j	ffffffffc0204eec <do_kill+0x3a>
            if (proc->pid == pid)
ffffffffc0204ee4:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0204ee8:	00870b63          	beq	a4,s0,ffffffffc0204efe <do_kill+0x4c>
ffffffffc0204eec:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0204eee:	fef51be3          	bne	a0,a5,ffffffffc0204ee4 <do_kill+0x32>
    return -E_INVAL;
ffffffffc0204ef2:	5475                	li	s0,-3
}
ffffffffc0204ef4:	60a2                	ld	ra,8(sp)
ffffffffc0204ef6:	8522                	mv	a0,s0
ffffffffc0204ef8:	6402                	ld	s0,0(sp)
ffffffffc0204efa:	0141                	addi	sp,sp,16
ffffffffc0204efc:	8082                	ret
        if (!(proc->flags & PF_EXITING))
ffffffffc0204efe:	fd87a703          	lw	a4,-40(a5)
ffffffffc0204f02:	00177693          	andi	a3,a4,1
ffffffffc0204f06:	e295                	bnez	a3,ffffffffc0204f2a <do_kill+0x78>
            if (proc->wait_state & WT_INTERRUPTED)
ffffffffc0204f08:	4bd4                	lw	a3,20(a5)
            proc->flags |= PF_EXITING;
ffffffffc0204f0a:	00176713          	ori	a4,a4,1
ffffffffc0204f0e:	fce7ac23          	sw	a4,-40(a5)
            return 0;
ffffffffc0204f12:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED)
ffffffffc0204f14:	fe06d0e3          	bgez	a3,ffffffffc0204ef4 <do_kill+0x42>
                wakeup_proc(proc);
ffffffffc0204f18:	f2878513          	addi	a0,a5,-216
ffffffffc0204f1c:	22e000ef          	jal	ra,ffffffffc020514a <wakeup_proc>
}
...
ffffffffc0204f28:	8082                	ret
        return -E_KILLED;
ffffffffc0204f2a:	545d                	li	s0,-9
ffffffffc0204f2c:	b7e1                	j	ffffffffc0204ef4 <do_kill+0x42>

ffffffffc0204f2e <proc_init>:
...
ffffffffc0204f30:	e426                	sd	s1,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0204f32:	000a5797          	auipc	a5,0xa5
ffffffffc0204f36:	74e78793          	addi	a5,a5,1870 # ffffffffc02aa680 <proc_list>
ffffffffc0204f3a:	ec06                	sd	ra,24(sp)
ffffffffc0204f3c:	e822                	sd	s0,16(sp)
ffffffffc0204f3e:	e04a                	sd	s2,0(sp)
ffffffffc0204f40:	000a1497          	auipc	s1,0xa1
ffffffffc0204f44:	74048493          	addi	s1,s1,1856 # ffffffffc02a6680 <hash_list>
ffffffffc0204f48:	e79c                	sd	a5,8(a5)
ffffffffc0204f4a:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i++)
ffffffffc0204f4c:	000a5717          	auipc	a4,0xa5
ffffffffc0204f50:	73470713          	addi	a4,a4,1844 # ffffffffc02aa680 <proc_list>
ffffffffc0204f54:	87a6                	mv	a5,s1
ffffffffc0204f56:	e79c                	sd	a5,8(a5)
ffffffffc0204f58:	e39c                	sd	a5,0(a5)
ffffffffc0204f5a:	07c1                	addi	a5,a5,16
ffffffffc0204f5c:	fef71de3          	bne	a4,a5,ffffffffc0204f56 <proc_init+0x28>
    {
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL)
ffffffffc0204f60:	fe3fe0ef          	jal	ra,ffffffffc0203f42 <alloc_proc>
ffffffffc0204f64:	000a5917          	auipc	s2,0xa5
ffffffffc0204f68:	79490913          	addi	s2,s2,1940 # ffffffffc02aa6f8 <idleproc>
ffffffffc0204f6c:	00a93023          	sd	a0,0(s2)
ffffffffc0204f70:	0e050f63          	beqz	a0,ffffffffc020506e <proc_init+0x140>
    {
...
ffffffffc0204f74:	4789                	li	a5,2
ffffffffc0204f76:	e11c                	sd	a5,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204f78:	00003797          	auipc	a5,0x3
ffffffffc0204f7c:	08878793          	addi	a5,a5,136 # ffffffffc0208000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204f80:	0b450413          	addi	s0,a0,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204f84:	e91c                	sd	a5,16(a0)
    idleproc->need_resched = 1;
ffffffffc0204f86:	4785                	li	a5,1
ffffffffc0204f88:	ed1c                	sd	a5,24(a0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204f8a:	4641                	li	a2,16
ffffffffc0204f8c:	4581                	li	a1,0
ffffffffc0204f8e:	8522                	mv	a0,s0
ffffffffc0204f90:	04d000ef          	jal	ra,ffffffffc02057dc <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204f94:	463d                	li	a2,15
ffffffffc0204f96:	00002597          	auipc	a1,0x2
ffffffffc0204f9a:	46258593          	addi	a1,a1,1122 # ffffffffc02073f8 <default_pmm_manager+0xd80>
ffffffffc0204f9e:	8522                	mv	a0,s0
ffffffffc0204fa0:	04f000ef          	jal	ra,ffffffffc02057ee <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process++;
ffffffffc0204fa4:	000a5717          	auipc	a4,0xa5
ffffffffc0204fa8:	76470713          	addi	a4,a4,1892 # ffffffffc02aa708 <nr_process>
ffffffffc0204fac:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0204fae:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0204fb2:	4601                	li	a2,0
    nr_process++;
ffffffffc0204fb4:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0204fb6:	4581                	li	a1,0
ffffffffc0204fb8:	00000517          	auipc	a0,0x0
ffffffffc0204fbc:	87450513          	addi	a0,a0,-1932 # ffffffffc020482c <init_main>
    nr_process++;
ffffffffc0204fc0:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0204fc2:	000a5797          	auipc	a5,0xa5
ffffffffc0204fc6:	72d7b723          	sd	a3,1838(a5) # ffffffffc02aa6f0 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0204fca:	cf6ff0ef          	jal	ra,ffffffffc02044c0 <kernel_thread>
ffffffffc0204fce:	842a                	mv	s0,a0
    if (pid <= 0)
ffffffffc0204fd0:	08a05363          	blez	a0,ffffffffc0205056 <proc_init+0x128>
    if (0 < pid && pid < MAX_PID)
ffffffffc0204fd4:	6789                	lui	a5,0x2
ffffffffc0204fd6:	fff5071b          	addiw	a4,a0,-1
ffffffffc0204fda:	17f9                	addi	a5,a5,-2
ffffffffc0204fdc:	2501                	sext.w	a0,a0
ffffffffc0204fde:	02e7e363          	bltu	a5,a4,ffffffffc0205004 <proc_init+0xd6>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204fe2:	45a9                	li	a1,10
ffffffffc0204fe4:	352000ef          	jal	ra,ffffffffc0205336 <hash32>
ffffffffc0204fe8:	02051793          	slli	a5,a0,0x20
ffffffffc0204fec:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0204ff0:	96a6                	add	a3,a3,s1
ffffffffc0204ff2:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list)
ffffffffc0204ff4:	a029                	j	ffffffffc0204ffe <proc_init+0xd0>
            if (proc->pid == pid)
ffffffffc0204ff6:	f2c7a703          	lw	a4,-212(a5) # 1f2c <_binary_obj___user_faultread_out_size-0x7c7c>
ffffffffc0204ffa:	04870b63          	beq	a4,s0,ffffffffc0205050 <proc_init+0x122>
    return listelm->next;
ffffffffc0204ffe:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0205000:	fef69be3          	bne	a3,a5,ffffffffc0204ff6 <proc_init+0xc8>
    return NULL;
ffffffffc0205004:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205006:	0b478493          	addi	s1,a5,180
...
ffffffffc020500e:	000a5417          	auipc	s0,0xa5
ffffffffc0205012:	6f240413          	addi	s0,s0,1778 # ffffffffc02aa700 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205016:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0205018:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020501a:	7c2000ef          	jal	ra,ffffffffc02057dc <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020501e:	463d                	li	a2,15
ffffffffc0205020:	00002597          	auipc	a1,0x2
ffffffffc0205024:	40058593          	addi	a1,a1,1024 # ffffffffc0207420 <default_pmm_manager+0xda8>
ffffffffc0205028:	8526                	mv	a0,s1
ffffffffc020502a:	7c4000ef          	jal	ra,ffffffffc02057ee <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020502e:	00093783          	ld	a5,0(s2)
ffffffffc0205032:	cbb5                	beqz	a5,ffffffffc02050a6 <proc_init+0x178>
ffffffffc0205034:	43dc                	lw	a5,4(a5)
ffffffffc0205036:	eba5                	bnez	a5,ffffffffc02050a6 <proc_init+0x178>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205038:	601c                	ld	a5,0(s0)
ffffffffc020503a:	c7b1                	beqz	a5,ffffffffc0205086 <proc_init+0x158>
ffffffffc020503c:	43d8                	lw	a4,4(a5)
ffffffffc020503e:	4785                	li	a5,1
ffffffffc0205040:	04f71363          	bne	a4,a5,ffffffffc0205086 <proc_init+0x158>
}
ffffffffc0205044:	60e2                	ld	ra,24(sp)
ffffffffc0205046:	6442                	ld	s0,16(sp)
ffffffffc0205048:	64a2                	ld	s1,8(sp)
ffffffffc020504a:	6902                	ld	s2,0(sp)
ffffffffc020504c:	6105                	addi	sp,sp,32
ffffffffc020504e:	8082                	ret
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0205050:	f2878793          	addi	a5,a5,-216
ffffffffc0205054:	bf4d                	j	ffffffffc0205006 <proc_init+0xd8>
        panic("create init_main failed.\n");
ffffffffc0205056:	00002617          	auipc	a2,0x2
ffffffffc020505a:	3aa60613          	addi	a2,a2,938 # ffffffffc0207400 <default_pmm_manager+0xd88>
ffffffffc020505e:	3e700593          	li	a1,999
ffffffffc0205062:	00002517          	auipc	a0,0x2
ffffffffc0205066:	02e50513          	addi	a0,a0,46 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc020506a:	c24fb0ef          	jal	ra,ffffffffc020048e <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc020506e:	00002617          	auipc	a2,0x2
ffffffffc0205072:	37260613          	addi	a2,a2,882 # ffffffffc02073e0 <default_pmm_manager+0xd68>
ffffffffc0205076:	3d800593          	li	a1,984
ffffffffc020507a:	00002517          	auipc	a0,0x2
ffffffffc020507e:	01650513          	addi	a0,a0,22 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc0205082:	c0cfb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205086:	00002697          	auipc	a3,0x2
ffffffffc020508a:	3ca68693          	addi	a3,a3,970 # ffffffffc0207450 <default_pmm_manager+0xdd8>
ffffffffc020508e:	00001617          	auipc	a2,0x1
ffffffffc0205092:	23a60613          	addi	a2,a2,570 # ffffffffc02062c8 <commands+0x858>
ffffffffc0205096:	3ee00593          	li	a1,1006
ffffffffc020509a:	00002517          	auipc	a0,0x2
ffffffffc020509e:	ff650513          	addi	a0,a0,-10 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc02050a2:	becfb0ef          	jal	ra,ffffffffc020048e <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02050a6:	00002697          	auipc	a3,0x2
ffffffffc02050aa:	38268693          	addi	a3,a3,898 # ffffffffc0207428 <default_pmm_manager+0xdb0>
ffffffffc02050ae:	00001617          	auipc	a2,0x1
ffffffffc02050b2:	21a60613          	addi	a2,a2,538 # ffffffffc02062c8 <commands+0x858>
ffffffffc02050b6:	3ed00593          	li	a1,1005
ffffffffc02050ba:	00002517          	auipc	a0,0x2
ffffffffc02050be:	fd650513          	addi	a0,a0,-42 # ffffffffc0207090 <default_pmm_manager+0xa18>
ffffffffc02050c2:	bccfb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc02050c6 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void cpu_idle(void)
{
ffffffffc02050c6:	1141                	addi	sp,sp,-16
ffffffffc02050c8:	e022                	sd	s0,0(sp)
ffffffffc02050ca:	e406                	sd	ra,8(sp)
ffffffffc02050cc:	000a5417          	auipc	s0,0xa5
ffffffffc02050d0:	62440413          	addi	s0,s0,1572 # ffffffffc02aa6f0 <current>
    while (1)
    {
        if (current->need_resched)
ffffffffc02050d4:	6018                	ld	a4,0(s0)
ffffffffc02050d6:	6f1c                	ld	a5,24(a4)
ffffffffc02050d8:	dffd                	beqz	a5,ffffffffc02050d6 <cpu_idle+0x10>
        {
            schedule();
ffffffffc02050da:	0f0000ef          	jal	ra,ffffffffc02051ca <schedule>
ffffffffc02050de:	bfdd                	j	ffffffffc02050d4 <cpu_idle+0xe>

ffffffffc02050e0 <switch_to>:
.text
...
ffffffffc02050e0:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc02050e4:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc02050e8:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc02050ea:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc02050ec:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc02050f0:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc02050f4:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc02050f8:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc02050fc:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0205100:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0205104:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0205108:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020510c:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0205110:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0205114:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0205118:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc020511c:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc020511e:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0205120:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0205124:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0205128:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc020512c:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0205130:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0205134:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0205138:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc020513c:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0205140:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0205144:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0205148:	8082                	ret

ffffffffc020514a <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc020514a:	4118                	lw	a4,0(a0)
{
ffffffffc020514c:	1101                	addi	sp,sp,-32
ffffffffc020514e:	ec06                	sd	ra,24(sp)
ffffffffc0205150:	e822                	sd	s0,16(sp)
ffffffffc0205152:	e426                	sd	s1,8(sp)
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205154:	478d                	li	a5,3
ffffffffc0205156:	04f70b63          	beq	a4,a5,ffffffffc02051ac <wakeup_proc+0x62>
ffffffffc020515a:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc020515c:	100027f3          	csrr	a5,sstatus
ffffffffc0205160:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205162:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0205164:	ef9d                	bnez	a5,ffffffffc02051a2 <wakeup_proc+0x58>
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        if (proc->state != PROC_RUNNABLE)
ffffffffc0205166:	4789                	li	a5,2
ffffffffc0205168:	02f70163          	beq	a4,a5,ffffffffc020518a <wakeup_proc+0x40>
        {
            proc->state = PROC_RUNNABLE;
ffffffffc020516c:	c01c                	sw	a5,0(s0)
            proc->wait_state = 0;
ffffffffc020516e:	0e042623          	sw	zero,236(s0)
    if (flag)
ffffffffc0205172:	e491                	bnez	s1,ffffffffc020517e <wakeup_proc+0x34>
        {
...
ffffffffc0205178:	64a2                	ld	s1,8(sp)
...
ffffffffc0205182:	64a2                	ld	s1,8(sp)
ffffffffc0205184:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205186:	829fb06f          	j	ffffffffc02009ae <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc020518a:	00002617          	auipc	a2,0x2
ffffffffc020518e:	32660613          	addi	a2,a2,806 # ffffffffc02074b0 <default_pmm_manager+0xe38>
ffffffffc0205192:	45d1                	li	a1,20
ffffffffc0205194:	00002517          	auipc	a0,0x2
ffffffffc0205198:	30450513          	addi	a0,a0,772 # ffffffffc0207498 <default_pmm_manager+0xe20>
ffffffffc020519c:	b5afb0ef          	jal	ra,ffffffffc02004f6 <__warn>
ffffffffc02051a0:	bfc9                	j	ffffffffc0205172 <wakeup_proc+0x28>
        intr_disable();
ffffffffc02051a2:	813fb0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
        if (proc->state != PROC_RUNNABLE)
ffffffffc02051a6:	4018                	lw	a4,0(s0)
        return 1;
ffffffffc02051a8:	4485                	li	s1,1
ffffffffc02051aa:	bf75                	j	ffffffffc0205166 <wakeup_proc+0x1c>
    assert(proc->state != PROC_ZOMBIE);
ffffffffc02051ac:	00002697          	auipc	a3,0x2
ffffffffc02051b0:	2cc68693          	addi	a3,a3,716 # ffffffffc0207478 <default_pmm_manager+0xe00>
ffffffffc02051b4:	00001617          	auipc	a2,0x1
ffffffffc02051b8:	11460613          	addi	a2,a2,276 # ffffffffc02062c8 <commands+0x858>
ffffffffc02051bc:	45a5                	li	a1,9
ffffffffc02051be:	00002517          	auipc	a0,0x2
ffffffffc02051c2:	2da50513          	addi	a0,a0,730 # ffffffffc0207498 <default_pmm_manager+0xe20>
ffffffffc02051c6:	ac8fb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc02051ca <schedule>:

void schedule(void)
{
ffffffffc02051ca:	1141                	addi	sp,sp,-16
ffffffffc02051cc:	e406                	sd	ra,8(sp)
ffffffffc02051ce:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02051d0:	100027f3          	csrr	a5,sstatus
ffffffffc02051d4:	8b89                	andi	a5,a5,2
ffffffffc02051d6:	4401                	li	s0,0
ffffffffc02051d8:	efbd                	bnez	a5,ffffffffc0205256 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc02051da:	000a5897          	auipc	a7,0xa5
ffffffffc02051de:	5168b883          	ld	a7,1302(a7) # ffffffffc02aa6f0 <current>
ffffffffc02051e2:	0008bc23          	sd	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02051e6:	000a5517          	auipc	a0,0xa5
ffffffffc02051ea:	51253503          	ld	a0,1298(a0) # ffffffffc02aa6f8 <idleproc>
ffffffffc02051ee:	04a88e63          	beq	a7,a0,ffffffffc020524a <schedule+0x80>
ffffffffc02051f2:	0c888693          	addi	a3,a7,200
ffffffffc02051f6:	000a5617          	auipc	a2,0xa5
ffffffffc02051fa:	48a60613          	addi	a2,a2,1162 # ffffffffc02aa680 <proc_list>
        le = last;
ffffffffc02051fe:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc0205200:	4581                	li	a1,0
        do
        {
...
ffffffffc0205202:	4809                	li	a6,2
ffffffffc0205204:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list)
ffffffffc0205206:	00c78863          	beq	a5,a2,ffffffffc0205216 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE)
ffffffffc020520a:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc020520e:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE)
ffffffffc0205212:	03070163          	beq	a4,a6,ffffffffc0205234 <schedule+0x6a>
                {
                    break;
                }
            }
        } while (le != last);
ffffffffc0205216:	fef697e3          	bne	a3,a5,ffffffffc0205204 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE)
ffffffffc020521a:	ed89                	bnez	a1,ffffffffc0205234 <schedule+0x6a>
        {
            next = idleproc;
        }
        next->runs++;
ffffffffc020521c:	451c                	lw	a5,8(a0)
ffffffffc020521e:	2785                	addiw	a5,a5,1
ffffffffc0205220:	c51c                	sw	a5,8(a0)
        if (next != current)
ffffffffc0205222:	00a88463          	beq	a7,a0,ffffffffc020522a <schedule+0x60>
        {
            proc_run(next);
ffffffffc0205226:	e91fe0ef          	jal	ra,ffffffffc02040b6 <proc_run>
    if (flag)
ffffffffc020522a:	e819                	bnez	s0,ffffffffc0205240 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc020522c:	60a2                	ld	ra,8(sp)
ffffffffc020522e:	6402                	ld	s0,0(sp)
ffffffffc0205230:	0141                	addi	sp,sp,16
ffffffffc0205232:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE)
ffffffffc0205234:	4198                	lw	a4,0(a1)
ffffffffc0205236:	4789                	li	a5,2
ffffffffc0205238:	fef712e3          	bne	a4,a5,ffffffffc020521c <schedule+0x52>
ffffffffc020523c:	852e                	mv	a0,a1
ffffffffc020523e:	bff9                	j	ffffffffc020521c <schedule+0x52>
}
ffffffffc0205240:	6402                	ld	s0,0(sp)
ffffffffc0205242:	60a2                	ld	ra,8(sp)
ffffffffc0205244:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0205246:	f68fb06f          	j	ffffffffc02009ae <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020524a:	000a5617          	auipc	a2,0xa5
ffffffffc020524e:	43660613          	addi	a2,a2,1078 # ffffffffc02aa680 <proc_list>
ffffffffc0205252:	86b2                	mv	a3,a2
ffffffffc0205254:	b76d                	j	ffffffffc02051fe <schedule+0x34>
        intr_disable();
ffffffffc0205256:	f5efb0ef          	jal	ra,ffffffffc02009b4 <intr_disable>
        return 1;
ffffffffc020525a:	4405                	li	s0,1
ffffffffc020525c:	bfbd                	j	ffffffffc02051da <schedule+0x10>

ffffffffc020525e <sys_getpid>:
    return do_kill(pid);
}
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc020525e:	000a5797          	auipc	a5,0xa5
ffffffffc0205262:	4927b783          	ld	a5,1170(a5) # ffffffffc02aa6f0 <current>
}
ffffffffc0205266:	43c8                	lw	a0,4(a5)
ffffffffc0205268:	8082                	ret

ffffffffc020526a <sys_pgdir>:
...
ffffffffc020526e <sys_putc>:
    cputchar(c);
ffffffffc020526e:	4108                	lw	a0,0(a0)
sys_putc(uint64_t arg[]) {
ffffffffc0205270:	1141                	addi	sp,sp,-16
ffffffffc0205272:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc0205274:	f57fa0ef          	jal	ra,ffffffffc02001ca <cputchar>
}
ffffffffc0205278:	60a2                	ld	ra,8(sp)
ffffffffc020527a:	4501                	li	a0,0
ffffffffc020527c:	0141                	addi	sp,sp,16
ffffffffc020527e:	8082                	ret

ffffffffc0205280 <sys_kill>:
    return do_kill(pid);
ffffffffc0205280:	4108                	lw	a0,0(a0)
ffffffffc0205282:	c31ff06f          	j	ffffffffc0204eb2 <do_kill>

ffffffffc0205286 <sys_yield>:
    return do_yield();
ffffffffc0205286:	bdfff06f          	j	ffffffffc0204e64 <do_yield>

ffffffffc020528a <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc020528a:	6d14                	ld	a3,24(a0)
ffffffffc020528c:	6910                	ld	a2,16(a0)
ffffffffc020528e:	650c                	ld	a1,8(a0)
ffffffffc0205290:	6108                	ld	a0,0(a0)
ffffffffc0205292:	ebeff06f          	j	ffffffffc0204950 <do_execve>

ffffffffc0205296 <sys_wait>:
    return do_wait(pid, store);
ffffffffc0205296:	650c                	ld	a1,8(a0)
ffffffffc0205298:	4108                	lw	a0,0(a0)
ffffffffc020529a:	bdbff06f          	j	ffffffffc0204e74 <do_wait>

ffffffffc020529e <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc020529e:	000a5797          	auipc	a5,0xa5
ffffffffc02052a2:	4527b783          	ld	a5,1106(a5) # ffffffffc02aa6f0 <current>
ffffffffc02052a6:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc02052a8:	4501                	li	a0,0
ffffffffc02052aa:	6a0c                	ld	a1,16(a2)
ffffffffc02052ac:	e6ffe06f          	j	ffffffffc020411a <do_fork>

ffffffffc02052b0 <sys_exit>:
    return do_exit(error_code);
ffffffffc02052b0:	4108                	lw	a0,0(a0)
ffffffffc02052b2:	a5eff06f          	j	ffffffffc0204510 <do_exit>

ffffffffc02052b6 <syscall>:
};
...
void
syscall(void) {
ffffffffc02052b6:	715d                	addi	sp,sp,-80
ffffffffc02052b8:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc02052ba:	000a5497          	auipc	s1,0xa5
ffffffffc02052be:	43648493          	addi	s1,s1,1078 # ffffffffc02aa6f0 <current>
ffffffffc02052c2:	6098                	ld	a4,0(s1)
syscall(void) {
ffffffffc02052c4:	e0a2                	sd	s0,64(sp)
ffffffffc02052c6:	f84a                	sd	s2,48(sp)
    struct trapframe *tf = current->tf;
ffffffffc02052c8:	7340                	ld	s0,160(a4)
syscall(void) {
ffffffffc02052ca:	e486                	sd	ra,72(sp)
    uint64_t arg[5];
    int num = tf->gpr.a0;
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc02052cc:	47fd                	li	a5,31
    int num = tf->gpr.a0;
ffffffffc02052ce:	05042903          	lw	s2,80(s0)
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc02052d2:	0327ee63          	bltu	a5,s2,ffffffffc020530e <syscall+0x58>
        if (syscalls[num] != NULL) {
ffffffffc02052d6:	00391713          	slli	a4,s2,0x3
ffffffffc02052da:	00002797          	auipc	a5,0x2
ffffffffc02052de:	23e78793          	addi	a5,a5,574 # ffffffffc0207518 <syscalls>
ffffffffc02052e2:	97ba                	add	a5,a5,a4
ffffffffc02052e4:	639c                	ld	a5,0(a5)
ffffffffc02052e6:	c785                	beqz	a5,ffffffffc020530e <syscall+0x58>
            arg[0] = tf->gpr.a1;
ffffffffc02052e8:	6c28                	ld	a0,88(s0)
            arg[1] = tf->gpr.a2;
ffffffffc02052ea:	702c                	ld	a1,96(s0)
            arg[2] = tf->gpr.a3;
ffffffffc02052ec:	7430                	ld	a2,104(s0)
            arg[3] = tf->gpr.a4;
ffffffffc02052ee:	7834                	ld	a3,112(s0)
            arg[4] = tf->gpr.a5;
ffffffffc02052f0:	7c38                	ld	a4,120(s0)
            arg[0] = tf->gpr.a1;
ffffffffc02052f2:	e42a                	sd	a0,8(sp)
            arg[1] = tf->gpr.a2;
ffffffffc02052f4:	e82e                	sd	a1,16(sp)
            arg[2] = tf->gpr.a3;
ffffffffc02052f6:	ec32                	sd	a2,24(sp)
            arg[3] = tf->gpr.a4;
ffffffffc02052f8:	f036                	sd	a3,32(sp)
            arg[4] = tf->gpr.a5;
ffffffffc02052fa:	f43a                	sd	a4,40(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02052fc:	0028                	addi	a0,sp,8
ffffffffc02052fe:	9782                	jalr	a5
        }
    }
    print_trapframe(tf);
...
ffffffffc0205300:	60a6                	ld	ra,72(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc0205302:	e828                	sd	a0,80(s0)
}
ffffffffc0205304:	6406                	ld	s0,64(sp)
ffffffffc0205306:	74e2                	ld	s1,56(sp)
ffffffffc0205308:	7942                	ld	s2,48(sp)
ffffffffc020530a:	6161                	addi	sp,sp,80
ffffffffc020530c:	8082                	ret
    print_trapframe(tf);
ffffffffc020530e:	8522                	mv	a0,s0
ffffffffc0205310:	895fb0ef          	jal	ra,ffffffffc0200ba4 <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc0205314:	609c                	ld	a5,0(s1)
ffffffffc0205316:	86ca                	mv	a3,s2
ffffffffc0205318:	00002617          	auipc	a2,0x2
ffffffffc020531c:	1b860613          	addi	a2,a2,440 # ffffffffc02074d0 <default_pmm_manager+0xe58>
ffffffffc0205320:	43d8                	lw	a4,4(a5)
ffffffffc0205322:	06200593          	li	a1,98
ffffffffc0205326:	0b478793          	addi	a5,a5,180
ffffffffc020532a:	00002517          	auipc	a0,0x2
ffffffffc020532e:	1d650513          	addi	a0,a0,470 # ffffffffc0207500 <default_pmm_manager+0xe88>
ffffffffc0205332:	95cfb0ef          	jal	ra,ffffffffc020048e <__panic>

ffffffffc0205336 <hash32>:
 *
...
ffffffffc0205336:	9e3707b7          	lui	a5,0x9e370
ffffffffc020533a:	2785                	addiw	a5,a5,1
ffffffffc020533c:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0205340:	02000793          	li	a5,32
ffffffffc0205344:	9f8d                	subw	a5,a5,a1
}
ffffffffc0205346:	00f5553b          	srlw	a0,a0,a5
ffffffffc020534a:	8082                	ret

ffffffffc020534c <printnum>:
 * */
static void
...
ffffffffc020534c:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0205350:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0205352:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0205356:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0205358:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020535c:	f022                	sd	s0,32(sp)
ffffffffc020535e:	ec26                	sd	s1,24(sp)
ffffffffc0205360:	e84a                	sd	s2,16(sp)
ffffffffc0205362:	f406                	sd	ra,40(sp)
ffffffffc0205364:	e44e                	sd	s3,8(sp)
ffffffffc0205366:	84aa                	mv	s1,a0
ffffffffc0205368:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc020536a:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc020536e:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0205370:	03067e63          	bgeu	a2,a6,ffffffffc02053ac <printnum+0x60>
ffffffffc0205374:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0205376:	00805763          	blez	s0,ffffffffc0205384 <printnum+0x38>
ffffffffc020537a:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc020537c:	85ca                	mv	a1,s2
ffffffffc020537e:	854e                	mv	a0,s3
ffffffffc0205380:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0205382:	fc65                	bnez	s0,ffffffffc020537a <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0205384:	1a02                	slli	s4,s4,0x20
ffffffffc0205386:	00002797          	auipc	a5,0x2
ffffffffc020538a:	29278793          	addi	a5,a5,658 # ffffffffc0207618 <syscalls+0x100>
ffffffffc020538e:	020a5a13          	srli	s4,s4,0x20
ffffffffc0205392:	9a3e                	add	s4,s4,a5
...
ffffffffc0205394:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0205396:	000a4503          	lbu	a0,0(s4)
}
ffffffffc020539a:	70a2                	ld	ra,40(sp)
ffffffffc020539c:	69a2                	ld	s3,8(sp)
ffffffffc020539e:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02053a0:	85ca                	mv	a1,s2
ffffffffc02053a2:	87a6                	mv	a5,s1
}
ffffffffc02053a4:	6942                	ld	s2,16(sp)
ffffffffc02053a6:	64e2                	ld	s1,24(sp)
ffffffffc02053a8:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02053aa:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc02053ac:	03065633          	divu	a2,a2,a6
ffffffffc02053b0:	8722                	mv	a4,s0
ffffffffc02053b2:	f9bff0ef          	jal	ra,ffffffffc020534c <printnum>
ffffffffc02053b6:	b7f9                	j	ffffffffc0205384 <printnum+0x38>

ffffffffc02053b8 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc02053b8:	7119                	addi	sp,sp,-128
ffffffffc02053ba:	f4a6                	sd	s1,104(sp)
ffffffffc02053bc:	f0ca                	sd	s2,96(sp)
ffffffffc02053be:	ecce                	sd	s3,88(sp)
ffffffffc02053c0:	e8d2                	sd	s4,80(sp)
ffffffffc02053c2:	e4d6                	sd	s5,72(sp)
ffffffffc02053c4:	e0da                	sd	s6,64(sp)
ffffffffc02053c6:	fc5e                	sd	s7,56(sp)
ffffffffc02053c8:	f06a                	sd	s10,32(sp)
ffffffffc02053ca:	fc86                	sd	ra,120(sp)
ffffffffc02053cc:	f8a2                	sd	s0,112(sp)
ffffffffc02053ce:	f862                	sd	s8,48(sp)
ffffffffc02053d0:	f466                	sd	s9,40(sp)
ffffffffc02053d2:	ec6e                	sd	s11,24(sp)
ffffffffc02053d4:	892a                	mv	s2,a0
ffffffffc02053d6:	84ae                	mv	s1,a1
ffffffffc02053d8:	8d32                	mv	s10,a2
ffffffffc02053da:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc02053dc:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02053e0:	5b7d                	li	s6,-1
ffffffffc02053e2:	00002a97          	auipc	s5,0x2
ffffffffc02053e6:	262a8a93          	addi	s5,s5,610 # ffffffffc0207644 <syscalls+0x12c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02053ea:	00002b97          	auipc	s7,0x2
ffffffffc02053ee:	476b8b93          	addi	s7,s7,1142 # ffffffffc0207860 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02053f2:	000d4503          	lbu	a0,0(s10)
ffffffffc02053f6:	001d0413          	addi	s0,s10,1
ffffffffc02053fa:	01350a63          	beq	a0,s3,ffffffffc020540e <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc02053fe:	c121                	beqz	a0,ffffffffc020543e <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0205400:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0205402:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0205404:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0205406:	fff44503          	lbu	a0,-1(s0)
ffffffffc020540a:	ff351ae3          	bne	a0,s3,ffffffffc02053fe <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020540e:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0205412:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0205416:	4c81                	li	s9,0
ffffffffc0205418:	4881                	li	a7,0
        width = precision = -1;
ffffffffc020541a:	5c7d                	li	s8,-1
ffffffffc020541c:	5dfd                	li	s11,-1
ffffffffc020541e:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0205422:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205424:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0205428:	0ff5f593          	zext.b	a1,a1
ffffffffc020542c:	00140d13          	addi	s10,s0,1
ffffffffc0205430:	04b56263          	bltu	a0,a1,ffffffffc0205474 <vprintfmt+0xbc>
ffffffffc0205434:	058a                	slli	a1,a1,0x2
ffffffffc0205436:	95d6                	add	a1,a1,s5
ffffffffc0205438:	4194                	lw	a3,0(a1)
ffffffffc020543a:	96d6                	add	a3,a3,s5
ffffffffc020543c:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc020545a:	8082                	ret
            padc = '0';
ffffffffc020545c:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc020545e:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205462:	846a                	mv	s0,s10
ffffffffc0205464:	00140d13          	addi	s10,s0,1
ffffffffc0205468:	fdd6059b          	addiw	a1,a2,-35
ffffffffc020546c:	0ff5f593          	zext.b	a1,a1
ffffffffc0205470:	fcb572e3          	bgeu	a0,a1,ffffffffc0205434 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0205474:	85a6                	mv	a1,s1
ffffffffc0205476:	02500513          	li	a0,37
ffffffffc020547a:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc020547c:	fff44783          	lbu	a5,-1(s0)
ffffffffc0205480:	8d22                	mv	s10,s0
ffffffffc0205482:	f73788e3          	beq	a5,s3,ffffffffc02053f2 <vprintfmt+0x3a>
ffffffffc0205486:	ffed4783          	lbu	a5,-2(s10)
ffffffffc020548a:	1d7d                	addi	s10,s10,-1
ffffffffc020548c:	ff379de3          	bne	a5,s3,ffffffffc0205486 <vprintfmt+0xce>
ffffffffc0205490:	b78d                	j	ffffffffc02053f2 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0205492:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0205496:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020549a:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc020549c:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc02054a0:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02054a4:	02d86463          	bltu	a6,a3,ffffffffc02054cc <vprintfmt+0x114>
                ch = *fmt;
ffffffffc02054a8:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc02054ac:	002c169b          	slliw	a3,s8,0x2
ffffffffc02054b0:	0186873b          	addw	a4,a3,s8
ffffffffc02054b4:	0017171b          	slliw	a4,a4,0x1
ffffffffc02054b8:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc02054ba:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc02054be:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc02054c0:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc02054c4:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02054c8:	fed870e3          	bgeu	a6,a3,ffffffffc02054a8 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc02054cc:	f40ddce3          	bgez	s11,ffffffffc0205424 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc02054d0:	8de2                	mv	s11,s8
ffffffffc02054d2:	5c7d                	li	s8,-1
ffffffffc02054d4:	bf81                	j	ffffffffc0205424 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02054d6:	fffdc693          	not	a3,s11
ffffffffc02054da:	96fd                	srai	a3,a3,0x3f
ffffffffc02054dc:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02054e0:	00144603          	lbu	a2,1(s0)
ffffffffc02054e4:	2d81                	sext.w	s11,s11
ffffffffc02054e6:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02054e8:	bf35                	j	ffffffffc0205424 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02054ea:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02054ee:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02054f2:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02054f4:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc02054f6:	bfd9                	j	ffffffffc02054cc <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02054f8:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02054fa:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02054fe:	01174463          	blt	a4,a7,ffffffffc0205506 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0205502:	1a088e63          	beqz	a7,ffffffffc02056be <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0205506:	000a3603          	ld	a2,0(s4)
ffffffffc020550a:	46c1                	li	a3,16
ffffffffc020550c:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc020550e:	2781                	sext.w	a5,a5
ffffffffc0205510:	876e                	mv	a4,s11
ffffffffc0205512:	85a6                	mv	a1,s1
ffffffffc0205514:	854a                	mv	a0,s2
ffffffffc0205516:	e37ff0ef          	jal	ra,ffffffffc020534c <printnum>
            break;
ffffffffc020551a:	bde1                	j	ffffffffc02053f2 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc020551c:	000a2503          	lw	a0,0(s4)
ffffffffc0205520:	85a6                	mv	a1,s1
ffffffffc0205522:	0a21                	addi	s4,s4,8
ffffffffc0205524:	9902                	jalr	s2
            break;
ffffffffc0205526:	b5f1                	j	ffffffffc02053f2 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0205528:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020552a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020552e:	01174463          	blt	a4,a7,ffffffffc0205536 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0205532:	18088163          	beqz	a7,ffffffffc02056b4 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0205536:	000a3603          	ld	a2,0(s4)
ffffffffc020553a:	46a9                	li	a3,10
ffffffffc020553c:	8a2e                	mv	s4,a1
ffffffffc020553e:	bfc1                	j	ffffffffc020550e <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205540:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0205544:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205546:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0205548:	bdf1                	j	ffffffffc0205424 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc020554a:	85a6                	mv	a1,s1
ffffffffc020554c:	02500513          	li	a0,37
ffffffffc0205550:	9902                	jalr	s2
            break;
ffffffffc0205552:	b545                	j	ffffffffc02053f2 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205554:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0205558:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020555a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020555c:	b5e1                	j	ffffffffc0205424 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc020555e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0205560:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0205564:	01174463          	blt	a4,a7,ffffffffc020556c <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0205568:	14088163          	beqz	a7,ffffffffc02056aa <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc020556c:	000a3603          	ld	a2,0(s4)
ffffffffc0205570:	46a1                	li	a3,8
ffffffffc0205572:	8a2e                	mv	s4,a1
ffffffffc0205574:	bf69                	j	ffffffffc020550e <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0205576:	03000513          	li	a0,48
ffffffffc020557a:	85a6                	mv	a1,s1
ffffffffc020557c:	e03e                	sd	a5,0(sp)
ffffffffc020557e:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0205580:	85a6                	mv	a1,s1
ffffffffc0205582:	07800513          	li	a0,120
ffffffffc0205586:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0205588:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc020558a:	6782                	ld	a5,0(sp)
ffffffffc020558c:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020558e:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0205592:	bfb5                	j	ffffffffc020550e <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0205594:	000a3403          	ld	s0,0(s4)
ffffffffc0205598:	008a0713          	addi	a4,s4,8
ffffffffc020559c:	e03a                	sd	a4,0(sp)
ffffffffc020559e:	14040263          	beqz	s0,ffffffffc02056e2 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02055a2:	0fb05763          	blez	s11,ffffffffc0205690 <vprintfmt+0x2d8>
ffffffffc02055a6:	02d00693          	li	a3,45
ffffffffc02055aa:	0cd79163          	bne	a5,a3,ffffffffc020566c <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02055ae:	00044783          	lbu	a5,0(s0)
ffffffffc02055b2:	0007851b          	sext.w	a0,a5
ffffffffc02055b6:	cf85                	beqz	a5,ffffffffc02055ee <vprintfmt+0x236>
ffffffffc02055b8:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02055bc:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02055c0:	000c4563          	bltz	s8,ffffffffc02055ca <vprintfmt+0x212>
ffffffffc02055c4:	3c7d                	addiw	s8,s8,-1
ffffffffc02055c6:	036c0263          	beq	s8,s6,ffffffffc02055ea <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02055ca:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02055cc:	0e0c8e63          	beqz	s9,ffffffffc02056c8 <vprintfmt+0x310>
ffffffffc02055d0:	3781                	addiw	a5,a5,-32
ffffffffc02055d2:	0ef47b63          	bgeu	s0,a5,ffffffffc02056c8 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02055d6:	03f00513          	li	a0,63
ffffffffc02055da:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02055dc:	000a4783          	lbu	a5,0(s4)
ffffffffc02055e0:	3dfd                	addiw	s11,s11,-1
ffffffffc02055e2:	0a05                	addi	s4,s4,1
ffffffffc02055e4:	0007851b          	sext.w	a0,a5
ffffffffc02055e8:	ffe1                	bnez	a5,ffffffffc02055c0 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02055ea:	01b05963          	blez	s11,ffffffffc02055fc <vprintfmt+0x244>
ffffffffc02055ee:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02055f0:	85a6                	mv	a1,s1
ffffffffc02055f2:	02000513          	li	a0,32
ffffffffc02055f6:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02055f8:	fe0d9be3          	bnez	s11,ffffffffc02055ee <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02055fc:	6a02                	ld	s4,0(sp)
ffffffffc02055fe:	bbd5                	j	ffffffffc02053f2 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0205600:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0205602:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0205606:	01174463          	blt	a4,a7,ffffffffc020560e <vprintfmt+0x256>
    else if (lflag) {
ffffffffc020560a:	08088d63          	beqz	a7,ffffffffc02056a4 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc020560e:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0205612:	0a044d63          	bltz	s0,ffffffffc02056cc <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0205616:	8622                	mv	a2,s0
ffffffffc0205618:	8a66                	mv	s4,s9
ffffffffc020561a:	46a9                	li	a3,10
ffffffffc020561c:	bdcd                	j	ffffffffc020550e <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc020561e:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0205622:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc0205624:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0205626:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc020562a:	8fb5                	xor	a5,a5,a3
ffffffffc020562c:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0205630:	02d74163          	blt	a4,a3,ffffffffc0205652 <vprintfmt+0x29a>
ffffffffc0205634:	00369793          	slli	a5,a3,0x3
ffffffffc0205638:	97de                	add	a5,a5,s7
ffffffffc020563a:	639c                	ld	a5,0(a5)
ffffffffc020563c:	cb99                	beqz	a5,ffffffffc0205652 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc020563e:	86be                	mv	a3,a5
ffffffffc0205640:	00000617          	auipc	a2,0x0
ffffffffc0205644:	1f060613          	addi	a2,a2,496 # ffffffffc0205830 <etext+0x2a>
ffffffffc0205648:	85a6                	mv	a1,s1
ffffffffc020564a:	854a                	mv	a0,s2
ffffffffc020564c:	0ce000ef          	jal	ra,ffffffffc020571a <printfmt>
ffffffffc0205650:	b34d                	j	ffffffffc02053f2 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0205652:	00002617          	auipc	a2,0x2
ffffffffc0205656:	fe660613          	addi	a2,a2,-26 # ffffffffc0207638 <syscalls+0x120>
ffffffffc020565a:	85a6                	mv	a1,s1
ffffffffc020565c:	854a                	mv	a0,s2
ffffffffc020565e:	0bc000ef          	jal	ra,ffffffffc020571a <printfmt>
ffffffffc0205662:	bb41                	j	ffffffffc02053f2 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0205664:	00002417          	auipc	s0,0x2
ffffffffc0205668:	fcc40413          	addi	s0,s0,-52 # ffffffffc0207630 <syscalls+0x118>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020566c:	85e2                	mv	a1,s8
ffffffffc020566e:	8522                	mv	a0,s0
ffffffffc0205670:	e43e                	sd	a5,8(sp)
ffffffffc0205672:	0e2000ef          	jal	ra,ffffffffc0205754 <strnlen>
ffffffffc0205676:	40ad8dbb          	subw	s11,s11,a0
ffffffffc020567a:	01b05b63          	blez	s11,ffffffffc0205690 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc020567e:	67a2                	ld	a5,8(sp)
ffffffffc0205680:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0205684:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0205686:	85a6                	mv	a1,s1
ffffffffc0205688:	8552                	mv	a0,s4
ffffffffc020568a:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020568c:	fe0d9ce3          	bnez	s11,ffffffffc0205684 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205690:	00044783          	lbu	a5,0(s0)
ffffffffc0205694:	00140a13          	addi	s4,s0,1
ffffffffc0205698:	0007851b          	sext.w	a0,a5
ffffffffc020569c:	d3a5                	beqz	a5,ffffffffc02055fc <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020569e:	05e00413          	li	s0,94
ffffffffc02056a2:	bf39                	j	ffffffffc02055c0 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02056a4:	000a2403          	lw	s0,0(s4)
ffffffffc02056a8:	b7ad                	j	ffffffffc0205612 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02056aa:	000a6603          	lwu	a2,0(s4)
ffffffffc02056ae:	46a1                	li	a3,8
ffffffffc02056b0:	8a2e                	mv	s4,a1
ffffffffc02056b2:	bdb1                	j	ffffffffc020550e <vprintfmt+0x156>
ffffffffc02056b4:	000a6603          	lwu	a2,0(s4)
ffffffffc02056b8:	46a9                	li	a3,10
ffffffffc02056ba:	8a2e                	mv	s4,a1
ffffffffc02056bc:	bd89                	j	ffffffffc020550e <vprintfmt+0x156>
ffffffffc02056be:	000a6603          	lwu	a2,0(s4)
ffffffffc02056c2:	46c1                	li	a3,16
ffffffffc02056c4:	8a2e                	mv	s4,a1
ffffffffc02056c6:	b5a1                	j	ffffffffc020550e <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02056c8:	9902                	jalr	s2
ffffffffc02056ca:	bf09                	j	ffffffffc02055dc <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02056cc:	85a6                	mv	a1,s1
ffffffffc02056ce:	02d00513          	li	a0,45
ffffffffc02056d2:	e03e                	sd	a5,0(sp)
ffffffffc02056d4:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02056d6:	6782                	ld	a5,0(sp)
ffffffffc02056d8:	8a66                	mv	s4,s9
ffffffffc02056da:	40800633          	neg	a2,s0
ffffffffc02056de:	46a9                	li	a3,10
ffffffffc02056e0:	b53d                	j	ffffffffc020550e <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02056e2:	03b05163          	blez	s11,ffffffffc0205704 <vprintfmt+0x34c>
ffffffffc02056e6:	02d00693          	li	a3,45
ffffffffc02056ea:	f6d79de3          	bne	a5,a3,ffffffffc0205664 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02056ee:	00002417          	auipc	s0,0x2
ffffffffc02056f2:	f4240413          	addi	s0,s0,-190 # ffffffffc0207630 <syscalls+0x118>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02056f6:	02800793          	li	a5,40
ffffffffc02056fa:	02800513          	li	a0,40
ffffffffc02056fe:	00140a13          	addi	s4,s0,1
ffffffffc0205702:	bd6d                	j	ffffffffc02055bc <vprintfmt+0x204>
ffffffffc0205704:	00002a17          	auipc	s4,0x2
ffffffffc0205708:	f2da0a13          	addi	s4,s4,-211 # ffffffffc0207631 <syscalls+0x119>
ffffffffc020570c:	02800513          	li	a0,40
ffffffffc0205710:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0205714:	05e00413          	li	s0,94
ffffffffc0205718:	b565                	j	ffffffffc02055c0 <vprintfmt+0x208>

ffffffffc020571a <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020571a:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc020571c:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0205720:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0205722:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0205724:	ec06                	sd	ra,24(sp)
ffffffffc0205726:	f83a                	sd	a4,48(sp)
ffffffffc0205728:	fc3e                	sd	a5,56(sp)
ffffffffc020572a:	e0c2                	sd	a6,64(sp)
ffffffffc020572c:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc020572e:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0205730:	c89ff0ef          	jal	ra,ffffffffc02053b8 <vprintfmt>
}
ffffffffc0205734:	60e2                	ld	ra,24(sp)
ffffffffc0205736:	6161                	addi	sp,sp,80
ffffffffc0205738:	8082                	ret

ffffffffc020573a <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc020573a:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc020573e:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0205740:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0205742:	cb81                	beqz	a5,ffffffffc0205752 <strlen+0x18>
        cnt ++;
ffffffffc0205744:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0205746:	00a707b3          	add	a5,a4,a0
ffffffffc020574a:	0007c783          	lbu	a5,0(a5)
ffffffffc020574e:	fbfd                	bnez	a5,ffffffffc0205744 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0205754:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0205756:	e589                	bnez	a1,ffffffffc0205760 <strnlen+0xc>
ffffffffc0205758:	a811                	j	ffffffffc020576c <strnlen+0x18>
        cnt ++;
ffffffffc020575a:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020575c:	00f58863          	beq	a1,a5,ffffffffc020576c <strnlen+0x18>
ffffffffc0205760:	00f50733          	add	a4,a0,a5
ffffffffc0205764:	00074703          	lbu	a4,0(a4)
ffffffffc0205768:	fb6d                	bnez	a4,ffffffffc020575a <strnlen+0x6>
ffffffffc020576a:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc020576c:	852e                	mv	a0,a1
ffffffffc020576e:	8082                	ret

ffffffffc0205770 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0205770:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0205772:	0005c703          	lbu	a4,0(a1)
ffffffffc0205776:	0785                	addi	a5,a5,1
ffffffffc0205778:	0585                	addi	a1,a1,1
ffffffffc020577a:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020577e:	fb75                	bnez	a4,ffffffffc0205772 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0205786:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020578a:	cb89                	beqz	a5,ffffffffc020579c <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc020578c:	0505                	addi	a0,a0,1
ffffffffc020578e:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0205790:	fee789e3          	beq	a5,a4,ffffffffc0205782 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0205794:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0205798:	9d19                	subw	a0,a0,a4
ffffffffc020579a:	8082                	ret
ffffffffc020579c:	4501                	li	a0,0
ffffffffc020579e:	bfed                	j	ffffffffc0205798 <strcmp+0x16>

ffffffffc02057a0 <strncmp>:
...
ffffffffc02057a0:	c20d                	beqz	a2,ffffffffc02057c2 <strncmp+0x22>
ffffffffc02057a2:	962e                	add	a2,a2,a1
ffffffffc02057a4:	a031                	j	ffffffffc02057b0 <strncmp+0x10>
        n --, s1 ++, s2 ++;
ffffffffc02057a6:	0505                	addi	a0,a0,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc02057a8:	00e79a63          	bne	a5,a4,ffffffffc02057bc <strncmp+0x1c>
ffffffffc02057ac:	00b60b63          	beq	a2,a1,ffffffffc02057c2 <strncmp+0x22>
ffffffffc02057b0:	00054783          	lbu	a5,0(a0)
        n --, s1 ++, s2 ++;
ffffffffc02057b4:	0585                	addi	a1,a1,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc02057b6:	fff5c703          	lbu	a4,-1(a1)
ffffffffc02057ba:	f7f5                	bnez	a5,ffffffffc02057a6 <strncmp+0x6>
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc02057bc:	40e7853b          	subw	a0,a5,a4
}
...
ffffffffc02057ca:	c799                	beqz	a5,ffffffffc02057d8 <strchr+0x12>
        if (*s == c) {
ffffffffc02057cc:	00f58763          	beq	a1,a5,ffffffffc02057da <strchr+0x14>
    while (*s != '\0') {
ffffffffc02057d0:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02057d4:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02057d6:	fbfd                	bnez	a5,ffffffffc02057cc <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02057dc:	ca01                	beqz	a2,ffffffffc02057ec <memset+0x10>
ffffffffc02057de:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02057e0:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02057e2:	0785                	addi	a5,a5,1
ffffffffc02057e4:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02057e8:	fec79de3          	bne	a5,a2,ffffffffc02057e2 <memset+0x6>
    }
    return s;
...
ffffffffc02057ee <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02057ee:	ca19                	beqz	a2,ffffffffc0205804 <memcpy+0x16>
ffffffffc02057f0:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02057f2:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02057f4:	0005c703          	lbu	a4,0(a1)
ffffffffc02057f8:	0585                	addi	a1,a1,1
ffffffffc02057fa:	0785                	addi	a5,a5,1
ffffffffc02057fc:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0205800:	fec59ae3          	bne	a1,a2,ffffffffc02057f4 <memcpy+0x6>
    }
    return dst;

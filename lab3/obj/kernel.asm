...
ffffffffc0200a86:	08f76f63          	bltu	a4,a5,ffffffffc0200b24 <interrupt_handler+0xa8>
...
void interrupt_handler(struct trapframe *tf) {
ffffffffc0200acc:	1101                	addi	sp,sp,-32
ffffffffc0200ace:	e822                	sd	s0,16(sp)
ffffffffc0200ad0:	e426                	sd	s1,8(sp)
             *(2)计数器（ticks）加一
            ...
            */
            ...
            ticks++;
ffffffffc0200ad2:	00007417          	auipc	s0,0x7
ffffffffc0200ad6:	97640413          	addi	s0,s0,-1674 # ffffffffc0207448 <ticks>
void interrupt_handler(struct trapframe *tf) {
ffffffffc0200ada:	ec06                	sd	ra,24(sp)
            clock_set_next_event();
ffffffffc0200adc:	985ff0ef          	jal	ra,ffffffffc0200460 <clock_set_next_event>
            ticks++;
ffffffffc0200ae0:	601c                	ld	a5,0(s0)
            if(PRINT_COUNT==10) 
ffffffffc0200ae2:	00007497          	auipc	s1,0x7
ffffffffc0200ae6:	97e48493          	addi	s1,s1,-1666 # ffffffffc0207460 <PRINT_COUNT>
ffffffffc0200aea:	4098                	lw	a4,0(s1)
            ticks++;
ffffffffc0200aec:	0785                	addi	a5,a5,1
ffffffffc0200aee:	e01c                	sd	a5,0(s0)
            if(PRINT_COUNT==10) 
ffffffffc0200af0:	47a9                	li	a5,10
ffffffffc0200af2:	04f70663          	beq	a4,a5,ffffffffc0200b3e <interrupt_handler+0xc2>
                sbi_shutdown();
            if(ticks%TICK_NUM==0)
ffffffffc0200af6:	601c                	ld	a5,0(s0)
ffffffffc0200af8:	06400713          	li	a4,100
ffffffffc0200afc:	02e7f7b3          	remu	a5,a5,a4
ffffffffc0200b00:	c39d                	beqz	a5,ffffffffc0200b26 <interrupt_handler+0xaa>
            break;
        default:
            print_trapframe(tf);
            break;
...
ffffffffc0200b02:	60e2                	ld	ra,24(sp)
ffffffffc0200b04:	6442                	ld	s0,16(sp)
ffffffffc0200b06:	64a2                	ld	s1,8(sp)
ffffffffc0200b08:	6105                	addi	sp,sp,32
ffffffffc0200b0a:	8082                	ret
            cprintf("Supervisor external interrupt\n");
ffffffffc0200b0c:	00002517          	auipc	a0,0x2
ffffffffc0200b10:	cf450513          	addi	a0,a0,-780 # ffffffffc0202800 <commands+0x5f8>
ffffffffc0200b14:	dc4ff06f          	j	ffffffffc02000d8 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc0200b18:	00002517          	auipc	a0,0x2
ffffffffc0200b1c:	c6050513          	addi	a0,a0,-928 # ffffffffc0202778 <commands+0x570>
ffffffffc0200b20:	db8ff06f          	j	ffffffffc02000d8 <cprintf>
            print_trapframe(tf);
ffffffffc0200b24:	bddd                	j	ffffffffc0200a1a <print_trapframe>
    cprintf("%d ticks\n", TICK_NUM);
ffffffffc0200b26:	06400593          	li	a1,100
ffffffffc0200b2a:	00002517          	auipc	a0,0x2
ffffffffc0200b2e:	cc650513          	addi	a0,a0,-826 # ffffffffc02027f0 <commands+0x5e8>
ffffffffc0200b32:	da6ff0ef          	jal	ra,ffffffffc02000d8 <cprintf>
                PRINT_COUNT++;
ffffffffc0200b36:	409c                	lw	a5,0(s1)
ffffffffc0200b38:	2785                	addiw	a5,a5,1
ffffffffc0200b3a:	c09c                	sw	a5,0(s1)
ffffffffc0200b3c:	b7d9                	j	ffffffffc0200b02 <interrupt_handler+0x86>
                sbi_shutdown();
ffffffffc0200b3e:	3b2010ef          	jal	ra,ffffffffc0201ef0 <sbi_shutdown>
ffffffffc0200b42:	bf55                	j	ffffffffc0200af6 <interrupt_handler+0x7a>

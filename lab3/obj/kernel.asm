...
ffffffffc020009e:	bfff                	0xbfff
ffffffffc02000a0:	dead                	beqz	a3,ffffffffc020001a <kern_entry+0x1a>
...
ffffffffc0200afe:	d3650513          	addi	a0,a0,-714 # ffffffffc0202830 <commands+0x5f8>
ffffffffc0200b02:	ddcff06f          	j	ffffffffc02000de <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc0200b06:	00002517          	auipc	a0,0x2
ffffffffc0200b0a:	ca250513          	addi	a0,a0,-862 # ffffffffc02027a8 <commands+0x570>
...
ffffffffc0200b1c:	d0850513          	addi	a0,a0,-760 # ffffffffc0202820 <commands+0x5e8>
ffffffffc0200b20:	dbeff0ef          	jal	ra,ffffffffc02000de <cprintf>
                PRINT_COUNT++;
ffffffffc0200b24:	00007717          	auipc	a4,0x7
ffffffffc0200b28:	93c70713          	addi	a4,a4,-1732 # ffffffffc0207460 <PRINT_COUNT>
...
ffffffffc0200b34:	c310                	sw	a2,0(a4)
                if(PRINT_COUNT==10) 
ffffffffc0200b36:	fad61fe3          	bne	a2,a3,ffffffffc0200af4 <interrupt_handler+0x72>
}
ffffffffc0200b3a:	60a2                	ld	ra,8(sp)
ffffffffc0200b3c:	0141                	addi	sp,sp,16
                sbi_shutdown();
ffffffffc0200b3e:	3e20106f          	j	ffffffffc0201f20 <sbi_shutdown>
...
ffffffffc0200b44:	10853783          	ld	a5,264(a0)
void exception_handler(struct trapframe *tf) {
ffffffffc0200b48:	f022                	sd	s0,32(sp)
    switch (tf->cause) {
ffffffffc0200b4a:	11853403          	ld	s0,280(a0)
void exception_handler(struct trapframe *tf) {
ffffffffc0200b4e:	ec26                	sd	s1,24(sp)
ffffffffc0200b50:	e84a                	sd	s2,16(sp)
ffffffffc0200b52:	e44e                	sd	s3,8(sp)
ffffffffc0200b54:	f406                	sd	ra,40(sp)
    switch (tf->cause) {
ffffffffc0200b56:	490d                	li	s2,3
    uint16_t instr = *(uint16_t *)tf->epc;
ffffffffc0200b58:	0007d983          	lhu	s3,0(a5)
void exception_handler(struct trapframe *tf) {
ffffffffc0200b5c:	84aa                	mv	s1,a0
    switch (tf->cause) {
ffffffffc0200b5e:	07240063          	beq	s0,s2,ffffffffc0200bbe <exception_handler+0x7c>
ffffffffc0200b62:	04896363          	bltu	s2,s0,ffffffffc0200ba8 <exception_handler+0x66>
ffffffffc0200b66:	4789                	li	a5,2
ffffffffc0200b68:	02f41963          	bne	s0,a5,ffffffffc0200b9a <exception_handler+0x58>
             /* LAB3 CHALLENGE3   YOUR CODE : （小组成员：2312289刘轩麟 2312114李子恒 2213468陈馨颍） */
...
ffffffffc0200b70:	d1450513          	addi	a0,a0,-748 # ffffffffc0202880 <commands+0x648>
ffffffffc0200b74:	d6aff0ef          	jal	ra,ffffffffc02000de <cprintf>
            cprintf("Illegal instruction caught at 0x%08x\n", tf->epc);
ffffffffc0200b78:	1084b583          	ld	a1,264(s1)
ffffffffc0200b7c:	00002517          	auipc	a0,0x2
ffffffffc0200b80:	d2c50513          	addi	a0,a0,-724 # ffffffffc02028a8 <commands+0x670>
            
            if ((instr & 0x03) != 0x03) 
ffffffffc0200b84:	0039f993          	andi	s3,s3,3
            cprintf("Illegal instruction caught at 0x%08x\n", tf->epc);
ffffffffc0200b88:	d56ff0ef          	jal	ra,ffffffffc02000de <cprintf>
                tf->epc+=2;  // 压缩指令，2字节
ffffffffc0200b8c:	1084b783          	ld	a5,264(s1)
            if ((instr & 0x03) != 0x03) 
ffffffffc0200b90:	05298b63          	beq	s3,s2,ffffffffc0200be6 <exception_handler+0xa4>
             *(3)更新 tf->epc寄存器
            */
            ...
            if ((instr & 0x03) != 0x03) 
                tf->epc+=2;  // 压缩指令，2字节
ffffffffc0200b94:	0789                	addi	a5,a5,2
ffffffffc0200b96:	10f4b423          	sd	a5,264(s1)
            break;
        default:
            print_trapframe(tf);
            break;
...
ffffffffc0200b9a:	70a2                	ld	ra,40(sp)
ffffffffc0200b9c:	7402                	ld	s0,32(sp)
ffffffffc0200b9e:	64e2                	ld	s1,24(sp)
ffffffffc0200ba0:	6942                	ld	s2,16(sp)
ffffffffc0200ba2:	69a2                	ld	s3,8(sp)
ffffffffc0200ba4:	6145                	addi	sp,sp,48
ffffffffc0200ba6:	8082                	ret
    switch (tf->cause) {
ffffffffc0200ba8:	1471                	addi	s0,s0,-4
ffffffffc0200baa:	479d                	li	a5,7
ffffffffc0200bac:	fe87f7e3          	bgeu	a5,s0,ffffffffc0200b9a <exception_handler+0x58>
}
ffffffffc0200bb0:	7402                	ld	s0,32(sp)
ffffffffc0200bb2:	70a2                	ld	ra,40(sp)
ffffffffc0200bb4:	64e2                	ld	s1,24(sp)
ffffffffc0200bb6:	6942                	ld	s2,16(sp)
ffffffffc0200bb8:	69a2                	ld	s3,8(sp)
ffffffffc0200bba:	6145                	addi	sp,sp,48
            print_trapframe(tf);
ffffffffc0200bbc:	b595                	j	ffffffffc0200a20 <print_trapframe>
            cprintf("Exception type: breakpoint\n");
ffffffffc0200bbe:	00002517          	auipc	a0,0x2
ffffffffc0200bc2:	d1250513          	addi	a0,a0,-750 # ffffffffc02028d0 <commands+0x698>
ffffffffc0200bc6:	d18ff0ef          	jal	ra,ffffffffc02000de <cprintf>
            cprintf("ebreak caught at 0x%08x\n", tf->epc);
ffffffffc0200bca:	1084b583          	ld	a1,264(s1)
ffffffffc0200bce:	00002517          	auipc	a0,0x2
ffffffffc0200bd2:	d2250513          	addi	a0,a0,-734 # ffffffffc02028f0 <commands+0x6b8>
            if ((instr & 0x03) != 0x03) 
ffffffffc0200bd6:	0039f993          	andi	s3,s3,3
            cprintf("ebreak caught at 0x%08x\n", tf->epc);
ffffffffc0200bda:	d04ff0ef          	jal	ra,ffffffffc02000de <cprintf>
                tf->epc+=2;  // 压缩指令，2字节
ffffffffc0200bde:	1084b783          	ld	a5,264(s1)
            if ((instr & 0x03) != 0x03) 
ffffffffc0200be2:	fa8999e3          	bne	s3,s0,ffffffffc0200b94 <exception_handler+0x52>
}
ffffffffc0200be6:	70a2                	ld	ra,40(sp)
ffffffffc0200be8:	7402                	ld	s0,32(sp)
            else tf->epc+=4;  
ffffffffc0200bea:	0791                	addi	a5,a5,4
ffffffffc0200bec:	10f4b423          	sd	a5,264(s1)
}
ffffffffc0200bf0:	6942                	ld	s2,16(sp)
ffffffffc0200bf2:	64e2                	ld	s1,24(sp)
ffffffffc0200bf4:	69a2                	ld	s3,8(sp)
ffffffffc0200bf6:	6145                	addi	sp,sp,48
...
ffffffffc0200c02:	b781                	j	ffffffffc0200b42 <exception_handler>
        interrupt_handler(tf);
...
ffffffffc0200d7c:	3205b583          	ld	a1,800(a1) # ffffffffc0203098 <error_string+0x38>
ffffffffc0200d80:	02b70733          	mul	a4,a4,a1
ffffffffc0200d84:	00002617          	auipc	a2,0x2
ffffffffc0200d88:	31c63603          	ld	a2,796(a2) # ffffffffc02030a0 <nbase>
...
ffffffffc0200fd4:	94068693          	addi	a3,a3,-1728 # ffffffffc0202910 <commands+0x6d8>
ffffffffc0200fd8:	00002617          	auipc	a2,0x2
ffffffffc0200fdc:	94860613          	addi	a2,a2,-1720 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0200fe0:	0f000593          	li	a1,240
ffffffffc0200fe4:	00002517          	auipc	a0,0x2
ffffffffc0200fe8:	95450513          	addi	a0,a0,-1708 # ffffffffc0202938 <commands+0x700>
ffffffffc0200fec:	becff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200ff0:	00002697          	auipc	a3,0x2
ffffffffc0200ff4:	9e068693          	addi	a3,a3,-1568 # ffffffffc02029d0 <commands+0x798>
ffffffffc0200ff8:	00002617          	auipc	a2,0x2
ffffffffc0200ffc:	92860613          	addi	a2,a2,-1752 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201000:	0bd00593          	li	a1,189
ffffffffc0201004:	00002517          	auipc	a0,0x2
ffffffffc0201008:	93450513          	addi	a0,a0,-1740 # ffffffffc0202938 <commands+0x700>
ffffffffc020100c:	bccff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0201010:	00002697          	auipc	a3,0x2
ffffffffc0201014:	9e868693          	addi	a3,a3,-1560 # ffffffffc02029f8 <commands+0x7c0>
ffffffffc0201018:	00002617          	auipc	a2,0x2
ffffffffc020101c:	90860613          	addi	a2,a2,-1784 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201020:	0be00593          	li	a1,190
ffffffffc0201024:	00002517          	auipc	a0,0x2
ffffffffc0201028:	91450513          	addi	a0,a0,-1772 # ffffffffc0202938 <commands+0x700>
ffffffffc020102c:	bacff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0201030:	00002697          	auipc	a3,0x2
ffffffffc0201034:	a0868693          	addi	a3,a3,-1528 # ffffffffc0202a38 <commands+0x800>
ffffffffc0201038:	00002617          	auipc	a2,0x2
ffffffffc020103c:	8e860613          	addi	a2,a2,-1816 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201040:	0c000593          	li	a1,192
ffffffffc0201044:	00002517          	auipc	a0,0x2
ffffffffc0201048:	8f450513          	addi	a0,a0,-1804 # ffffffffc0202938 <commands+0x700>
ffffffffc020104c:	b8cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0201050:	00002697          	auipc	a3,0x2
ffffffffc0201054:	a7068693          	addi	a3,a3,-1424 # ffffffffc0202ac0 <commands+0x888>
ffffffffc0201058:	00002617          	auipc	a2,0x2
ffffffffc020105c:	8c860613          	addi	a2,a2,-1848 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201060:	0d900593          	li	a1,217
ffffffffc0201064:	00002517          	auipc	a0,0x2
ffffffffc0201068:	8d450513          	addi	a0,a0,-1836 # ffffffffc0202938 <commands+0x700>
ffffffffc020106c:	b6cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201070:	00002697          	auipc	a3,0x2
ffffffffc0201074:	90068693          	addi	a3,a3,-1792 # ffffffffc0202970 <commands+0x738>
ffffffffc0201078:	00002617          	auipc	a2,0x2
ffffffffc020107c:	8a860613          	addi	a2,a2,-1880 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201080:	0d200593          	li	a1,210
ffffffffc0201084:	00002517          	auipc	a0,0x2
ffffffffc0201088:	8b450513          	addi	a0,a0,-1868 # ffffffffc0202938 <commands+0x700>
ffffffffc020108c:	b4cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(nr_free == 3);
ffffffffc0201090:	00002697          	auipc	a3,0x2
ffffffffc0201094:	a2068693          	addi	a3,a3,-1504 # ffffffffc0202ab0 <commands+0x878>
ffffffffc0201098:	00002617          	auipc	a2,0x2
ffffffffc020109c:	88860613          	addi	a2,a2,-1912 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02010a0:	0d000593          	li	a1,208
ffffffffc02010a4:	00002517          	auipc	a0,0x2
ffffffffc02010a8:	89450513          	addi	a0,a0,-1900 # ffffffffc0202938 <commands+0x700>
ffffffffc02010ac:	b2cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010b0:	00002697          	auipc	a3,0x2
ffffffffc02010b4:	9e868693          	addi	a3,a3,-1560 # ffffffffc0202a98 <commands+0x860>
ffffffffc02010b8:	00002617          	auipc	a2,0x2
ffffffffc02010bc:	86860613          	addi	a2,a2,-1944 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02010c0:	0cb00593          	li	a1,203
ffffffffc02010c4:	00002517          	auipc	a0,0x2
ffffffffc02010c8:	87450513          	addi	a0,a0,-1932 # ffffffffc0202938 <commands+0x700>
ffffffffc02010cc:	b0cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc02010d0:	00002697          	auipc	a3,0x2
ffffffffc02010d4:	9a868693          	addi	a3,a3,-1624 # ffffffffc0202a78 <commands+0x840>
ffffffffc02010d8:	00002617          	auipc	a2,0x2
ffffffffc02010dc:	84860613          	addi	a2,a2,-1976 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02010e0:	0c200593          	li	a1,194
ffffffffc02010e4:	00002517          	auipc	a0,0x2
ffffffffc02010e8:	85450513          	addi	a0,a0,-1964 # ffffffffc0202938 <commands+0x700>
ffffffffc02010ec:	aecff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(p0 != NULL);
ffffffffc02010f0:	00002697          	auipc	a3,0x2
ffffffffc02010f4:	a1868693          	addi	a3,a3,-1512 # ffffffffc0202b08 <commands+0x8d0>
ffffffffc02010f8:	00002617          	auipc	a2,0x2
ffffffffc02010fc:	82860613          	addi	a2,a2,-2008 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201100:	0f800593          	li	a1,248
ffffffffc0201104:	00002517          	auipc	a0,0x2
ffffffffc0201108:	83450513          	addi	a0,a0,-1996 # ffffffffc0202938 <commands+0x700>
ffffffffc020110c:	accff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(nr_free == 0);
ffffffffc0201110:	00002697          	auipc	a3,0x2
ffffffffc0201114:	9e868693          	addi	a3,a3,-1560 # ffffffffc0202af8 <commands+0x8c0>
ffffffffc0201118:	00002617          	auipc	a2,0x2
ffffffffc020111c:	80860613          	addi	a2,a2,-2040 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201120:	0df00593          	li	a1,223
ffffffffc0201124:	00002517          	auipc	a0,0x2
ffffffffc0201128:	81450513          	addi	a0,a0,-2028 # ffffffffc0202938 <commands+0x700>
ffffffffc020112c:	aacff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201130:	00002697          	auipc	a3,0x2
ffffffffc0201134:	96868693          	addi	a3,a3,-1688 # ffffffffc0202a98 <commands+0x860>
ffffffffc0201138:	00001617          	auipc	a2,0x1
ffffffffc020113c:	7e860613          	addi	a2,a2,2024 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201140:	0dd00593          	li	a1,221
ffffffffc0201144:	00001517          	auipc	a0,0x1
ffffffffc0201148:	7f450513          	addi	a0,a0,2036 # ffffffffc0202938 <commands+0x700>
ffffffffc020114c:	a8cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0201150:	00002697          	auipc	a3,0x2
ffffffffc0201154:	98868693          	addi	a3,a3,-1656 # ffffffffc0202ad8 <commands+0x8a0>
ffffffffc0201158:	00001617          	auipc	a2,0x1
ffffffffc020115c:	7c860613          	addi	a2,a2,1992 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201160:	0dc00593          	li	a1,220
ffffffffc0201164:	00001517          	auipc	a0,0x1
ffffffffc0201168:	7d450513          	addi	a0,a0,2004 # ffffffffc0202938 <commands+0x700>
ffffffffc020116c:	a6cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201170:	00002697          	auipc	a3,0x2
ffffffffc0201174:	80068693          	addi	a3,a3,-2048 # ffffffffc0202970 <commands+0x738>
ffffffffc0201178:	00001617          	auipc	a2,0x1
ffffffffc020117c:	7a860613          	addi	a2,a2,1960 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201180:	0b900593          	li	a1,185
ffffffffc0201184:	00001517          	auipc	a0,0x1
ffffffffc0201188:	7b450513          	addi	a0,a0,1972 # ffffffffc0202938 <commands+0x700>
ffffffffc020118c:	a4cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201190:	00002697          	auipc	a3,0x2
ffffffffc0201194:	90868693          	addi	a3,a3,-1784 # ffffffffc0202a98 <commands+0x860>
ffffffffc0201198:	00001617          	auipc	a2,0x1
ffffffffc020119c:	78860613          	addi	a2,a2,1928 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02011a0:	0d600593          	li	a1,214
ffffffffc02011a4:	00001517          	auipc	a0,0x1
ffffffffc02011a8:	79450513          	addi	a0,a0,1940 # ffffffffc0202938 <commands+0x700>
ffffffffc02011ac:	a2cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02011b0:	00002697          	auipc	a3,0x2
ffffffffc02011b4:	80068693          	addi	a3,a3,-2048 # ffffffffc02029b0 <commands+0x778>
ffffffffc02011b8:	00001617          	auipc	a2,0x1
ffffffffc02011bc:	76860613          	addi	a2,a2,1896 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02011c0:	0d400593          	li	a1,212
ffffffffc02011c4:	00001517          	auipc	a0,0x1
ffffffffc02011c8:	77450513          	addi	a0,a0,1908 # ffffffffc0202938 <commands+0x700>
ffffffffc02011cc:	a0cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02011d0:	00001697          	auipc	a3,0x1
ffffffffc02011d4:	7c068693          	addi	a3,a3,1984 # ffffffffc0202990 <commands+0x758>
ffffffffc02011d8:	00001617          	auipc	a2,0x1
ffffffffc02011dc:	74860613          	addi	a2,a2,1864 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02011e0:	0d300593          	li	a1,211
ffffffffc02011e4:	00001517          	auipc	a0,0x1
ffffffffc02011e8:	75450513          	addi	a0,a0,1876 # ffffffffc0202938 <commands+0x700>
ffffffffc02011ec:	9ecff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02011f0:	00001697          	auipc	a3,0x1
ffffffffc02011f4:	7c068693          	addi	a3,a3,1984 # ffffffffc02029b0 <commands+0x778>
ffffffffc02011f8:	00001617          	auipc	a2,0x1
ffffffffc02011fc:	72860613          	addi	a2,a2,1832 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201200:	0bb00593          	li	a1,187
ffffffffc0201204:	00001517          	auipc	a0,0x1
ffffffffc0201208:	73450513          	addi	a0,a0,1844 # ffffffffc0202938 <commands+0x700>
ffffffffc020120c:	9ccff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(count == 0);
ffffffffc0201210:	00002697          	auipc	a3,0x2
ffffffffc0201214:	a4868693          	addi	a3,a3,-1464 # ffffffffc0202c58 <commands+0xa20>
ffffffffc0201218:	00001617          	auipc	a2,0x1
ffffffffc020121c:	70860613          	addi	a2,a2,1800 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201220:	12500593          	li	a1,293
ffffffffc0201224:	00001517          	auipc	a0,0x1
ffffffffc0201228:	71450513          	addi	a0,a0,1812 # ffffffffc0202938 <commands+0x700>
ffffffffc020122c:	9acff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(nr_free == 0);
ffffffffc0201230:	00002697          	auipc	a3,0x2
ffffffffc0201234:	8c868693          	addi	a3,a3,-1848 # ffffffffc0202af8 <commands+0x8c0>
ffffffffc0201238:	00001617          	auipc	a2,0x1
ffffffffc020123c:	6e860613          	addi	a2,a2,1768 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201240:	11a00593          	li	a1,282
ffffffffc0201244:	00001517          	auipc	a0,0x1
ffffffffc0201248:	6f450513          	addi	a0,a0,1780 # ffffffffc0202938 <commands+0x700>
ffffffffc020124c:	98cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201250:	00002697          	auipc	a3,0x2
ffffffffc0201254:	84868693          	addi	a3,a3,-1976 # ffffffffc0202a98 <commands+0x860>
ffffffffc0201258:	00001617          	auipc	a2,0x1
ffffffffc020125c:	6c860613          	addi	a2,a2,1736 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201260:	11800593          	li	a1,280
ffffffffc0201264:	00001517          	auipc	a0,0x1
ffffffffc0201268:	6d450513          	addi	a0,a0,1748 # ffffffffc0202938 <commands+0x700>
ffffffffc020126c:	96cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201270:	00001697          	auipc	a3,0x1
ffffffffc0201274:	7e868693          	addi	a3,a3,2024 # ffffffffc0202a58 <commands+0x820>
ffffffffc0201278:	00001617          	auipc	a2,0x1
ffffffffc020127c:	6a860613          	addi	a2,a2,1704 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201280:	0c100593          	li	a1,193
ffffffffc0201284:	00001517          	auipc	a0,0x1
ffffffffc0201288:	6b450513          	addi	a0,a0,1716 # ffffffffc0202938 <commands+0x700>
ffffffffc020128c:	94cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201290:	00002697          	auipc	a3,0x2
ffffffffc0201294:	98868693          	addi	a3,a3,-1656 # ffffffffc0202c18 <commands+0x9e0>
ffffffffc0201298:	00001617          	auipc	a2,0x1
ffffffffc020129c:	68860613          	addi	a2,a2,1672 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02012a0:	11200593          	li	a1,274
ffffffffc02012a4:	00001517          	auipc	a0,0x1
ffffffffc02012a8:	69450513          	addi	a0,a0,1684 # ffffffffc0202938 <commands+0x700>
ffffffffc02012ac:	92cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02012b0:	00002697          	auipc	a3,0x2
ffffffffc02012b4:	94868693          	addi	a3,a3,-1720 # ffffffffc0202bf8 <commands+0x9c0>
ffffffffc02012b8:	00001617          	auipc	a2,0x1
ffffffffc02012bc:	66860613          	addi	a2,a2,1640 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02012c0:	11000593          	li	a1,272
ffffffffc02012c4:	00001517          	auipc	a0,0x1
ffffffffc02012c8:	67450513          	addi	a0,a0,1652 # ffffffffc0202938 <commands+0x700>
ffffffffc02012cc:	90cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02012d0:	00002697          	auipc	a3,0x2
ffffffffc02012d4:	90068693          	addi	a3,a3,-1792 # ffffffffc0202bd0 <commands+0x998>
ffffffffc02012d8:	00001617          	auipc	a2,0x1
ffffffffc02012dc:	64860613          	addi	a2,a2,1608 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02012e0:	10e00593          	li	a1,270
ffffffffc02012e4:	00001517          	auipc	a0,0x1
ffffffffc02012e8:	65450513          	addi	a0,a0,1620 # ffffffffc0202938 <commands+0x700>
ffffffffc02012ec:	8ecff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02012f0:	00002697          	auipc	a3,0x2
ffffffffc02012f4:	8b868693          	addi	a3,a3,-1864 # ffffffffc0202ba8 <commands+0x970>
ffffffffc02012f8:	00001617          	auipc	a2,0x1
ffffffffc02012fc:	62860613          	addi	a2,a2,1576 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201300:	10d00593          	li	a1,269
ffffffffc0201304:	00001517          	auipc	a0,0x1
ffffffffc0201308:	63450513          	addi	a0,a0,1588 # ffffffffc0202938 <commands+0x700>
ffffffffc020130c:	8ccff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201310:	00002697          	auipc	a3,0x2
ffffffffc0201314:	88868693          	addi	a3,a3,-1912 # ffffffffc0202b98 <commands+0x960>
ffffffffc0201318:	00001617          	auipc	a2,0x1
ffffffffc020131c:	60860613          	addi	a2,a2,1544 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201320:	10800593          	li	a1,264
ffffffffc0201324:	00001517          	auipc	a0,0x1
ffffffffc0201328:	61450513          	addi	a0,a0,1556 # ffffffffc0202938 <commands+0x700>
ffffffffc020132c:	8acff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201330:	00001697          	auipc	a3,0x1
ffffffffc0201334:	76868693          	addi	a3,a3,1896 # ffffffffc0202a98 <commands+0x860>
ffffffffc0201338:	00001617          	auipc	a2,0x1
ffffffffc020133c:	5e860613          	addi	a2,a2,1512 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201340:	10700593          	li	a1,263
ffffffffc0201344:	00001517          	auipc	a0,0x1
ffffffffc0201348:	5f450513          	addi	a0,a0,1524 # ffffffffc0202938 <commands+0x700>
ffffffffc020134c:	88cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201350:	00002697          	auipc	a3,0x2
ffffffffc0201354:	82868693          	addi	a3,a3,-2008 # ffffffffc0202b78 <commands+0x940>
ffffffffc0201358:	00001617          	auipc	a2,0x1
ffffffffc020135c:	5c860613          	addi	a2,a2,1480 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201360:	10600593          	li	a1,262
ffffffffc0201364:	00001517          	auipc	a0,0x1
ffffffffc0201368:	5d450513          	addi	a0,a0,1492 # ffffffffc0202938 <commands+0x700>
ffffffffc020136c:	86cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201370:	00001697          	auipc	a3,0x1
ffffffffc0201374:	7d868693          	addi	a3,a3,2008 # ffffffffc0202b48 <commands+0x910>
ffffffffc0201378:	00001617          	auipc	a2,0x1
ffffffffc020137c:	5a860613          	addi	a2,a2,1448 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201380:	10500593          	li	a1,261
ffffffffc0201384:	00001517          	auipc	a0,0x1
ffffffffc0201388:	5b450513          	addi	a0,a0,1460 # ffffffffc0202938 <commands+0x700>
ffffffffc020138c:	84cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201390:	00001697          	auipc	a3,0x1
ffffffffc0201394:	7a068693          	addi	a3,a3,1952 # ffffffffc0202b30 <commands+0x8f8>
ffffffffc0201398:	00001617          	auipc	a2,0x1
ffffffffc020139c:	58860613          	addi	a2,a2,1416 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02013a0:	10400593          	li	a1,260
ffffffffc02013a4:	00001517          	auipc	a0,0x1
ffffffffc02013a8:	59450513          	addi	a0,a0,1428 # ffffffffc0202938 <commands+0x700>
ffffffffc02013ac:	82cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02013b0:	00001697          	auipc	a3,0x1
ffffffffc02013b4:	6e868693          	addi	a3,a3,1768 # ffffffffc0202a98 <commands+0x860>
ffffffffc02013b8:	00001617          	auipc	a2,0x1
ffffffffc02013bc:	56860613          	addi	a2,a2,1384 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02013c0:	0fe00593          	li	a1,254
ffffffffc02013c4:	00001517          	auipc	a0,0x1
ffffffffc02013c8:	57450513          	addi	a0,a0,1396 # ffffffffc0202938 <commands+0x700>
ffffffffc02013cc:	80cff0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(!PageProperty(p0));
ffffffffc02013d0:	00001697          	auipc	a3,0x1
ffffffffc02013d4:	74868693          	addi	a3,a3,1864 # ffffffffc0202b18 <commands+0x8e0>
ffffffffc02013d8:	00001617          	auipc	a2,0x1
ffffffffc02013dc:	54860613          	addi	a2,a2,1352 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02013e0:	0f900593          	li	a1,249
ffffffffc02013e4:	00001517          	auipc	a0,0x1
ffffffffc02013e8:	55450513          	addi	a0,a0,1364 # ffffffffc0202938 <commands+0x700>
ffffffffc02013ec:	fedfe0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02013f0:	00002697          	auipc	a3,0x2
ffffffffc02013f4:	84868693          	addi	a3,a3,-1976 # ffffffffc0202c38 <commands+0xa00>
ffffffffc02013f8:	00001617          	auipc	a2,0x1
ffffffffc02013fc:	52860613          	addi	a2,a2,1320 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201400:	11700593          	li	a1,279
ffffffffc0201404:	00001517          	auipc	a0,0x1
ffffffffc0201408:	53450513          	addi	a0,a0,1332 # ffffffffc0202938 <commands+0x700>
ffffffffc020140c:	fcdfe0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(total == 0);
ffffffffc0201410:	00002697          	auipc	a3,0x2
ffffffffc0201414:	85868693          	addi	a3,a3,-1960 # ffffffffc0202c68 <commands+0xa30>
ffffffffc0201418:	00001617          	auipc	a2,0x1
ffffffffc020141c:	50860613          	addi	a2,a2,1288 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201420:	12600593          	li	a1,294
ffffffffc0201424:	00001517          	auipc	a0,0x1
ffffffffc0201428:	51450513          	addi	a0,a0,1300 # ffffffffc0202938 <commands+0x700>
ffffffffc020142c:	fadfe0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201430:	00001697          	auipc	a3,0x1
ffffffffc0201434:	52068693          	addi	a3,a3,1312 # ffffffffc0202950 <commands+0x718>
ffffffffc0201438:	00001617          	auipc	a2,0x1
ffffffffc020143c:	4e860613          	addi	a2,a2,1256 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201440:	0f300593          	li	a1,243
ffffffffc0201444:	00001517          	auipc	a0,0x1
ffffffffc0201448:	4f450513          	addi	a0,a0,1268 # ffffffffc0202938 <commands+0x700>
ffffffffc020144c:	f8dfe0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201450:	00001697          	auipc	a3,0x1
ffffffffc0201454:	54068693          	addi	a3,a3,1344 # ffffffffc0202990 <commands+0x758>
ffffffffc0201458:	00001617          	auipc	a2,0x1
ffffffffc020145c:	4c860613          	addi	a2,a2,1224 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201460:	0ba00593          	li	a1,186
ffffffffc0201464:	00001517          	auipc	a0,0x1
ffffffffc0201468:	4d450513          	addi	a0,a0,1236 # ffffffffc0202938 <commands+0x700>
...
ffffffffc02015ac:	6d868693          	addi	a3,a3,1752 # ffffffffc0202c80 <commands+0xa48>
ffffffffc02015b0:	00001617          	auipc	a2,0x1
ffffffffc02015b4:	37060613          	addi	a2,a2,880 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02015b8:	08300593          	li	a1,131
ffffffffc02015bc:	00001517          	auipc	a0,0x1
ffffffffc02015c0:	37c50513          	addi	a0,a0,892 # ffffffffc0202938 <commands+0x700>
ffffffffc02015c4:	e15fe0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(n > 0);
ffffffffc02015c8:	00001697          	auipc	a3,0x1
ffffffffc02015cc:	6b068693          	addi	a3,a3,1712 # ffffffffc0202c78 <commands+0xa40>
ffffffffc02015d0:	00001617          	auipc	a2,0x1
ffffffffc02015d4:	35060613          	addi	a2,a2,848 # ffffffffc0202920 <commands+0x6e8>
ffffffffc02015d8:	08000593          	li	a1,128
ffffffffc02015dc:	00001517          	auipc	a0,0x1
ffffffffc02015e0:	35c50513          	addi	a0,a0,860 # ffffffffc0202938 <commands+0x700>
...
ffffffffc0201684:	5f868693          	addi	a3,a3,1528 # ffffffffc0202c78 <commands+0xa40>
ffffffffc0201688:	00001617          	auipc	a2,0x1
ffffffffc020168c:	29860613          	addi	a2,a2,664 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201690:	06200593          	li	a1,98
ffffffffc0201694:	00001517          	auipc	a0,0x1
ffffffffc0201698:	2a450513          	addi	a0,a0,676 # ffffffffc0202938 <commands+0x700>
default_alloc_pages(size_t n) {
...
ffffffffc020175a:	55268693          	addi	a3,a3,1362 # ffffffffc0202ca8 <commands+0xa70>
ffffffffc020175e:	00001617          	auipc	a2,0x1
ffffffffc0201762:	1c260613          	addi	a2,a2,450 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201766:	04900593          	li	a1,73
ffffffffc020176a:	00001517          	auipc	a0,0x1
ffffffffc020176e:	1ce50513          	addi	a0,a0,462 # ffffffffc0202938 <commands+0x700>
ffffffffc0201772:	c67fe0ef          	jal	ra,ffffffffc02003d8 <__panic>
    assert(n > 0);
ffffffffc0201776:	00001697          	auipc	a3,0x1
ffffffffc020177a:	50268693          	addi	a3,a3,1282 # ffffffffc0202c78 <commands+0xa40>
ffffffffc020177e:	00001617          	auipc	a2,0x1
ffffffffc0201782:	1a260613          	addi	a2,a2,418 # ffffffffc0202920 <commands+0x6e8>
ffffffffc0201786:	04600593          	li	a1,70
ffffffffc020178a:	00001517          	auipc	a0,0x1
ffffffffc020178e:	1ae50513          	addi	a0,a0,430 # ffffffffc0202938 <commands+0x700>
...
ffffffffc0201852:	48278793          	addi	a5,a5,1154 # ffffffffc0202cd0 <default_pmm_manager>
...
ffffffffc0201860:	4ac50513          	addi	a0,a0,1196 # ffffffffc0202d08 <default_pmm_manager+0x38>
    pmm_manager = &default_pmm_manager;
...
ffffffffc02018a4:	4b050513          	addi	a0,a0,1200 # ffffffffc0202d50 <default_pmm_manager+0x80>
...
ffffffffc02018bc:	4b050513          	addi	a0,a0,1200 # ffffffffc0202d68 <default_pmm_manager+0x98>
...
ffffffffc0201952:	4a250513          	addi	a0,a0,1186 # ffffffffc0202df0 <default_pmm_manager+0x120>
...
ffffffffc0201990:	48450513          	addi	a0,a0,1156 # ffffffffc0202e10 <default_pmm_manager+0x140>
}
...
ffffffffc02019d0:	3f460613          	addi	a2,a2,1012 # ffffffffc0202dc0 <default_pmm_manager+0xf0>
ffffffffc02019d4:	06b00593          	li	a1,107
ffffffffc02019d8:	00001517          	auipc	a0,0x1
ffffffffc02019dc:	40850513          	addi	a0,a0,1032 # ffffffffc0202de0 <default_pmm_manager+0x110>
ffffffffc02019e0:	9f9fe0ef          	jal	ra,ffffffffc02003d8 <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc02019e4:	00001617          	auipc	a2,0x1
ffffffffc02019e8:	3b460613          	addi	a2,a2,948 # ffffffffc0202d98 <default_pmm_manager+0xc8>
ffffffffc02019ec:	07100593          	li	a1,113
ffffffffc02019f0:	00001517          	auipc	a0,0x1
ffffffffc02019f4:	35050513          	addi	a0,a0,848 # ffffffffc0202d40 <default_pmm_manager+0x70>
ffffffffc02019f8:	9e1fe0ef          	jal	ra,ffffffffc02003d8 <__panic>
        panic("DTB memory info not available");
ffffffffc02019fc:	00001617          	auipc	a2,0x1
ffffffffc0201a00:	32460613          	addi	a2,a2,804 # ffffffffc0202d20 <default_pmm_manager+0x50>
ffffffffc0201a04:	05a00593          	li	a1,90
ffffffffc0201a08:	00001517          	auipc	a0,0x1
ffffffffc0201a0c:	33850513          	addi	a0,a0,824 # ffffffffc0202d40 <default_pmm_manager+0x70>
...
ffffffffc0201a1a:	38260613          	addi	a2,a2,898 # ffffffffc0202d98 <default_pmm_manager+0xc8>
ffffffffc0201a1e:	08c00593          	li	a1,140
ffffffffc0201a22:	00001517          	auipc	a0,0x1
ffffffffc0201a26:	31e50513          	addi	a0,a0,798 # ffffffffc0202d40 <default_pmm_manager+0x70>
...
ffffffffc0201a6c:	3e878793          	addi	a5,a5,1000 # ffffffffc0202e50 <default_pmm_manager+0x180>
...
ffffffffc0201ac8:	3c0a8a93          	addi	s5,s5,960 # ffffffffc0202e84 <default_pmm_manager+0x1b4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0201ad0:	594b8b93          	addi	s7,s7,1428 # ffffffffc0203060 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
...
ffffffffc0201d26:	15e60613          	addi	a2,a2,350 # ffffffffc0202e80 <default_pmm_manager+0x1b0>
...
ffffffffc0201d38:	13c60613          	addi	a2,a2,316 # ffffffffc0202e70 <default_pmm_manager+0x1a0>
...
ffffffffc0201d4a:	12240413          	addi	s0,s0,290 # ffffffffc0202e68 <default_pmm_manager+0x198>
...
ffffffffc0201dd4:	09840413          	addi	s0,s0,152 # ffffffffc0202e68 <default_pmm_manager+0x198>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
ffffffffc0201dea:	083a0a13          	addi	s4,s4,131 # ffffffffc0202e69 <default_pmm_manager+0x199>
...
ffffffffc0201e36:	04e50513          	addi	a0,a0,78 # ffffffffc0202e80 <default_pmm_manager+0x1b0>
